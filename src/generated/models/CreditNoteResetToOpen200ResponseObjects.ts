 ...
 * 
 * @export
 * @interface CreditNoteResetToOpen200ResponseObjects
 */
export interface CreditNoteResetToOpen200ResponseObjects {
    /**
     * The creditNote id
     * @type {string}
     * @memberof CreditNoteResetToOpen200ResponseObjects
     */
    readonly id?: string;
    /**
     ...
     * @memberof CreditNoteResetToOpen200ResponseObjects
     */
    sendType?: CreditNoteResetToOpen200ResponseObjectsSendTypeEnum | null;
}
 ...
 * @export
 */
export const CreditNoteResetToOpen200ResponseObjectsSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type CreditNoteResetToOpen200ResponseObjectsSendTypeEnum = typeof CreditNoteResetToOpen200ResponseObjectsSendTypeEnum[keyof typeof CreditNoteResetToOpen200ResponseObjectsSendTypeEnum];


/**
 * Check if a given object implements the CreditNoteResetToOpen200ResponseObjects interface.
 */
export function instanceOfCreditNoteResetToOpen200ResponseObjects(value: object): value is CreditNoteResetToOpen200ResponseObjects {
    return true;
}

export function CreditNoteResetToOpen200ResponseObjectsFromJSON(json: any): CreditNoteResetToOpen200ResponseObjects {
    return CreditNoteResetToOpen200ResponseObjectsFromJSONTyped(json, false);
}

export function CreditNoteResetToOpen200ResponseObjectsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditNoteResetToOpen200ResponseObjects {
    if (json == null) {
        return json;
    }
    return {
...
export function CreditNoteResetToOpen200ResponseObjectsToJSON(json: any): CreditNoteResetToOpen200ResponseObjects {
    return CreditNoteResetToOpen200ResponseObjectsToJSONTyped(json, false);
}

export function CreditNoteResetToOpen200ResponseObjectsToJSONTyped(value?: Omit<CreditNoteResetToOpen200ResponseObjects, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
