...
import type { CreateFileImportAccountResponseSevClient } from './CreateFileImportAccountResponseSevClient';
import {
    CreateFileImportAccountResponseSevClientFromJSON,
    CreateFileImportAccountResponseSevClientFromJSONTyped,
    CreateFileImportAccountResponseSevClientToJSON,
    CreateFileImportAccountResponseSevClientToJSONTyped,
} from './CreateFileImportAccountResponseSevClient';

/**
 * CheckAccount model. Showing the properties relevant to file import accounts.
 * @export
 * @interface CreateFileImportAccountResponse
 */
export interface CreateFileImportAccountResponse {
    /**
     * The check account id
     * @type {string}
     * @memberof CreateFileImportAccountResponse
     */
    id?: string;
    /**
    ...
    /**
     * 
     * @type {CreateFileImportAccountResponseSevClient}
     * @memberof CreateFileImportAccountResponse
     */
    sevClient?: CreateFileImportAccountResponseSevClient;
    /**
     ...
     * @memberof CreateFileImportAccountResponse
     */
    type?: CreateFileImportAccountResponseTypeEnum;
    /**
     ...
     * @memberof CreateFileImportAccountResponse
     */
    importType?: CreateFileImportAccountResponseImportTypeEnum;
    /**
     ...
     * @memberof CreateFileImportAccountResponse
     */
    defaultAccount?: CreateFileImportAccountResponseDefaultAccountEnum;
    /**
     * Status of the check account. 0 <-> Archived - 100 <-> Active
     * @type {string}
     * @memberof CreateFileImportAccountResponse
     */
    status?: CreateFileImportAccountResponseStatusEnum;
    /**
     * Defines if transactions on this account are automatically mapped to invoice and vouchers when imported if possible.
     * @type {string}
     * @memberof CreateFileImportAccountResponse
     */
    autoMapTransactions?: CreateFileImportAccountResponseAutoMapTransactionsEnum;
    /**
 ...
 * @export
 */
export const CreateFileImportAccountResponseTypeEnum = {
    Online: 'online',
    Offline: 'offline'
} as const;
export type CreateFileImportAccountResponseTypeEnum = typeof CreateFileImportAccountResponseTypeEnum[keyof typeof CreateFileImportAccountResponseTypeEnum];

/**
 * @export
 */
export const CreateFileImportAccountResponseImportTypeEnum = {
    Csv: 'CSV',
    Mt940: 'MT940'
} as const;
export type CreateFileImportAccountResponseImportTypeEnum = typeof CreateFileImportAccountResponseImportTypeEnum[keyof typeof CreateFileImportAccountResponseImportTypeEnum];

/**
 * @export
 */
export const CreateFileImportAccountResponseDefaultAccountEnum = {
    _0: '0',
    _1: '1'
} as const;
export type CreateFileImportAccountResponseDefaultAccountEnum = typeof CreateFileImportAccountResponseDefaultAccountEnum[keyof typeof CreateFileImportAccountResponseDefaultAccountEnum];

/**
 * @export
 */
export const CreateFileImportAccountResponseStatusEnum = {
    _0: '0',
    _100: '100'
} as const;
export type CreateFileImportAccountResponseStatusEnum = typeof CreateFileImportAccountResponseStatusEnum[keyof typeof CreateFileImportAccountResponseStatusEnum];

/**
 * @export
 */
export const CreateFileImportAccountResponseAutoMapTransactionsEnum = {
    _0: '0',
    _1: '1'
} as const;
export type CreateFileImportAccountResponseAutoMapTransactionsEnum = typeof CreateFileImportAccountResponseAutoMapTransactionsEnum[keyof typeof CreateFileImportAccountResponseAutoMapTransactionsEnum];


/**
 * Check if a given object implements the CreateFileImportAccountResponse interface.
 */
export function instanceOfCreateFileImportAccountResponse(value: object): value is CreateFileImportAccountResponse {
    return true;
}

export function CreateFileImportAccountResponseFromJSON(json: any): CreateFileImportAccountResponse {
    return CreateFileImportAccountResponseFromJSONTyped(json, false);
}

export function CreateFileImportAccountResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateFileImportAccountResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sevClient': json['sevClient'] == null ? undefined : CreateFileImportAccountResponseSevClientFromJSON(json['sevClient']),
        'name': json['name'] == null ? undefined : json['name'],
        'iban': json['iban'] == null ? undefined : json['iban'],
        'type': json['type'] == null ? undefined : json['type'],
        'importType': json['importType'] == null ? undefined : json['importType'],
        'currency': json['currency'] == null ? undefined : json['currency'],
        'defaultAccount': json['defaultAccount'] == null ? undefined : json['defaultAccount'],
        'status': json['status'] == null ? undefined : json['status'],
        'autoMapTransactions': json['autoMapTransactions'] == null ? undefined : json['autoMapTransactions'],
        'accountingNumber': json['accountingNumber'] == null ? undefined : json['accountingNumber'],
    };
}

export function CreateFileImportAccountResponseToJSON(json: any): CreateFileImportAccountResponse {
    return CreateFileImportAccountResponseToJSONTyped(json, false);
}

export function CreateFileImportAccountResponseToJSONTyped(value?: CreateFileImportAccountResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'create': value['create'] == null ? undefined : ((value['create']).toISOString()),
        'update': value['update'] == null ? undefined : ((value['update']).toISOString()),
        'sevClient': CreateFileImportAccountResponseSevClientToJSON(value['sevClient']),
        'name': value['name'],
        'iban': value['iban'],
        'type': value['type'],
        'importType': value['importType'],
        'currency': value['currency'],
        'defaultAccount': value['defaultAccount'],
        'status': value['status'],
        'autoMapTransactions': value['autoMapTransactions'],
