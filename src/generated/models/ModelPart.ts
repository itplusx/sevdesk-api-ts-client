...
export interface ModelPart {
     ...
     * @memberof ModelPart
     */
    status?: ModelPartStatusEnum | null;
    /**
 ...
 * @export
 */
export const ModelPartStatusEnum = {
    NUMBER_50: 50,
    NUMBER_100: 100
} as const;
export type ModelPartStatusEnum = typeof ModelPartStatusEnum[keyof typeof ModelPartStatusEnum];


/**
 * Check if a given object implements the ModelPart interface.
 */
export function instanceOfModelPart(value: object): value is ModelPart {
...
export function ModelPartFromJSON(json: any): ModelPart {
    return ModelPartFromJSONTyped(json, false);
}

export function ModelPartFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelPart {
    if (json == null) {
        return json;
    }
    return {
        ...
        'unity': ModelPartUnityFromJSON(json['unity']),
...
export function ModelPartToJSON(json: any): ModelPart {
    return ModelPartToJSONTyped(json, false);
}

export function ModelPartToJSONTyped(value?: Omit<ModelPart, 'id'|'objectName'|'create'|'update'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
