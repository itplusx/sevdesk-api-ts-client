...
import {
    ...
    ModelInvoiceResponseOriginToJSONTyped,
...
import {
    ...
    ModelInvoiceResponseTaxSetToJSONTyped,
...
import {
    ...
    ModelInvoiceResponseContactPersonToJSONTyped,
...
import {
    ...
    ModelInvoiceResponseAddressCountryToJSONTyped,
...
import {
    ...
    ModelInvoiceResponseContactToJSONTyped,
...
import {
    ...
    ModelInvoiceResponseCostCentreToJSONTyped,
...
import {
    ...
    ModelInvoiceResponsePaymentMethodToJSONTyped,
...
import {
    ...
    ModelInvoiceResponseSevClientToJSONTyped,
} from './ModelInvoiceResponseSevClient';

/**
 * 
 * @export
 * @interface InvoiceResetToOpen200ResponseObjects
 */
export interface InvoiceResetToOpen200ResponseObjects {
    /**
     * The invoice id
     * @type {string}
     * @memberof InvoiceResetToOpen200ResponseObjects
     */
    readonly id?: string;
    /**
     ...
     * @memberof InvoiceResetToOpen200ResponseObjects
     */
    readonly taxType?: InvoiceResetToOpen200ResponseObjectsTaxTypeEnum;
    /**
     * 
     ...
     * @memberof InvoiceResetToOpen200ResponseObjects
     */
    readonly invoiceType?: InvoiceResetToOpen200ResponseObjectsInvoiceTypeEnum;
    /**
     * 
     * @type {any}
     * @memberof InvoiceResetToOpen200ResponseObjects
     ...
     * @memberof InvoiceResetToOpen200ResponseObjects
     */
    readonly sendType?: InvoiceResetToOpen200ResponseObjectsSendTypeEnum;
    /**
 ...
 * @export
 */
export const InvoiceResetToOpen200ResponseObjectsTaxTypeEnum = {
    Default: 'default',
    Eu: 'eu',
    Noteu: 'noteu',
    Custom: 'custom'
} as const;
export type InvoiceResetToOpen200ResponseObjectsTaxTypeEnum = typeof InvoiceResetToOpen200ResponseObjectsTaxTypeEnum[keyof typeof InvoiceResetToOpen200ResponseObjectsTaxTypeEnum];

/**
 * @export
 */
export const InvoiceResetToOpen200ResponseObjectsInvoiceTypeEnum = {
    Re: 'RE',
    Wkr: 'WKR',
    Sr: 'SR',
    Ma: 'MA',
...
export type InvoiceResetToOpen200ResponseObjectsInvoiceTypeEnum = typeof InvoiceResetToOpen200ResponseObjectsInvoiceTypeEnum[keyof typeof InvoiceResetToOpen200ResponseObjectsInvoiceTypeEnum];

/**
 * @export
 */
export const InvoiceResetToOpen200ResponseObjectsSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type InvoiceResetToOpen200ResponseObjectsSendTypeEnum = typeof InvoiceResetToOpen200ResponseObjectsSendTypeEnum[keyof typeof InvoiceResetToOpen200ResponseObjectsSendTypeEnum];


/**
 * Check if a given object implements the InvoiceResetToOpen200ResponseObjects interface.
 */
export function instanceOfInvoiceResetToOpen200ResponseObjects(value: object): value is InvoiceResetToOpen200ResponseObjects {
    return true;
}

export function InvoiceResetToOpen200ResponseObjectsFromJSON(json: any): InvoiceResetToOpen200ResponseObjects {
    return InvoiceResetToOpen200ResponseObjectsFromJSONTyped(json, false);
}

export function InvoiceResetToOpen200ResponseObjectsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceResetToOpen200ResponseObjects {
    if (json == null) {
        return json;
    }
    return {
