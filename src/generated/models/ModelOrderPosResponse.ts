...
import type { ModelOrderPosResponseOrder } from './ModelOrderPosResponseOrder';
import {
    ModelOrderPosResponseOrderFromJSON,
    ModelOrderPosResponseOrderFromJSONTyped,
    ModelOrderPosResponseOrderToJSON,
    ModelOrderPosResponseOrderToJSONTyped,
} from './ModelOrderPosResponseOrder';
import type { ModelOrderPosResponsePart } from './ModelOrderPosResponsePart';
import {
    ModelOrderPosResponsePartFromJSON,
    ModelOrderPosResponsePartFromJSONTyped,
    ModelOrderPosResponsePartToJSON,
    ModelOrderPosResponsePartToJSONTyped,
} from './ModelOrderPosResponsePart';
import type { ModelOrderPosResponseUnity } from './ModelOrderPosResponseUnity';
import {
    ModelOrderPosResponseUnityFromJSON,
    ModelOrderPosResponseUnityFromJSONTyped,
    ModelOrderPosResponseUnityToJSON,
    ModelOrderPosResponseUnityToJSONTyped,
} from './ModelOrderPosResponseUnity';
import type { ModelOrderPosResponseSevClient } from './ModelOrderPosResponseSevClient';
import {
    ModelOrderPosResponseSevClientFromJSON,
    ModelOrderPosResponseSevClientFromJSONTyped,
    ModelOrderPosResponseSevClientToJSON,
    ModelOrderPosResponseSevClientToJSONTyped,
} from './ModelOrderPosResponseSevClient';

/**
 * Order position model
 * @export
 * @interface ModelOrderPosResponse
 */
export interface ModelOrderPosResponse {
    /**
     * The order position id
     * @type {string}
     * @memberof ModelOrderPosResponse
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelOrderPosResponseOrder}
     * @memberof ModelOrderPosResponse
     */
    order?: ModelOrderPosResponseOrder;
    /**
     * 
     * @type {ModelOrderPosResponsePart}
     * @memberof ModelOrderPosResponse
     */
    ...
    /**
     * 
     * @type {ModelOrderPosResponseUnity}
     * @memberof ModelOrderPosResponse
     */
    unity?: ModelOrderPosResponseUnity;
    /**
     * 
     * @type {ModelOrderPosResponseSevClient}
     * @memberof ModelOrderPosResponse
     */
    sevClient?: ModelOrderPosResponseSevClient;
    /**
...
/**
 * Check if a given object implements the ModelOrderPosResponse interface.
 */
export function instanceOfModelOrderPosResponse(value: object): value is ModelOrderPosResponse {
    return true;
}

export function ModelOrderPosResponseFromJSON(json: any): ModelOrderPosResponse {
    return ModelOrderPosResponseFromJSONTyped(json, false);
}

export function ModelOrderPosResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelOrderPosResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'order': json['order'] == null ? undefined : ModelOrderPosResponseOrderFromJSON(json['order']),
        'part': json['part'] == null ? undefined : ModelOrderPosResponsePartFromJSON(json['part']),
        ...
        'unity': json['unity'] == null ? undefined : ModelOrderPosResponseUnityFromJSON(json['unity']),
        'sevClient': json['sevClient'] == null ? undefined : ModelOrderPosResponseSevClientFromJSON(json['sevClient']),
...
export function ModelOrderPosResponseToJSON(json: any): ModelOrderPosResponse {
    return ModelOrderPosResponseToJSONTyped(json, false);
}

export function ModelOrderPosResponseToJSONTyped(value?: Omit<ModelOrderPosResponse, 'id'|'objectName'|'create'|'update'|'priceNet'|'sumDiscount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'order': ModelOrderPosResponseOrderToJSON(value['order']),
        'part': ModelOrderPosResponsePartToJSON(value['part']),
        'quantity': value['quantity'],
        'price': value['price'],
        'priceTax': value['priceTax'],
        'priceGross': value['priceGross'],
        'name': value['name'],
        'unity': ModelOrderPosResponseUnityToJSON(value['unity']),
        'sevClient': ModelOrderPosResponseSevClientToJSON(value['sevClient']),
