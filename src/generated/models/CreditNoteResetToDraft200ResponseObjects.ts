...
import {
    ...
    ModelCreditNoteResponseCreateUserToJSONTyped,
} from './ModelCreditNoteResponseCreateUser';
import type { ModelCreditNoteResponseSevClient } from './ModelCreditNoteResponseSevClient';
import {
    ModelCreditNoteResponseSevClientFromJSON,
    ModelCreditNoteResponseSevClientFromJSONTyped,
    ModelCreditNoteResponseSevClientToJSON,
    ModelCreditNoteResponseSevClientToJSONTyped,
} from './ModelCreditNoteResponseSevClient';
...
import type { ModelCreditNoteResponseTaxSet } from './ModelCreditNoteResponseTaxSet';
import {
    ModelCreditNoteResponseTaxSetFromJSON,
    ModelCreditNoteResponseTaxSetFromJSONTyped,
    ModelCreditNoteResponseTaxSetToJSON,
    ModelCreditNoteResponseTaxSetToJSONTyped,
} from './ModelCreditNoteResponseTaxSet';
import type { ModelCreditNoteResponseAddressCountry } from './ModelCreditNoteResponseAddressCountry';
import {
    ModelCreditNoteResponseAddressCountryFromJSON,
    ModelCreditNoteResponseAddressCountryFromJSONTyped,
    ModelCreditNoteResponseAddressCountryToJSON,
    ModelCreditNoteResponseAddressCountryToJSONTyped,
} from './ModelCreditNoteResponseAddressCountry';
import type { ModelCreditNoteResponseContactPerson } from './ModelCreditNoteResponseContactPerson';
import {
    ModelCreditNoteResponseContactPersonFromJSON,
    ModelCreditNoteResponseContactPersonFromJSONTyped,
    ModelCreditNoteResponseContactPersonToJSON,
    ModelCreditNoteResponseContactPersonToJSONTyped,
} from './ModelCreditNoteResponseContactPerson';
import type { ModelCreditNoteResponseContact } from './ModelCreditNoteResponseContact';
import {
    ModelCreditNoteResponseContactFromJSON,
    ModelCreditNoteResponseContactFromJSONTyped,
    ModelCreditNoteResponseContactToJSON,
    ModelCreditNoteResponseContactToJSONTyped,
} from './ModelCreditNoteResponseContact';

/**
 * 
 * @export
 * @interface CreditNoteResetToDraft200ResponseObjects
 */
export interface CreditNoteResetToDraft200ResponseObjects {
    /**
     * The creditNote id
     * @type {string}
     * @memberof CreditNoteResetToDraft200ResponseObjects
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNoteResponseContact}
     * @memberof CreditNoteResetToDraft200ResponseObjects
     */
    contact?: ModelCreditNoteResponseContact | null;
    /**
     ...
     * @memberof CreditNoteResetToDraft200ResponseObjects
     */
    status?: CreditNoteResetToDraft200ResponseObjectsStatusEnum;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNoteResponseAddressCountry}
     * @memberof CreditNoteResetToDraft200ResponseObjects
     */
    addressCountry?: ModelCreditNoteResponseAddressCountry | null;
    /**
     * 
    ...
    /**
     * 
     * @type {ModelCreditNoteResponseSevClient}
     * @memberof CreditNoteResetToDraft200ResponseObjects
     */
    sevClient?: ModelCreditNoteResponseSevClient;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNoteResponseContactPerson}
     * @memberof CreditNoteResetToDraft200ResponseObjects
     */
    contactPerson?: ModelCreditNoteResponseContactPerson | null;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNoteResponseTaxSet}
     * @memberof CreditNoteResetToDraft200ResponseObjects
     */
    taxSet?: ModelCreditNoteResponseTaxSet | null;
    /**
     * 
     * @type {any}
     * @memberof CreditNoteResetToDraft200ResponseObjects
     ...
     * @memberof CreditNoteResetToDraft200ResponseObjects
     */
    sendType?: CreditNoteResetToDraft200ResponseObjectsSendTypeEnum | null;
}
 ...
 * @export
 */
export const CreditNoteResetToDraft200ResponseObjectsStatusEnum = {
    _100: '100',
    _200: '200',
    _750: '750',
    _1000: '1000'
} as const;
export type CreditNoteResetToDraft200ResponseObjectsStatusEnum = typeof CreditNoteResetToDraft200ResponseObjectsStatusEnum[keyof typeof CreditNoteResetToDraft200ResponseObjectsStatusEnum];

/**
 * @export
 */
export const CreditNoteResetToDraft200ResponseObjectsSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type CreditNoteResetToDraft200ResponseObjectsSendTypeEnum = typeof CreditNoteResetToDraft200ResponseObjectsSendTypeEnum[keyof typeof CreditNoteResetToDraft200ResponseObjectsSendTypeEnum];


/**
 * Check if a given object implements the CreditNoteResetToDraft200ResponseObjects interface.
 */
export function instanceOfCreditNoteResetToDraft200ResponseObjects(value: object): value is CreditNoteResetToDraft200ResponseObjects {
    return true;
}

export function CreditNoteResetToDraft200ResponseObjectsFromJSON(json: any): CreditNoteResetToDraft200ResponseObjects {
    return CreditNoteResetToDraft200ResponseObjectsFromJSONTyped(json, false);
}

export function CreditNoteResetToDraft200ResponseObjectsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditNoteResetToDraft200ResponseObjects {
    if (json == null) {
        return json;
    }
    return {
        ...
        'creditNoteNumber': json['creditNoteNumber'] == null ? undefined : json['creditNoteNumber'],
        'contact': json['contact'] == null ? undefined : ModelCreditNoteResponseContactFromJSON(json['contact']),
        'creditNoteDate': json['creditNoteDate'] == null ? undefined : (new Date(json['creditNoteDate'])),
        ...
        'addressCountry': json['addressCountry'] == null ? undefined : ModelCreditNoteResponseAddressCountryFromJSON(json['addressCountry']),
        'createUser': json['createUser'] == null ? undefined : ModelCreditNoteResponseCreateUserFromJSON(json['createUser']),
        'sevClient': json['sevClient'] == null ? undefined : ModelCreditNoteResponseSevClientFromJSON(json['sevClient']),
        ...
        'contactPerson': json['contactPerson'] == null ? undefined : ModelCreditNoteResponseContactPersonFromJSON(json['contactPerson']),
        ...
        'taxSet': json['taxSet'] == null ? undefined : ModelCreditNoteResponseTaxSetFromJSON(json['taxSet']),
...
export function CreditNoteResetToDraft200ResponseObjectsToJSON(json: any): CreditNoteResetToDraft200ResponseObjects {
    return CreditNoteResetToDraft200ResponseObjectsToJSONTyped(json, false);
}

export function CreditNoteResetToDraft200ResponseObjectsToJSONTyped(value?: Omit<CreditNoteResetToDraft200ResponseObjects, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'contact': ModelCreditNoteResponseContactToJSON(value['contact']),
        'creditNoteDate': value['creditNoteDate'] == null ? undefined : ((value['creditNoteDate']).toISOString()),
        'status': value['status'],
        'header': value['header'],
        'headText': value['headText'],
        'footText': value['footText'],
        'addressCountry': ModelCreditNoteResponseAddressCountryToJSON(value['addressCountry']),
        'createUser': ModelCreditNoteResponseCreateUserToJSON(value['createUser']),
        'sevClient': ModelCreditNoteResponseSevClientToJSON(value['sevClient']),
        'deliveryDate': value['deliveryDate'] == null ? undefined : ((value['deliveryDate']).toISOString()),
        'smallSettlement': value['smallSettlement'],
        'contactPerson': ModelCreditNoteResponseContactPersonToJSON(value['contactPerson']),
        'taxRate': value['taxRate'],
        'taxRule': ModelCreditNoteResponseTaxRuleToJSON(value['taxRule']),
        'taxSet': ModelCreditNoteResponseTaxSetToJSON(value['taxSet']),
