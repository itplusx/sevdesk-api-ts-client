...
import type { ModelContactParent } from './ModelContactParent';
import {
    ModelContactParentFromJSON,
    ModelContactParentFromJSONTyped,
    ModelContactParentToJSON,
    ModelContactParentToJSONTyped,
} from './ModelContactParent';
import type { ModelContactCategory } from './ModelContactCategory';
import {
    ModelContactCategoryFromJSON,
    ModelContactCategoryFromJSONTyped,
    ModelContactCategoryToJSON,
    ModelContactCategoryToJSONTyped,
} from './ModelContactCategory';
...
export interface ModelContact {
    ...
    /**
     * 
     * @type {ModelContactParent}
     * @memberof ModelContact
     */
    parent?: ModelContactParent | null;
    /**
...
/**
 * Check if a given object implements the ModelContact interface.
 */
export function instanceOfModelContact(value: object): value is ModelContact {
    if (!('category' in value) || value['category'] === undefined) return false;
    return true;
}

export function ModelContactFromJSON(json: any): ModelContact {
    return ModelContactFromJSONTyped(json, false);
}

export function ModelContactFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelContact {
    if (json == null) {
        return json;
    }
    return {
        ...
        'parent': json['parent'] == null ? undefined : ModelContactParentFromJSON(json['parent']),
        'surename': json['surename'] == null ? undefined : json['surename'],
        'familyname': json['familyname'] == null ? undefined : json['familyname'],
        'titel': json['titel'] == null ? undefined : json['titel'],
        'category': ModelContactCategoryFromJSON(json['category']),
...
export function ModelContactToJSON(json: any): ModelContact {
    return ModelContactToJSONTyped(json, false);
}

export function ModelContactToJSONTyped(value?: ModelContact | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'parent': ModelContactParentToJSON(value['parent']),
        'surename': value['surename'],
        'familyname': value['familyname'],
        'titel': value['titel'],
        'category': ModelContactCategoryToJSON(value['category']),
