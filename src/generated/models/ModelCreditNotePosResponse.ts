...
import type { ModelCreditNotePosResponsePart } from './ModelCreditNotePosResponsePart';
import {
    ModelCreditNotePosResponsePartFromJSON,
    ModelCreditNotePosResponsePartFromJSONTyped,
    ModelCreditNotePosResponsePartToJSON,
    ModelCreditNotePosResponsePartToJSONTyped,
} from './ModelCreditNotePosResponsePart';
import type { ModelCreditNotePosResponseUnity } from './ModelCreditNotePosResponseUnity';
import {
    ModelCreditNotePosResponseUnityFromJSON,
    ModelCreditNotePosResponseUnityFromJSONTyped,
    ModelCreditNotePosResponseUnityToJSON,
    ModelCreditNotePosResponseUnityToJSONTyped,
} from './ModelCreditNotePosResponseUnity';
import type { ModelCreditNotePosResponseCreditNote } from './ModelCreditNotePosResponseCreditNote';
import {
    ModelCreditNotePosResponseCreditNoteFromJSON,
    ModelCreditNotePosResponseCreditNoteFromJSONTyped,
    ModelCreditNotePosResponseCreditNoteToJSON,
    ModelCreditNotePosResponseCreditNoteToJSONTyped,
} from './ModelCreditNotePosResponseCreditNote';
import type { ModelCreditNotePosResponseSevClient } from './ModelCreditNotePosResponseSevClient';
import {
    ModelCreditNotePosResponseSevClientFromJSON,
    ModelCreditNotePosResponseSevClientFromJSONTyped,
    ModelCreditNotePosResponseSevClientToJSON,
    ModelCreditNotePosResponseSevClientToJSONTyped,
} from './ModelCreditNotePosResponseSevClient';

/**
 * creditNote position model
 * @export
 * @interface ModelCreditNotePosResponse
 */
export interface ModelCreditNotePosResponse {
    /**
     * The creditNote position id
     * @type {string}
     * @memberof ModelCreditNotePosResponse
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNotePosResponseCreditNote}
     * @memberof ModelCreditNotePosResponse
     */
    creditNote: ModelCreditNotePosResponseCreditNote;
    /**
     * 
     * @type {ModelCreditNotePosResponsePart}
     * @memberof ModelCreditNotePosResponse
     */
    ...
    /**
     * 
     * @type {ModelCreditNotePosResponseUnity}
     * @memberof ModelCreditNotePosResponse
     */
    unity: ModelCreditNotePosResponseUnity;
    /**
     * 
     * @type {ModelCreditNotePosResponseSevClient}
     * @memberof ModelCreditNotePosResponse
     */
    sevClient?: ModelCreditNotePosResponseSevClient;
    /**
...
/**
 * Check if a given object implements the ModelCreditNotePosResponse interface.
 */
export function instanceOfModelCreditNotePosResponse(value: object): value is ModelCreditNotePosResponse {
    if (!('creditNote' in value) || value['creditNote'] === undefined) return false;
    if (!('quantity' in value) || value['quantity'] === undefined) return false;
    if (!('unity' in value) || value['unity'] === undefined) return false;
    if (!('taxRate' in value) || value['taxRate'] === undefined) return false;
    return true;
}

export function ModelCreditNotePosResponseFromJSON(json: any): ModelCreditNotePosResponse {
    return ModelCreditNotePosResponseFromJSONTyped(json, false);
}

export function ModelCreditNotePosResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCreditNotePosResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'creditNote': ModelCreditNotePosResponseCreditNoteFromJSON(json['creditNote']),
        'part': json['part'] == null ? undefined : ModelCreditNotePosResponsePartFromJSON(json['part']),
        'quantity': json['quantity'],
        'price': json['price'] == null ? undefined : json['price'],
        'priceNet': json['priceNet'] == null ? undefined : json['priceNet'],
        'priceTax': json['priceTax'] == null ? undefined : json['priceTax'],
        'priceGross': json['priceGross'] == null ? undefined : json['priceGross'],
        'name': json['name'] == null ? undefined : json['name'],
        'unity': ModelCreditNotePosResponseUnityFromJSON(json['unity']),
        'sevClient': json['sevClient'] == null ? undefined : ModelCreditNotePosResponseSevClientFromJSON(json['sevClient']),
        'positionNumber': json['positionNumber'] == null ? undefined : json['positionNumber'],
        'text': json['text'] == null ? undefined : json['text'],
        'discount': json['discount'] == null ? undefined : json['discount'],
        'optional': json['optional'] == null ? undefined : json['optional'],
        'taxRate': json['taxRate'],
        'sumDiscount': json['sumDiscount'] == null ? undefined : json['sumDiscount'],
    };
}

export function ModelCreditNotePosResponseToJSON(json: any): ModelCreditNotePosResponse {
    return ModelCreditNotePosResponseToJSONTyped(json, false);
}

export function ModelCreditNotePosResponseToJSONTyped(value?: Omit<ModelCreditNotePosResponse, 'id'|'objectName'|'create'|'update'|'priceNet'|'sumDiscount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'creditNote': ModelCreditNotePosResponseCreditNoteToJSON(value['creditNote']),
        'part': ModelCreditNotePosResponsePartToJSON(value['part']),
        'quantity': value['quantity'],
        'price': value['price'],
        'priceTax': value['priceTax'],
        'priceGross': value['priceGross'],
        'name': value['name'],
        'unity': ModelCreditNotePosResponseUnityToJSON(value['unity']),
        'sevClient': ModelCreditNotePosResponseSevClientToJSON(value['sevClient']),
