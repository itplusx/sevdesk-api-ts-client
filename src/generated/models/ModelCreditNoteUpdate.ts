...
import type { ModelCreditNoteAddressCountry } from './ModelCreditNoteAddressCountry';
import {
    ModelCreditNoteAddressCountryFromJSON,
    ModelCreditNoteAddressCountryFromJSONTyped,
    ModelCreditNoteAddressCountryToJSON,
    ModelCreditNoteAddressCountryToJSONTyped,
} from './ModelCreditNoteAddressCountry';
...
import type { ModelCreditNoteSevClient } from './ModelCreditNoteSevClient';
import {
    ModelCreditNoteSevClientFromJSON,
    ModelCreditNoteSevClientFromJSONTyped,
    ModelCreditNoteSevClientToJSON,
    ModelCreditNoteSevClientToJSONTyped,
} from './ModelCreditNoteSevClient';
import type { ModelCreditNoteTaxSet } from './ModelCreditNoteTaxSet';
import {
    ModelCreditNoteTaxSetFromJSON,
    ModelCreditNoteTaxSetFromJSONTyped,
    ModelCreditNoteTaxSetToJSON,
    ModelCreditNoteTaxSetToJSONTyped,
} from './ModelCreditNoteTaxSet';
import type { ModelCreditNoteUpdateContactPerson } from './ModelCreditNoteUpdateContactPerson';
import {
    ModelCreditNoteUpdateContactPersonFromJSON,
    ModelCreditNoteUpdateContactPersonFromJSONTyped,
    ModelCreditNoteUpdateContactPersonToJSON,
    ModelCreditNoteUpdateContactPersonToJSONTyped,
} from './ModelCreditNoteUpdateContactPerson';
...
import type { ModelCreditNoteUpdateContact } from './ModelCreditNoteUpdateContact';
import {
    ModelCreditNoteUpdateContactFromJSON,
    ModelCreditNoteUpdateContactFromJSONTyped,
    ModelCreditNoteUpdateContactToJSON,
    ModelCreditNoteUpdateContactToJSONTyped,
} from './ModelCreditNoteUpdateContact';

/**
 * creditNote model
 * @export
 * @interface ModelCreditNoteUpdate
 */
export interface ModelCreditNoteUpdate {
    /**
     * The creditNote id
     * @type {number}
     * @memberof ModelCreditNoteUpdate
     */
    readonly id?: number;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNoteUpdateContact}
     * @memberof ModelCreditNoteUpdate
     */
    contact?: ModelCreditNoteUpdateContact | null;
    /**
     ...
     * @memberof ModelCreditNoteUpdate
     */
    status?: ModelCreditNoteUpdateStatusEnum;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNoteAddressCountry}
     * @memberof ModelCreditNoteUpdate
     */
    addressCountry?: ModelCreditNoteAddressCountry | null;
    /**
     * 
    ...
    /**
     * 
     * @type {ModelCreditNoteSevClient}
     * @memberof ModelCreditNoteUpdate
     */
    sevClient?: ModelCreditNoteSevClient;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNoteUpdateContactPerson}
     * @memberof ModelCreditNoteUpdate
     */
    contactPerson?: ModelCreditNoteUpdateContactPerson | null;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNoteTaxSet}
     * @memberof ModelCreditNoteUpdate
     */
    taxSet?: ModelCreditNoteTaxSet | null;
    /**
     ...
     * @memberof ModelCreditNoteUpdate
     */
    sendType?: ModelCreditNoteUpdateSendTypeEnum | null;
}
 ...
 * @export
 */
export const ModelCreditNoteUpdateStatusEnum = {
    _100: '100',
    _200: '200',
    _750: '750',
    _1000: '1000'
} as const;
export type ModelCreditNoteUpdateStatusEnum = typeof ModelCreditNoteUpdateStatusEnum[keyof typeof ModelCreditNoteUpdateStatusEnum];

/**
 * @export
 */
export const ModelCreditNoteUpdateSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type ModelCreditNoteUpdateSendTypeEnum = typeof ModelCreditNoteUpdateSendTypeEnum[keyof typeof ModelCreditNoteUpdateSendTypeEnum];


/**
 * Check if a given object implements the ModelCreditNoteUpdate interface.
 */
export function instanceOfModelCreditNoteUpdate(value: object): value is ModelCreditNoteUpdate {
    return true;
}

export function ModelCreditNoteUpdateFromJSON(json: any): ModelCreditNoteUpdate {
    return ModelCreditNoteUpdateFromJSONTyped(json, false);
}

export function ModelCreditNoteUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCreditNoteUpdate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'contact': json['contact'] == null ? undefined : ModelCreditNoteUpdateContactFromJSON(json['contact']),
        ...
        'addressCountry': json['addressCountry'] == null ? undefined : ModelCreditNoteAddressCountryFromJSON(json['addressCountry']),
        'createUser': json['createUser'] == null ? undefined : ModelCreditNoteCreateUserFromJSON(json['createUser']),
        'sevClient': json['sevClient'] == null ? undefined : ModelCreditNoteSevClientFromJSON(json['sevClient']),
        ...
        'contactPerson': json['contactPerson'] == null ? undefined : ModelCreditNoteUpdateContactPersonFromJSON(json['contactPerson']),
        ...
        'taxSet': json['taxSet'] == null ? undefined : ModelCreditNoteTaxSetFromJSON(json['taxSet']),
...
export function ModelCreditNoteUpdateToJSON(json: any): ModelCreditNoteUpdate {
    return ModelCreditNoteUpdateToJSONTyped(json, false);
}

export function ModelCreditNoteUpdateToJSONTyped(value?: Omit<ModelCreditNoteUpdate, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'contact': ModelCreditNoteUpdateContactToJSON(value['contact']),
        ...
        'addressCountry': ModelCreditNoteAddressCountryToJSON(value['addressCountry']),
        'createUser': ModelCreditNoteCreateUserToJSON(value['createUser']),
        'sevClient': ModelCreditNoteSevClientToJSON(value['sevClient']),
        'deliveryDate': value['deliveryDate'] == null ? undefined : ((value['deliveryDate']).toISOString()),
        'smallSettlement': value['smallSettlement'],
        'contactPerson': ModelCreditNoteUpdateContactPersonToJSON(value['contactPerson']),
        'taxRate': value['taxRate'],
        'taxRule': ModelCreditNoteResponseTaxRuleToJSON(value['taxRule']),
        'taxSet': ModelCreditNoteTaxSetToJSON(value['taxSet']),
