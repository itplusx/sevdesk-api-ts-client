...
import type { ModelOrderUpdateAddressCountry } from './ModelOrderUpdateAddressCountry';
import {
    ModelOrderUpdateAddressCountryFromJSON,
    ModelOrderUpdateAddressCountryFromJSONTyped,
    ModelOrderUpdateAddressCountryToJSON,
    ModelOrderUpdateAddressCountryToJSONTyped,
} from './ModelOrderUpdateAddressCountry';
import type { ModelOrderOrigin } from './ModelOrderOrigin';
import {
    ModelOrderOriginFromJSON,
    ModelOrderOriginFromJSONTyped,
    ModelOrderOriginToJSON,
    ModelOrderOriginToJSONTyped,
} from './ModelOrderOrigin';
import type { ModelOrderUpdateContact } from './ModelOrderUpdateContact';
import {
    ModelOrderUpdateContactFromJSON,
    ModelOrderUpdateContactFromJSONTyped,
    ModelOrderUpdateContactToJSON,
    ModelOrderUpdateContactToJSONTyped,
} from './ModelOrderUpdateContact';
import type { ModelOrderUpdateTaxSet } from './ModelOrderUpdateTaxSet';
import {
    ModelOrderUpdateTaxSetFromJSON,
    ModelOrderUpdateTaxSetFromJSONTyped,
    ModelOrderUpdateTaxSetToJSON,
    ModelOrderUpdateTaxSetToJSONTyped,
} from './ModelOrderUpdateTaxSet';
...
import type { ModelOrderUpdateSevClient } from './ModelOrderUpdateSevClient';
import {
    ModelOrderUpdateSevClientFromJSON,
    ModelOrderUpdateSevClientFromJSONTyped,
    ModelOrderUpdateSevClientToJSON,
    ModelOrderUpdateSevClientToJSONTyped,
} from './ModelOrderUpdateSevClient';
import type { ModelOrderUpdateCreateUser } from './ModelOrderUpdateCreateUser';
import {
    ModelOrderUpdateCreateUserFromJSON,
    ModelOrderUpdateCreateUserFromJSONTyped,
    ModelOrderUpdateCreateUserToJSON,
    ModelOrderUpdateCreateUserToJSONTyped,
} from './ModelOrderUpdateCreateUser';
import type { ModelOrderUpdateContactPerson } from './ModelOrderUpdateContactPerson';
import {
    ModelOrderUpdateContactPersonFromJSON,
    ModelOrderUpdateContactPersonFromJSONTyped,
    ModelOrderUpdateContactPersonToJSON,
    ModelOrderUpdateContactPersonToJSONTyped,
} from './ModelOrderUpdateContactPerson';
...
export interface ModelOrderUpdate {
    ...
    /**
     * 
     * @type {ModelOrderUpdateContact}
     * @memberof ModelOrderUpdate
     */
    contact?: ModelOrderUpdateContact | null;
    /**
     ...
     * @memberof ModelOrderUpdate
     */
    status?: ModelOrderUpdateStatusEnum | null;
    /**
    ...
    /**
     * 
     * @type {ModelOrderUpdateAddressCountry}
     * @memberof ModelOrderUpdate
     */
    addressCountry?: ModelOrderUpdateAddressCountry | null;
    /**
     * 
     * @type {ModelOrderUpdateCreateUser}
     * @memberof ModelOrderUpdate
     */
    createUser?: ModelOrderUpdateCreateUser;
    /**
     * 
     * @type {ModelOrderUpdateSevClient}
     * @memberof ModelOrderUpdate
     */
    sevClient?: ModelOrderUpdateSevClient;
    /**
    ...
    /**
     * 
     * @type {ModelOrderOrigin}
     * @memberof ModelOrderUpdate
     */
    origin?: ModelOrderOrigin | null;
    /**
    ...
    /**
     * 
     * @type {ModelOrderUpdateContactPerson}
     * @memberof ModelOrderUpdate
     */
    contactPerson?: ModelOrderUpdateContactPerson;
    /**
    ...
    /**
     * 
     * @type {ModelOrderUpdateTaxSet}
     * @memberof ModelOrderUpdate
     */
    taxSet?: ModelOrderUpdateTaxSet | null;
    /**
     ...
     * @memberof ModelOrderUpdate
     */
    orderType?: ModelOrderUpdateOrderTypeEnum | null;
    /**
     ...
     * @memberof ModelOrderUpdate
     */
    sendType?: ModelOrderUpdateSendTypeEnum | null;
}
 ...
 * @export
 */
export const ModelOrderUpdateStatusEnum = {
    NUMBER_100: 100,
    NUMBER_200: 200,
    NUMBER_300: 300,
    NUMBER_500: 500,
...
export type ModelOrderUpdateStatusEnum = typeof ModelOrderUpdateStatusEnum[keyof typeof ModelOrderUpdateStatusEnum];

/**
 * @export
 */
export const ModelOrderUpdateOrderTypeEnum = {
    An: 'AN',
    Ab: 'AB',
    Li: 'LI'
} as const;
export type ModelOrderUpdateOrderTypeEnum = typeof ModelOrderUpdateOrderTypeEnum[keyof typeof ModelOrderUpdateOrderTypeEnum];

/**
 * @export
 */
export const ModelOrderUpdateSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type ModelOrderUpdateSendTypeEnum = typeof ModelOrderUpdateSendTypeEnum[keyof typeof ModelOrderUpdateSendTypeEnum];


/**
 * Check if a given object implements the ModelOrderUpdate interface.
 */
export function instanceOfModelOrderUpdate(value: object): value is ModelOrderUpdate {
    return true;
}

export function ModelOrderUpdateFromJSON(json: any): ModelOrderUpdate {
    return ModelOrderUpdateFromJSONTyped(json, false);
}

export function ModelOrderUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelOrderUpdate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'contact': json['contact'] == null ? undefined : ModelOrderUpdateContactFromJSON(json['contact']),
        ...
        'addressCountry': json['addressCountry'] == null ? undefined : ModelOrderUpdateAddressCountryFromJSON(json['addressCountry']),
        'createUser': json['createUser'] == null ? undefined : ModelOrderUpdateCreateUserFromJSON(json['createUser']),
        'sevClient': json['sevClient'] == null ? undefined : ModelOrderUpdateSevClientFromJSON(json['sevClient']),
        ...
        'origin': json['origin'] == null ? undefined : ModelOrderOriginFromJSON(json['origin']),
        'version': json['version'] == null ? undefined : json['version'],
        'smallSettlement': json['smallSettlement'] == null ? undefined : json['smallSettlement'],
        'contactPerson': json['contactPerson'] == null ? undefined : ModelOrderUpdateContactPersonFromJSON(json['contactPerson']),
        ...
        'taxSet': json['taxSet'] == null ? undefined : ModelOrderUpdateTaxSetFromJSON(json['taxSet']),
...
export function ModelOrderUpdateToJSON(json: any): ModelOrderUpdate {
    return ModelOrderUpdateToJSONTyped(json, false);
}

export function ModelOrderUpdateToJSONTyped(value?: Omit<ModelOrderUpdate, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'contact': ModelOrderUpdateContactToJSON(value['contact']),
        'orderDate': value['orderDate'] === null ? null : ((value['orderDate'] as any)?.toISOString()),
        'status': value['status'],
        'header': value['header'],
        'headText': value['headText'],
        'footText': value['footText'],
        'addressCountry': ModelOrderUpdateAddressCountryToJSON(value['addressCountry']),
        'createUser': ModelOrderUpdateCreateUserToJSON(value['createUser']),
        'sevClient': ModelOrderUpdateSevClientToJSON(value['sevClient']),
        'deliveryTerms': value['deliveryTerms'],
        'paymentTerms': value['paymentTerms'],
        'origin': ModelOrderOriginToJSON(value['origin']),
        'version': value['version'],
        'smallSettlement': value['smallSettlement'],
        'contactPerson': ModelOrderUpdateContactPersonToJSON(value['contactPerson']),
        'taxRate': value['taxRate'],
        'taxRule': ModelCreditNoteResponseTaxRuleToJSON(value['taxRule']),
        'taxSet': ModelOrderUpdateTaxSetToJSON(value['taxSet']),
