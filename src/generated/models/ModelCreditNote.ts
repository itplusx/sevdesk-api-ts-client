...
import type { ModelCreditNoteContact } from './ModelCreditNoteContact';
import {
    ModelCreditNoteContactFromJSON,
    ModelCreditNoteContactFromJSONTyped,
    ModelCreditNoteContactToJSON,
    ModelCreditNoteContactToJSONTyped,
} from './ModelCreditNoteContact';
import type { ModelCreditNoteContactPerson } from './ModelCreditNoteContactPerson';
import {
    ModelCreditNoteContactPersonFromJSON,
    ModelCreditNoteContactPersonFromJSONTyped,
    ModelCreditNoteContactPersonToJSON,
    ModelCreditNoteContactPersonToJSONTyped,
} from './ModelCreditNoteContactPerson';
...
export interface ModelCreditNote {
     ...
     * @memberof ModelCreditNote
     */
    status: ModelCreditNoteStatusEnum;
    /**
    ...
    /**
     * 
     * @type {ModelCreditNoteContactPerson}
     * @memberof ModelCreditNote
     */
    contactPerson: ModelCreditNoteContactPerson;
    /**
     * 
     ...
     * @memberof ModelCreditNote
     */
    bookingCategory: ModelCreditNoteBookingCategoryEnum;
    /**
     ...
     * @memberof ModelCreditNote
     */
    sendType?: ModelCreditNoteSendTypeEnum | null;
}
 ...
 * @export
 */
export const ModelCreditNoteStatusEnum = {
    _100: '100',
    _200: '200',
    _300: '300',
    _500: '500',
...
export type ModelCreditNoteStatusEnum = typeof ModelCreditNoteStatusEnum[keyof typeof ModelCreditNoteStatusEnum];

/**
 * @export
 */
export const ModelCreditNoteBookingCategoryEnum = {
    Provision: 'PROVISION',
...
export type ModelCreditNoteBookingCategoryEnum = typeof ModelCreditNoteBookingCategoryEnum[keyof typeof ModelCreditNoteBookingCategoryEnum];

/**
 * @export
 */
export const ModelCreditNoteSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type ModelCreditNoteSendTypeEnum = typeof ModelCreditNoteSendTypeEnum[keyof typeof ModelCreditNoteSendTypeEnum];


/**
 * Check if a given object implements the ModelCreditNote interface.
 */
export function instanceOfModelCreditNote(value: object): value is ModelCreditNote {
    ...
    if (!('creditNoteDate' in value) || value['creditNoteDate'] === undefined) return false;
    ...
    if (!('bookingCategory' in value) || value['bookingCategory'] === undefined) return false;
    if (!('currency' in value) || value['currency'] === undefined) return false;
    return true;
}

export function ModelCreditNoteFromJSON(json: any): ModelCreditNote {
    return ModelCreditNoteFromJSONTyped(json, false);
}

export function ModelCreditNoteFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCreditNote {
    if (json == null) {
        return json;
    }
    return {
        ...
        'contact': ModelCreditNoteContactFromJSON(json['contact']),
        'creditNoteDate': (new Date(json['creditNoteDate'])),
        'status': json['status'],
        'header': json['header'],
        'headText': json['headText'] == null ? undefined : json['headText'],
        'footText': json['footText'] == null ? undefined : json['footText'],
        'addressCountry': ModelCreditNoteAddressCountryFromJSON(json['addressCountry']),
        ...
        'contactPerson': ModelCreditNoteContactPersonFromJSON(json['contactPerson']),
        ...
        'bookingCategory': json['bookingCategory'],
...
export function ModelCreditNoteToJSON(json: any): ModelCreditNote {
    return ModelCreditNoteToJSONTyped(json, false);
}

export function ModelCreditNoteToJSONTyped(value?: Omit<ModelCreditNote, 'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'contact': ModelCreditNoteContactToJSON(value['contact']),
        'creditNoteDate': ((value['creditNoteDate']).toISOString()),
        'status': value['status'],
        'header': value['header'],
        ...
        'contactPerson': ModelCreditNoteContactPersonToJSON(value['contactPerson']),
        ...
        'bookingCategory': value['bookingCategory'],
