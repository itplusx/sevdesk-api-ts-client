...
import type { ModelCheckAccountResponseSevClient } from './ModelCheckAccountResponseSevClient';
import {
    ModelCheckAccountResponseSevClientFromJSON,
    ModelCheckAccountResponseSevClientFromJSONTyped,
    ModelCheckAccountResponseSevClientToJSON,
    ModelCheckAccountResponseSevClientToJSONTyped,
} from './ModelCheckAccountResponseSevClient';

/**
 * CheckAccount model. Responsible for the payment accounts.
 * @export
 * @interface ModelCheckAccountResponse
 */
export interface ModelCheckAccountResponse {
    /**
     * The check account id
     * @type {string}
     * @memberof ModelCheckAccountResponse
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelCheckAccountResponseSevClient}
     * @memberof ModelCheckAccountResponse
     */
    sevClient?: ModelCheckAccountResponseSevClient;
    /**
     ...
     * @memberof ModelCheckAccountResponse
     */
    type?: ModelCheckAccountResponseTypeEnum;
    /**
     * Import type, for accounts that are type "online" but not connected to a data provider.
     * @type {string}
     * @memberof ModelCheckAccountResponse
     */
    importType?: ModelCheckAccountResponseImportTypeEnum | null;
    /**
     ...
     * @memberof ModelCheckAccountResponse
     */
    status?: ModelCheckAccountResponseStatusEnum;
    /**
 ...
 * @export
 */
export const ModelCheckAccountResponseTypeEnum = {
    Online: 'online',
    Offline: 'offline',
    Register: 'register'
} as const;
export type ModelCheckAccountResponseTypeEnum = typeof ModelCheckAccountResponseTypeEnum[keyof typeof ModelCheckAccountResponseTypeEnum];

/**
 * @export
 */
export const ModelCheckAccountResponseImportTypeEnum = {
    Csv: 'CSV',
    Mt940: 'MT940'
} as const;
export type ModelCheckAccountResponseImportTypeEnum = typeof ModelCheckAccountResponseImportTypeEnum[keyof typeof ModelCheckAccountResponseImportTypeEnum];

/**
 * @export
 */
export const ModelCheckAccountResponseStatusEnum = {
    _0: '0',
    _100: '100'
} as const;
export type ModelCheckAccountResponseStatusEnum = typeof ModelCheckAccountResponseStatusEnum[keyof typeof ModelCheckAccountResponseStatusEnum];


/**
 * Check if a given object implements the ModelCheckAccountResponse interface.
 */
export function instanceOfModelCheckAccountResponse(value: object): value is ModelCheckAccountResponse {
    return true;
}

export function ModelCheckAccountResponseFromJSON(json: any): ModelCheckAccountResponse {
    return ModelCheckAccountResponseFromJSONTyped(json, false);
}

export function ModelCheckAccountResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCheckAccountResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sevClient': json['sevClient'] == null ? undefined : ModelCheckAccountResponseSevClientFromJSON(json['sevClient']),
        ...
        'baseAccount': json['baseAccount'] == null ? undefined : json['baseAccount'],
        'priority': json['priority'] == null ? undefined : json['priority'],
        'status': json['status'] == null ? undefined : json['status'],
        'balance': json['balance'] == null ? undefined : json['balance'],
        'bankServer': json['bankServer'] == null ? undefined : json['bankServer'],
        'autoMapTransactions': json['autoMapTransactions'] == null ? undefined : json['autoMapTransactions'],
        'autoSyncTransactions': json['autoSyncTransactions'] == null ? undefined : json['autoSyncTransactions'],
...
export function ModelCheckAccountResponseToJSON(json: any): ModelCheckAccountResponse {
    return ModelCheckAccountResponseToJSONTyped(json, false);
}

export function ModelCheckAccountResponseToJSONTyped(value?: Omit<ModelCheckAccountResponse, 'id'|'objectName'|'create'|'update'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sevClient': ModelCheckAccountResponseSevClientToJSON(value['sevClient']),
        'name': value['name'],
        'iban': value['iban'],
        'type': value['type'],
        ...
        'bankServer': value['bankServer'],
        'autoMapTransactions': value['autoMapTransactions'],
        'autoSyncTransactions': value['autoSyncTransactions'],
