...
import type { ModelVoucherResponseCreateUser } from './ModelVoucherResponseCreateUser';
import {
    ModelVoucherResponseCreateUserFromJSON,
    ModelVoucherResponseCreateUserFromJSONTyped,
    ModelVoucherResponseCreateUserToJSON,
    ModelVoucherResponseCreateUserToJSONTyped,
} from './ModelVoucherResponseCreateUser';
import type { ModelVoucherResponseTaxSet } from './ModelVoucherResponseTaxSet';
import {
    ModelVoucherResponseTaxSetFromJSON,
    ModelVoucherResponseTaxSetFromJSONTyped,
    ModelVoucherResponseTaxSetToJSON,
    ModelVoucherResponseTaxSetToJSONTyped,
} from './ModelVoucherResponseTaxSet';
import type { ModelVoucherTaxRule } from './ModelVoucherTaxRule';
import {
    ModelVoucherTaxRuleFromJSON,
    ModelVoucherTaxRuleFromJSONTyped,
    ModelVoucherTaxRuleToJSON,
    ModelVoucherTaxRuleToJSONTyped,
} from './ModelVoucherTaxRule';
import type { ModelVoucherResponseCostCentre } from './ModelVoucherResponseCostCentre';
import {
    ModelVoucherResponseCostCentreFromJSON,
    ModelVoucherResponseCostCentreFromJSONTyped,
    ModelVoucherResponseCostCentreToJSON,
    ModelVoucherResponseCostCentreToJSONTyped,
} from './ModelVoucherResponseCostCentre';
import type { ModelVoucherResponseDocument } from './ModelVoucherResponseDocument';
import {
    ModelVoucherResponseDocumentFromJSON,
    ModelVoucherResponseDocumentFromJSONTyped,
    ModelVoucherResponseDocumentToJSON,
    ModelVoucherResponseDocumentToJSONTyped,
} from './ModelVoucherResponseDocument';
import type { ModelVoucherResponseSevClient } from './ModelVoucherResponseSevClient';
import {
    ModelVoucherResponseSevClientFromJSON,
    ModelVoucherResponseSevClientFromJSONTyped,
    ModelVoucherResponseSevClientToJSON,
    ModelVoucherResponseSevClientToJSONTyped,
} from './ModelVoucherResponseSevClient';
import type { ModelVoucherResponseSupplier } from './ModelVoucherResponseSupplier';
import {
    ModelVoucherResponseSupplierFromJSON,
    ModelVoucherResponseSupplierFromJSONTyped,
    ModelVoucherResponseSupplierToJSON,
    ModelVoucherResponseSupplierToJSONTyped,
} from './ModelVoucherResponseSupplier';

/**
 * 
 * @export
 * @interface VoucherResetToOpen200ResponseObjects
 */
export interface VoucherResetToOpen200ResponseObjects {
    /**
     * The voucher id
     * @type {string}
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherResponseSevClient}
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    sevClient?: ModelVoucherResponseSevClient;
    /**
     * 
     * @type {ModelVoucherResponseCreateUser}
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    createUser?: ModelVoucherResponseCreateUser;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherResponseSupplier}
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    supplier?: ModelVoucherResponseSupplier | null;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherResponseDocument}
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    document?: ModelVoucherResponseDocument | null;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherTaxRule}
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    taxRule?: ModelVoucherTaxRule;
    /**
     ...
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    creditDebit?: VoucherResetToOpen200ResponseObjectsCreditDebitEnum | null;
    /**
     * 
     * @type {ModelVoucherResponseCostCentre}
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    costCentre?: ModelVoucherResponseCostCentre;
    /**
     ...
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    voucherType?: VoucherResetToOpen200ResponseObjectsVoucherTypeEnum | null;
    /**
     ...
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    propertyForeignCurrencyDeadline?: Date | null;
    /**
     ...
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    recurringInterval?: VoucherResetToOpen200ResponseObjectsRecurringIntervalEnum | null;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherResponseTaxSet}
     * @memberof VoucherResetToOpen200ResponseObjects
     */
    taxSet?: ModelVoucherResponseTaxSet | null;
    /**
 ...
 * @export
 */
export const VoucherResetToOpen200ResponseObjectsCreditDebitEnum = {
    C: 'C',
    D: 'D'
} as const;
export type VoucherResetToOpen200ResponseObjectsCreditDebitEnum = typeof VoucherResetToOpen200ResponseObjectsCreditDebitEnum[keyof typeof VoucherResetToOpen200ResponseObjectsCreditDebitEnum];

/**
 * @export
 */
export const VoucherResetToOpen200ResponseObjectsVoucherTypeEnum = {
    Vou: 'VOU',
    Rv: 'RV'
} as const;
export type VoucherResetToOpen200ResponseObjectsVoucherTypeEnum = typeof VoucherResetToOpen200ResponseObjectsVoucherTypeEnum[keyof typeof VoucherResetToOpen200ResponseObjectsVoucherTypeEnum];

/**
 * @export
 */
export const VoucherResetToOpen200ResponseObjectsRecurringIntervalEnum = {
    P0Y0M1W: 'P0Y0M1W',
    P0Y0M2W: 'P0Y0M2W',
    P0Y1M0W: 'P0Y1M0W',
    P0Y3M0W: 'P0Y3M0W',
...
export type VoucherResetToOpen200ResponseObjectsRecurringIntervalEnum = typeof VoucherResetToOpen200ResponseObjectsRecurringIntervalEnum[keyof typeof VoucherResetToOpen200ResponseObjectsRecurringIntervalEnum];


/**
 * Check if a given object implements the VoucherResetToOpen200ResponseObjects interface.
 */
export function instanceOfVoucherResetToOpen200ResponseObjects(value: object): value is VoucherResetToOpen200ResponseObjects {
    return true;
}

export function VoucherResetToOpen200ResponseObjectsFromJSON(json: any): VoucherResetToOpen200ResponseObjects {
    return VoucherResetToOpen200ResponseObjectsFromJSONTyped(json, false);
}

export function VoucherResetToOpen200ResponseObjectsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VoucherResetToOpen200ResponseObjects {
    if (json == null) {
        return json;
    }
    return {
        ...
        'mapAll': json['mapAll'] == null ? undefined : json['mapAll'],
        'create': json['create'] == null ? undefined : (new Date(json['create'])),
        'update': json['update'] == null ? undefined : (new Date(json['update'])),
        'sevClient': json['sevClient'] == null ? undefined : ModelVoucherResponseSevClientFromJSON(json['sevClient']),
        'createUser': json['createUser'] == null ? undefined : ModelVoucherResponseCreateUserFromJSON(json['createUser']),
        'voucherDate': json['voucherDate'] == null ? undefined : (new Date(json['voucherDate'])),
        'supplier': json['supplier'] == null ? undefined : ModelVoucherResponseSupplierFromJSON(json['supplier']),
        'supplierName': json['supplierName'] == null ? undefined : json['supplierName'],
        'description': json['description'] == null ? undefined : json['description'],
        'document': json['document'] == null ? undefined : ModelVoucherResponseDocumentFromJSON(json['document']),
        ...
        'taxRule': json['taxRule'] == null ? undefined : ModelVoucherTaxRuleFromJSON(json['taxRule']),
        'taxType': json['taxType'] == null ? undefined : json['taxType'],
        'creditDebit': json['creditDebit'] == null ? undefined : json['creditDebit'],
        'costCentre': json['costCentre'] == null ? undefined : ModelVoucherResponseCostCentreFromJSON(json['costCentre']),
        'voucherType': json['voucherType'] == null ? undefined : json['voucherType'],
        'currency': json['currency'] == null ? undefined : json['currency'],
        'propertyForeignCurrencyDeadline': json['propertyForeignCurrencyDeadline'] == null ? undefined : (new Date(json['propertyForeignCurrencyDeadline'])),
        'propertyExchangeRate': json['propertyExchangeRate'] == null ? undefined : json['propertyExchangeRate'],
        'recurringInterval': json['recurringInterval'] == null ? undefined : json['recurringInterval'],
        'recurringStartDate': json['recurringStartDate'] == null ? undefined : (new Date(json['recurringStartDate'])),
        'recurringNextVoucher': json['recurringNextVoucher'] == null ? undefined : (new Date(json['recurringNextVoucher'])),
        'recurringLastVoucher': json['recurringLastVoucher'] == null ? undefined : (new Date(json['recurringLastVoucher'])),
        'recurringEndDate': json['recurringEndDate'] == null ? undefined : (new Date(json['recurringEndDate'])),
        'enshrined': json['enshrined'] == null ? undefined : (new Date(json['enshrined'])),
        'taxSet': json['taxSet'] == null ? undefined : ModelVoucherResponseTaxSetFromJSON(json['taxSet']),
        ...
        'deliveryDateUntil': json['deliveryDateUntil'] == null ? undefined : (new Date(json['deliveryDateUntil'])),
    };
}

export function VoucherResetToOpen200ResponseObjectsToJSON(json: any): VoucherResetToOpen200ResponseObjects {
    return VoucherResetToOpen200ResponseObjectsToJSONTyped(json, false);
}

export function VoucherResetToOpen200ResponseObjectsToJSONTyped(value?: Omit<VoucherResetToOpen200ResponseObjects, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'sumDiscounts'|'sumDiscountsForeignCurrency'|'paidAmount'|'enshrined'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'mapAll': value['mapAll'],
        'sevClient': ModelVoucherResponseSevClientToJSON(value['sevClient']),
        'createUser': ModelVoucherResponseCreateUserToJSON(value['createUser']),
        'voucherDate': value['voucherDate'] === null ? null : ((value['voucherDate'] as any)?.toISOString()),
        'supplier': ModelVoucherResponseSupplierToJSON(value['supplier']),
        'supplierName': value['supplierName'],
        'description': value['description'],
        'document': ModelVoucherResponseDocumentToJSON(value['document']),
        'payDate': value['payDate'] === null ? null : ((value['payDate'] as any)?.toISOString()),
        'status': value['status'],
        'taxRule': ModelVoucherTaxRuleToJSON(value['taxRule']),
        'taxType': value['taxType'],
        'creditDebit': value['creditDebit'],
        'costCentre': ModelVoucherResponseCostCentreToJSON(value['costCentre']),
        'voucherType': value['voucherType'],
        'currency': value['currency'],
        'propertyForeignCurrencyDeadline': value['propertyForeignCurrencyDeadline'] === null ? null : ((value['propertyForeignCurrencyDeadline'] as any)?.toISOString()),
        'propertyExchangeRate': value['propertyExchangeRate'],
        'recurringInterval': value['recurringInterval'],
        'recurringStartDate': value['recurringStartDate'] === null ? null : ((value['recurringStartDate'] as any)?.toISOString()),
        'recurringNextVoucher': value['recurringNextVoucher'] === null ? null : ((value['recurringNextVoucher'] as any)?.toISOString()),
        'recurringLastVoucher': value['recurringLastVoucher'] === null ? null : ((value['recurringLastVoucher'] as any)?.toISOString()),
        'recurringEndDate': value['recurringEndDate'] === null ? null : ((value['recurringEndDate'] as any)?.toISOString()),
        'taxSet': ModelVoucherResponseTaxSetToJSON(value['taxSet']),
        'paymentDeadline': value['paymentDeadline'] === null ? null : ((value['paymentDeadline'] as any)?.toISOString()),
        'deliveryDate': value['deliveryDate'] == null ? undefined : ((value['deliveryDate']).toISOString()),
        'deliveryDateUntil': value['deliveryDateUntil'] === null ? null : ((value['deliveryDateUntil'] as any)?.toISOString()),
    };
}
