...
/**
 * Check if a given object implements the ModelOrderPos interface.
 */
export function instanceOfModelOrderPos(value: object): value is ModelOrderPos {
...
export function ModelOrderPosFromJSON(json: any): ModelOrderPos {
    return ModelOrderPosFromJSONTyped(json, false);
}

export function ModelOrderPosFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelOrderPos {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelOrderPosToJSON(json: any): ModelOrderPos {
    return ModelOrderPosToJSONTyped(json, false);
}

export function ModelOrderPosToJSONTyped(value?: Omit<ModelOrderPos, 'id'|'objectName'|'create'|'update'|'priceNet'|'sumDiscount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
