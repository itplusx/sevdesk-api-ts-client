...
import type { ModelOrderAddressCountry } from './ModelOrderAddressCountry';
import {
    ModelOrderAddressCountryFromJSON,
    ModelOrderAddressCountryFromJSONTyped,
    ModelOrderAddressCountryToJSON,
    ModelOrderAddressCountryToJSONTyped,
} from './ModelOrderAddressCountry';
import type { ModelOrderTaxSet } from './ModelOrderTaxSet';
import {
    ModelOrderTaxSetFromJSON,
    ModelOrderTaxSetFromJSONTyped,
    ModelOrderTaxSetToJSON,
    ModelOrderTaxSetToJSONTyped,
} from './ModelOrderTaxSet';
...
import type { ModelOrderContactPerson } from './ModelOrderContactPerson';
import {
    ModelOrderContactPersonFromJSON,
    ModelOrderContactPersonFromJSONTyped,
    ModelOrderContactPersonToJSON,
    ModelOrderContactPersonToJSONTyped,
} from './ModelOrderContactPerson';
import type { ModelOrderContact } from './ModelOrderContact';
import {
    ModelOrderContactFromJSON,
    ModelOrderContactFromJSONTyped,
    ModelOrderContactToJSON,
    ModelOrderContactToJSONTyped,
} from './ModelOrderContact';
...
export interface ModelOrder {
    ...
    /**
     * 
     * @type {ModelOrderAddressCountry}
     * @memberof ModelOrder
     */
    addressCountry: ModelOrderAddressCountry;
    /**
    ...
    /**
     * 
     * @type {ModelOrderContactPerson}
     * @memberof ModelOrder
     */
    contactPerson: ModelOrderContactPerson;
    /**
    ...
    /**
     * 
     * @type {ModelOrderTaxSet}
     * @memberof ModelOrder
     */
    taxSet?: ModelOrderTaxSet | null;
    /**
     ...
     * @memberof ModelOrder
     */
    orderType?: ModelOrderOrderTypeEnum;
    /**
     ...
     * @memberof ModelOrder
     */
    sendType?: ModelOrderSendTypeEnum | null;
    /**
     * 
 ...
 * @export
 */
export const ModelOrderOrderTypeEnum = {
    An: 'AN',
    Ab: 'AB',
    Li: 'LI'
} as const;
export type ModelOrderOrderTypeEnum = typeof ModelOrderOrderTypeEnum[keyof typeof ModelOrderOrderTypeEnum];

/**
 * @export
 */
export const ModelOrderSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type ModelOrderSendTypeEnum = typeof ModelOrderSendTypeEnum[keyof typeof ModelOrderSendTypeEnum];


/**
 * Check if a given object implements the ModelOrder interface.
 */
export function instanceOfModelOrder(value: object): value is ModelOrder {
...
export function ModelOrderFromJSON(json: any): ModelOrder {
    return ModelOrderFromJSONTyped(json, false);
}

export function ModelOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelOrder {
    if (json == null) {
        return json;
    }
    return {
        ...
        'contact': ModelOrderContactFromJSON(json['contact']),
        ...
        'addressCountry': ModelOrderAddressCountryFromJSON(json['addressCountry']),
        ...
        'contactPerson': ModelOrderContactPersonFromJSON(json['contactPerson']),
        'taxRate': json['taxRate'],
        'taxRule': ModelCreditNoteResponseTaxRuleFromJSON(json['taxRule']),
        'taxSet': json['taxSet'] == null ? undefined : ModelOrderTaxSetFromJSON(json['taxSet']),
...
export function ModelOrderToJSON(json: any): ModelOrder {
    return ModelOrderToJSONTyped(json, false);
}

export function ModelOrderToJSONTyped(value?: Omit<ModelOrder, 'id'|'create'|'update'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
