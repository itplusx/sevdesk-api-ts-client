...
import type { ModelCheckAccountTransactionResponseCheckAccount } from './ModelCheckAccountTransactionResponseCheckAccount';
import {
    ModelCheckAccountTransactionResponseCheckAccountFromJSON,
    ModelCheckAccountTransactionResponseCheckAccountFromJSONTyped,
    ModelCheckAccountTransactionResponseCheckAccountToJSON,
    ModelCheckAccountTransactionResponseCheckAccountToJSONTyped,
} from './ModelCheckAccountTransactionResponseCheckAccount';
import type { ModelCheckAccountTransactionResponseTargetTransaction } from './ModelCheckAccountTransactionResponseTargetTransaction';
import {
    ModelCheckAccountTransactionResponseTargetTransactionFromJSON,
    ModelCheckAccountTransactionResponseTargetTransactionFromJSONTyped,
    ModelCheckAccountTransactionResponseTargetTransactionToJSON,
    ModelCheckAccountTransactionResponseTargetTransactionToJSONTyped,
} from './ModelCheckAccountTransactionResponseTargetTransaction';
import type { ModelCheckAccountTransactionResponseSevClient } from './ModelCheckAccountTransactionResponseSevClient';
import {
    ModelCheckAccountTransactionResponseSevClientFromJSON,
    ModelCheckAccountTransactionResponseSevClientFromJSONTyped,
    ModelCheckAccountTransactionResponseSevClientToJSON,
    ModelCheckAccountTransactionResponseSevClientToJSONTyped,
} from './ModelCheckAccountTransactionResponseSevClient';
import type { ModelCheckAccountTransactionResponseSourceTransaction } from './ModelCheckAccountTransactionResponseSourceTransaction';
import {
    ModelCheckAccountTransactionResponseSourceTransactionFromJSON,
    ModelCheckAccountTransactionResponseSourceTransactionFromJSONTyped,
    ModelCheckAccountTransactionResponseSourceTransactionToJSON,
    ModelCheckAccountTransactionResponseSourceTransactionToJSONTyped,
} from './ModelCheckAccountTransactionResponseSourceTransaction';

/**
 * CheckAccountTransaction model. Responsible for the transactions on payment accounts.
 * @export
 * @interface ModelCheckAccountTransactionResponse
 */
export interface ModelCheckAccountTransactionResponse {
    /**
     * The check account transaction id
     * @type {string}
     * @memberof ModelCheckAccountTransactionResponse
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelCheckAccountTransactionResponseSevClient}
     * @memberof ModelCheckAccountTransactionResponse
     */
    sevClient?: ModelCheckAccountTransactionResponseSevClient;
    /**
    ...
    /**
     * 
     * @type {ModelCheckAccountTransactionResponseCheckAccount}
     * @memberof ModelCheckAccountTransactionResponse
     */
    checkAccount?: ModelCheckAccountTransactionResponseCheckAccount;
    /**
     ...
     * @memberof ModelCheckAccountTransactionResponse
     */
    readonly status?: ModelCheckAccountTransactionResponseStatusEnum;
    /**
     * 
     * @type {ModelCheckAccountTransactionResponseSourceTransaction}
     * @memberof ModelCheckAccountTransactionResponse
     */
    sourceTransaction?: ModelCheckAccountTransactionResponseSourceTransaction;
    /**
     * 
     * @type {ModelCheckAccountTransactionResponseTargetTransaction}
     * @memberof ModelCheckAccountTransactionResponse
     */
    targetTransaction?: ModelCheckAccountTransactionResponseTargetTransaction;
    /**
 ...
 * @export
 */
export const ModelCheckAccountTransactionResponseStatusEnum = {
    _100: '100',
    _200: '200',
    _300: '300',
    _350: '350',
...
export type ModelCheckAccountTransactionResponseStatusEnum = typeof ModelCheckAccountTransactionResponseStatusEnum[keyof typeof ModelCheckAccountTransactionResponseStatusEnum];


/**
 * Check if a given object implements the ModelCheckAccountTransactionResponse interface.
 */
export function instanceOfModelCheckAccountTransactionResponse(value: object): value is ModelCheckAccountTransactionResponse {
    return true;
}

export function ModelCheckAccountTransactionResponseFromJSON(json: any): ModelCheckAccountTransactionResponse {
    return ModelCheckAccountTransactionResponseFromJSONTyped(json, false);
}

export function ModelCheckAccountTransactionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCheckAccountTransactionResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sevClient': json['sevClient'] == null ? undefined : ModelCheckAccountTransactionResponseSevClientFromJSON(json['sevClient']),
        ...
        'paymtPurpose': json['paymtPurpose'] == null ? undefined : json['paymtPurpose'],
        'amount': json['amount'] == null ? undefined : json['amount'],
        'payeePayerName': json['payeePayerName'] == null ? undefined : json['payeePayerName'],
        'payeePayerAcctNo': json['payeePayerAcctNo'] == null ? undefined : json['payeePayerAcctNo'],
        'payeePayerBankCode': json['payeePayerBankCode'] == null ? undefined : json['payeePayerBankCode'],
        'gvCode': json['gvCode'] == null ? undefined : json['gvCode'],
        'entryText': json['entryText'] == null ? undefined : json['entryText'],
        'primaNotaNo': json['primaNotaNo'] == null ? undefined : json['primaNotaNo'],
        'checkAccount': json['checkAccount'] == null ? undefined : ModelCheckAccountTransactionResponseCheckAccountFromJSON(json['checkAccount']),
        'status': json['status'] == null ? undefined : json['status'],
        'sourceTransaction': json['sourceTransaction'] == null ? undefined : ModelCheckAccountTransactionResponseSourceTransactionFromJSON(json['sourceTransaction']),
        'targetTransaction': json['targetTransaction'] == null ? undefined : ModelCheckAccountTransactionResponseTargetTransactionFromJSON(json['targetTransaction']),
        'enshrined': json['enshrined'] == null ? undefined : (new Date(json['enshrined'])),
    };
}

export function ModelCheckAccountTransactionResponseToJSON(json: any): ModelCheckAccountTransactionResponse {
    return ModelCheckAccountTransactionResponseToJSONTyped(json, false);
}

export function ModelCheckAccountTransactionResponseToJSONTyped(value?: Omit<ModelCheckAccountTransactionResponse, 'id'|'objectName'|'create'|'update'|'status'|'enshrined'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sevClient': ModelCheckAccountTransactionResponseSevClientToJSON(value['sevClient']),
        'valueDate': value['valueDate'] == null ? undefined : ((value['valueDate']).toISOString()),
        'entryDate': value['entryDate'] === null ? null : ((value['entryDate'] as any)?.toISOString()),
        'paymtPurpose': value['paymtPurpose'],
        'amount': value['amount'],
        'payeePayerName': value['payeePayerName'],
        'payeePayerAcctNo': value['payeePayerAcctNo'],
        'payeePayerBankCode': value['payeePayerBankCode'],
        'gvCode': value['gvCode'],
        'entryText': value['entryText'],
        'primaNotaNo': value['primaNotaNo'],
        'checkAccount': ModelCheckAccountTransactionResponseCheckAccountToJSON(value['checkAccount']),
        'sourceTransaction': ModelCheckAccountTransactionResponseSourceTransactionToJSON(value['sourceTransaction']),
        'targetTransaction': ModelCheckAccountTransactionResponseTargetTransactionToJSON(value['targetTransaction']),
    };
}
