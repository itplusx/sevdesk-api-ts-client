...
import type { ModelVoucherUpdateTaxSet } from './ModelVoucherUpdateTaxSet';
import {
    ModelVoucherUpdateTaxSetFromJSON,
    ModelVoucherUpdateTaxSetFromJSONTyped,
    ModelVoucherUpdateTaxSetToJSON,
    ModelVoucherUpdateTaxSetToJSONTyped,
} from './ModelVoucherUpdateTaxSet';
...
import type { ModelVoucherUpdateSupplier } from './ModelVoucherUpdateSupplier';
import {
    ModelVoucherUpdateSupplierFromJSON,
    ModelVoucherUpdateSupplierFromJSONTyped,
    ModelVoucherUpdateSupplierToJSON,
    ModelVoucherUpdateSupplierToJSONTyped,
} from './ModelVoucherUpdateSupplier';
 ...
 * Voucher model
 * @export
 * @interface ModelVoucherUpdate
 */
export interface ModelVoucherUpdate {
    /**
     * Needs to be provided as timestamp or dd.mm.yyyy
     * @type {Date}
     * @memberof ModelVoucherUpdate
     */
    voucherDate?: Date | null;
    /**
     * 
     * @type {ModelVoucherUpdateSupplier}
     * @memberof ModelVoucherUpdate
     */
    supplier?: ModelVoucherUpdateSupplier | null;
    /**
     ...
     * @memberof ModelVoucherUpdate
     */
    status?: ModelVoucherUpdateStatusEnum;
    /**
     ...
     * @memberof ModelVoucherUpdate
     */
    creditDebit?: ModelVoucherUpdateCreditDebitEnum;
    /**
     ...
     * @memberof ModelVoucherUpdate
     */
    voucherType?: ModelVoucherUpdateVoucherTypeEnum;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherUpdateTaxSet}
     * @memberof ModelVoucherUpdate
     */
    taxSet?: ModelVoucherUpdateTaxSet | null;
    /**
 ...
 * @export
 */
export const ModelVoucherUpdateStatusEnum = {
    NUMBER_50: 50,
    NUMBER_100: 100,
    NUMBER_1000: 1000
} as const;
export type ModelVoucherUpdateStatusEnum = typeof ModelVoucherUpdateStatusEnum[keyof typeof ModelVoucherUpdateStatusEnum];

/**
 * @export
 */
export const ModelVoucherUpdateCreditDebitEnum = {
    C: 'C',
    D: 'D'
} as const;
export type ModelVoucherUpdateCreditDebitEnum = typeof ModelVoucherUpdateCreditDebitEnum[keyof typeof ModelVoucherUpdateCreditDebitEnum];

/**
 * @export
 */
export const ModelVoucherUpdateVoucherTypeEnum = {
    Vou: 'VOU',
    Rv: 'RV'
} as const;
export type ModelVoucherUpdateVoucherTypeEnum = typeof ModelVoucherUpdateVoucherTypeEnum[keyof typeof ModelVoucherUpdateVoucherTypeEnum];


/**
 * Check if a given object implements the ModelVoucherUpdate interface.
 */
export function instanceOfModelVoucherUpdate(value: object): value is ModelVoucherUpdate {
    return true;
}

export function ModelVoucherUpdateFromJSON(json: any): ModelVoucherUpdate {
    return ModelVoucherUpdateFromJSONTyped(json, false);
}

export function ModelVoucherUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelVoucherUpdate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'supplier': json['supplier'] == null ? undefined : ModelVoucherUpdateSupplierFromJSON(json['supplier']),
        ...
        'taxSet': json['taxSet'] == null ? undefined : ModelVoucherUpdateTaxSetFromJSON(json['taxSet']),
...
export function ModelVoucherUpdateToJSON(json: any): ModelVoucherUpdate {
    return ModelVoucherUpdateToJSONTyped(json, false);
}

export function ModelVoucherUpdateToJSONTyped(value?: Omit<ModelVoucherUpdate, 'paidAmount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'supplier': ModelVoucherUpdateSupplierToJSON(value['supplier']),
        ...
        'taxSet': ModelVoucherUpdateTaxSetToJSON(value['taxSet']),
