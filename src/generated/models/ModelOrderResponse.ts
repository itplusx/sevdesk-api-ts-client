...
import type { ModelOrderResponseContact } from './ModelOrderResponseContact';
import {
    ModelOrderResponseContactFromJSON,
    ModelOrderResponseContactFromJSONTyped,
    ModelOrderResponseContactToJSON,
    ModelOrderResponseContactToJSONTyped,
} from './ModelOrderResponseContact';
import type { ModelOrderResponseContactPerson } from './ModelOrderResponseContactPerson';
import {
    ModelOrderResponseContactPersonFromJSON,
    ModelOrderResponseContactPersonFromJSONTyped,
    ModelOrderResponseContactPersonToJSON,
    ModelOrderResponseContactPersonToJSONTyped,
} from './ModelOrderResponseContactPerson';
...
import type { ModelOrderResponseAddressCountry } from './ModelOrderResponseAddressCountry';
import {
    ModelOrderResponseAddressCountryFromJSON,
    ModelOrderResponseAddressCountryFromJSONTyped,
    ModelOrderResponseAddressCountryToJSON,
    ModelOrderResponseAddressCountryToJSONTyped,
} from './ModelOrderResponseAddressCountry';
import type { ModelOrderResponseCreateUser } from './ModelOrderResponseCreateUser';
import {
    ModelOrderResponseCreateUserFromJSON,
    ModelOrderResponseCreateUserFromJSONTyped,
    ModelOrderResponseCreateUserToJSON,
    ModelOrderResponseCreateUserToJSONTyped,
} from './ModelOrderResponseCreateUser';
import type { ModelOrderResponseOrigin } from './ModelOrderResponseOrigin';
import {
    ModelOrderResponseOriginFromJSON,
    ModelOrderResponseOriginFromJSONTyped,
    ModelOrderResponseOriginToJSON,
    ModelOrderResponseOriginToJSONTyped,
} from './ModelOrderResponseOrigin';
import type { ModelOrderResponseTaxSet } from './ModelOrderResponseTaxSet';
import {
    ModelOrderResponseTaxSetFromJSON,
    ModelOrderResponseTaxSetFromJSONTyped,
    ModelOrderResponseTaxSetToJSON,
    ModelOrderResponseTaxSetToJSONTyped,
} from './ModelOrderResponseTaxSet';
import type { ModelOrderResponseSevClient } from './ModelOrderResponseSevClient';
import {
    ModelOrderResponseSevClientFromJSON,
    ModelOrderResponseSevClientFromJSONTyped,
    ModelOrderResponseSevClientToJSON,
    ModelOrderResponseSevClientToJSONTyped,
} from './ModelOrderResponseSevClient';

/**
 * Order model
 * @export
 * @interface ModelOrderResponse
 */
export interface ModelOrderResponse {
    /**
     * The order id
     * @type {string}
     * @memberof ModelOrderResponse
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelOrderResponseContact}
     * @memberof ModelOrderResponse
     */
     ...
     * @memberof ModelOrderResponse
     */
    status?: ModelOrderResponseStatusEnum;
    /**
    ...
    /**
     * 
     * @type {ModelOrderResponseAddressCountry}
     * @memberof ModelOrderResponse
     */
    addressCountry?: ModelOrderResponseAddressCountry | null;
    /**
     * 
     * @type {ModelOrderResponseCreateUser}
     * @memberof ModelOrderResponse
     */
    createUser?: ModelOrderResponseCreateUser;
    /**
     * 
     * @type {ModelOrderResponseSevClient}
     * @memberof ModelOrderResponse
     */
    sevClient?: ModelOrderResponseSevClient;
    /**
    ...
    /**
     * 
     * @type {ModelOrderResponseOrigin}
     * @memberof ModelOrderResponse
     */
    origin?: ModelOrderResponseOrigin | null;
    /**
    ...
    /**
     * 
     * @type {ModelOrderResponseContactPerson}
     * @memberof ModelOrderResponse
     */
    contactPerson?: ModelOrderResponseContactPerson;
    /**
    ...
    /**
     * 
     * @type {ModelOrderResponseTaxSet}
     * @memberof ModelOrderResponse
     */
    taxSet?: ModelOrderResponseTaxSet | null;
    /**
     ...
     * @memberof ModelOrderResponse
     */
    orderType?: ModelOrderResponseOrderTypeEnum;
    /**
     ...
     * @memberof ModelOrderResponse
     */
    sendType?: ModelOrderResponseSendTypeEnum | null;
}
 ...
 * @export
 */
export const ModelOrderResponseStatusEnum = {
    _100: '100',
    _200: '200',
    _300: '300',
    _500: '500',
...
export type ModelOrderResponseStatusEnum = typeof ModelOrderResponseStatusEnum[keyof typeof ModelOrderResponseStatusEnum];

/**
 * @export
 */
export const ModelOrderResponseOrderTypeEnum = {
    An: 'AN',
    Ab: 'AB',
    Li: 'LI'
} as const;
export type ModelOrderResponseOrderTypeEnum = typeof ModelOrderResponseOrderTypeEnum[keyof typeof ModelOrderResponseOrderTypeEnum];

/**
 * @export
 */
export const ModelOrderResponseSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type ModelOrderResponseSendTypeEnum = typeof ModelOrderResponseSendTypeEnum[keyof typeof ModelOrderResponseSendTypeEnum];


/**
 * Check if a given object implements the ModelOrderResponse interface.
 */
export function instanceOfModelOrderResponse(value: object): value is ModelOrderResponse {
    return true;
}

export function ModelOrderResponseFromJSON(json: any): ModelOrderResponse {
    return ModelOrderResponseFromJSONTyped(json, false);
}

export function ModelOrderResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelOrderResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'contact': json['contact'] == null ? undefined : ModelOrderResponseContactFromJSON(json['contact']),
        ...
        'addressCountry': json['addressCountry'] == null ? undefined : ModelOrderResponseAddressCountryFromJSON(json['addressCountry']),
        'createUser': json['createUser'] == null ? undefined : ModelOrderResponseCreateUserFromJSON(json['createUser']),
        'sevClient': json['sevClient'] == null ? undefined : ModelOrderResponseSevClientFromJSON(json['sevClient']),
        ...
        'origin': json['origin'] == null ? undefined : ModelOrderResponseOriginFromJSON(json['origin']),
        'version': json['version'] == null ? undefined : json['version'],
        'smallSettlement': json['smallSettlement'] == null ? undefined : json['smallSettlement'],
        'contactPerson': json['contactPerson'] == null ? undefined : ModelOrderResponseContactPersonFromJSON(json['contactPerson']),
        ...
        'taxSet': json['taxSet'] == null ? undefined : ModelOrderResponseTaxSetFromJSON(json['taxSet']),
...
export function ModelOrderResponseToJSON(json: any): ModelOrderResponse {
    return ModelOrderResponseToJSONTyped(json, false);
}

export function ModelOrderResponseToJSONTyped(value?: Omit<ModelOrderResponse, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'contact': ModelOrderResponseContactToJSON(value['contact']),
        'orderDate': value['orderDate'] == null ? undefined : ((value['orderDate']).toISOString()),
        'status': value['status'],
        'header': value['header'],
        'headText': value['headText'],
        'footText': value['footText'],
        'addressCountry': ModelOrderResponseAddressCountryToJSON(value['addressCountry']),
        'createUser': ModelOrderResponseCreateUserToJSON(value['createUser']),
        'sevClient': ModelOrderResponseSevClientToJSON(value['sevClient']),
        'deliveryTerms': value['deliveryTerms'],
        'paymentTerms': value['paymentTerms'],
        'origin': ModelOrderResponseOriginToJSON(value['origin']),
        'version': value['version'],
        'smallSettlement': value['smallSettlement'],
        'contactPerson': ModelOrderResponseContactPersonToJSON(value['contactPerson']),
        'taxRate': value['taxRate'],
        'taxRule': ModelCreditNoteResponseTaxRuleToJSON(value['taxRule']),
        'taxSet': ModelOrderResponseTaxSetToJSON(value['taxSet']),
