...
import type { ModelCreditNotePosPart } from './ModelCreditNotePosPart';
import {
    ModelCreditNotePosPartFromJSON,
    ModelCreditNotePosPartFromJSONTyped,
    ModelCreditNotePosPartToJSON,
    ModelCreditNotePosPartToJSONTyped,
} from './ModelCreditNotePosPart';
import type { ModelCreditNotePosSevClient } from './ModelCreditNotePosSevClient';
import {
    ModelCreditNotePosSevClientFromJSON,
    ModelCreditNotePosSevClientFromJSONTyped,
    ModelCreditNotePosSevClientToJSON,
    ModelCreditNotePosSevClientToJSONTyped,
} from './ModelCreditNotePosSevClient';
import type { ModelCreditNotePosUnity } from './ModelCreditNotePosUnity';
import {
    ModelCreditNotePosUnityFromJSON,
    ModelCreditNotePosUnityFromJSONTyped,
    ModelCreditNotePosUnityToJSON,
    ModelCreditNotePosUnityToJSONTyped,
} from './ModelCreditNotePosUnity';
import type { ModelCreditNotePosCreditNote } from './ModelCreditNotePosCreditNote';
import {
    ModelCreditNotePosCreditNoteFromJSON,
    ModelCreditNotePosCreditNoteFromJSONTyped,
    ModelCreditNotePosCreditNoteToJSON,
    ModelCreditNotePosCreditNoteToJSONTyped,
} from './ModelCreditNotePosCreditNote';
...
export interface ModelCreditNotePos {
    ...
    /**
     * 
     * @type {ModelCreditNotePosCreditNote}
     * @memberof ModelCreditNotePos
     */
    creditNote?: ModelCreditNotePosCreditNote;
    /**
     * 
     * @type {ModelCreditNotePosPart}
     * @memberof ModelCreditNotePos
     */
    ...
    /**
     * 
     * @type {ModelCreditNotePosUnity}
     * @memberof ModelCreditNotePos
     */
    unity: ModelCreditNotePosUnity;
    /**
     * 
     * @type {ModelCreditNotePosSevClient}
     * @memberof ModelCreditNotePos
     */
    sevClient?: ModelCreditNotePosSevClient;
    /**
...
/**
 * Check if a given object implements the ModelCreditNotePos interface.
 */
export function instanceOfModelCreditNotePos(value: object): value is ModelCreditNotePos {
...
export function ModelCreditNotePosFromJSON(json: any): ModelCreditNotePos {
    return ModelCreditNotePosFromJSONTyped(json, false);
}

export function ModelCreditNotePosFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCreditNotePos {
    if (json == null) {
        return json;
    }
    return {
        ...
        'creditNote': json['creditNote'] == null ? undefined : ModelCreditNotePosCreditNoteFromJSON(json['creditNote']),
        'part': json['part'] == null ? undefined : ModelCreditNotePosPartFromJSON(json['part']),
        ...
        'unity': ModelCreditNotePosUnityFromJSON(json['unity']),
        'sevClient': json['sevClient'] == null ? undefined : ModelCreditNotePosSevClientFromJSON(json['sevClient']),
...
export function ModelCreditNotePosToJSON(json: any): ModelCreditNotePos {
    return ModelCreditNotePosToJSONTyped(json, false);
}

export function ModelCreditNotePosToJSONTyped(value?: Omit<ModelCreditNotePos, 'id'|'create'|'update'|'priceNet'|'sumDiscount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'mapAll': value['mapAll'],
        'creditNote': ModelCreditNotePosCreditNoteToJSON(value['creditNote']),
        'part': ModelCreditNotePosPartToJSON(value['part']),
        'quantity': value['quantity'],
        'price': value['price'],
        'priceTax': value['priceTax'],
        'priceGross': value['priceGross'],
        'name': value['name'],
        'unity': ModelCreditNotePosUnityToJSON(value['unity']),
        'sevClient': ModelCreditNotePosSevClientToJSON(value['sevClient']),
