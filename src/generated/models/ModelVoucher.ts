...
import type { ModelVoucherDocument } from './ModelVoucherDocument';
import {
    ModelVoucherDocumentFromJSON,
    ModelVoucherDocumentFromJSONTyped,
    ModelVoucherDocumentToJSON,
    ModelVoucherDocumentToJSONTyped,
} from './ModelVoucherDocument';
import type { ModelVoucherTaxSet } from './ModelVoucherTaxSet';
import {
    ModelVoucherTaxSetFromJSON,
    ModelVoucherTaxSetFromJSONTyped,
    ModelVoucherTaxSetToJSON,
    ModelVoucherTaxSetToJSONTyped,
} from './ModelVoucherTaxSet';
import type { ModelVoucherSevClient } from './ModelVoucherSevClient';
import {
    ModelVoucherSevClientFromJSON,
    ModelVoucherSevClientFromJSONTyped,
    ModelVoucherSevClientToJSON,
    ModelVoucherSevClientToJSONTyped,
} from './ModelVoucherSevClient';
import type { ModelVoucherCreateUser } from './ModelVoucherCreateUser';
import {
    ModelVoucherCreateUserFromJSON,
    ModelVoucherCreateUserFromJSONTyped,
    ModelVoucherCreateUserToJSON,
    ModelVoucherCreateUserToJSONTyped,
} from './ModelVoucherCreateUser';
...
import type { ModelVoucherSupplier } from './ModelVoucherSupplier';
import {
    ModelVoucherSupplierFromJSON,
    ModelVoucherSupplierFromJSONTyped,
    ModelVoucherSupplierToJSON,
    ModelVoucherSupplierToJSONTyped,
} from './ModelVoucherSupplier';
import type { ModelVoucherCostCentre } from './ModelVoucherCostCentre';
import {
    ModelVoucherCostCentreFromJSON,
    ModelVoucherCostCentreFromJSONTyped,
    ModelVoucherCostCentreToJSON,
    ModelVoucherCostCentreToJSONTyped,
} from './ModelVoucherCostCentre';
...
export interface ModelVoucher {
    ...
    /**
     * 
     * @type {ModelVoucherSevClient}
     * @memberof ModelVoucher
     */
    sevClient?: ModelVoucherSevClient;
    /**
     * 
     * @type {ModelVoucherCreateUser}
     * @memberof ModelVoucher
     */
    createUser?: ModelVoucherCreateUser;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherSupplier}
     * @memberof ModelVoucher
     */
    supplier?: ModelVoucherSupplier | null;
    /**
     ...
     * @memberof ModelVoucher
     */
    creditDebit: ModelVoucherCreditDebitEnum;
    /**
     ...
     * @memberof ModelVoucher
     */
    voucherType: ModelVoucherVoucherTypeEnum;
    /**
     ...
     * @memberof ModelVoucher
     */
    readonly recurringInterval?: ModelVoucherRecurringIntervalEnum | null;
    /**
     ...
     * @memberof ModelVoucher
     */
    readonly recurringStartDate?: Date | null;
    /**
     ...
     * @memberof ModelVoucher
     */
    readonly recurringNextVoucher?: Date | null;
    /**
     * The date when the last voucher was generated.
     * @type {Date}
     * @memberof ModelVoucher
     */
    readonly recurringLastVoucher?: Date | null;
    /**
     ...
     * @memberof ModelVoucher
     */
    readonly recurringEndDate?: Date | null;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherTaxSet}
     * @memberof ModelVoucher
     */
    taxSet?: ModelVoucherTaxSet | null;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherDocument}
     * @memberof ModelVoucher
     */
    document?: ModelVoucherDocument | null;
    /**
     * 
     * @type {ModelVoucherCostCentre}
     * @memberof ModelVoucher
     */
    costCentre?: ModelVoucherCostCentre;
}
 ...
 * @export
 */
export const ModelVoucherStatusEnum = {
    NUMBER_50: 50,
    NUMBER_100: 100,
    NUMBER_1000: 1000
} as const;
export type ModelVoucherStatusEnum = typeof ModelVoucherStatusEnum[keyof typeof ModelVoucherStatusEnum];

/**
 * @export
 */
export const ModelVoucherCreditDebitEnum = {
    C: 'C',
    D: 'D'
} as const;
export type ModelVoucherCreditDebitEnum = typeof ModelVoucherCreditDebitEnum[keyof typeof ModelVoucherCreditDebitEnum];

/**
 * @export
 */
export const ModelVoucherVoucherTypeEnum = {
    Vou: 'VOU',
    Rv: 'RV'
} as const;
export type ModelVoucherVoucherTypeEnum = typeof ModelVoucherVoucherTypeEnum[keyof typeof ModelVoucherVoucherTypeEnum];

/**
 * @export
 */
export const ModelVoucherRecurringIntervalEnum = {
    P0Y0M1W: 'P0Y0M1W',
    P0Y0M2W: 'P0Y0M2W',
    P0Y1M0W: 'P0Y1M0W',
    P0Y3M0W: 'P0Y3M0W',
...
export type ModelVoucherRecurringIntervalEnum = typeof ModelVoucherRecurringIntervalEnum[keyof typeof ModelVoucherRecurringIntervalEnum];
...
export function instanceOfModelVoucher(value: object): value is ModelVoucher {
    ...
    if (!('creditDebit' in value) || value['creditDebit'] === undefined) return false;
    if (!('voucherType' in value) || value['voucherType'] === undefined) return false;
    return true;
}
...
export function ModelVoucherFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelVoucher {
    ...
    return {
        ...
        'sevClient': json['sevClient'] == null ? undefined : ModelVoucherSevClientFromJSON(json['sevClient']),
        'createUser': json['createUser'] == null ? undefined : ModelVoucherCreateUserFromJSON(json['createUser']),
        'voucherDate': json['voucherDate'] == null ? undefined : (new Date(json['voucherDate'])),
        'supplier': json['supplier'] == null ? undefined : ModelVoucherSupplierFromJSON(json['supplier']),
        ...
        'taxRule': ModelVoucherTaxRuleFromJSON(json['taxRule']),
        ...
        'taxSet': json['taxSet'] == null ? undefined : ModelVoucherTaxSetFromJSON(json['taxSet']),
        ...
        'document': json['document'] == null ? undefined : ModelVoucherDocumentFromJSON(json['document']),
        'costCentre': json['costCentre'] == null ? undefined : ModelVoucherCostCentreFromJSON(json['costCentre']),
    };
}
...
export function ModelVoucherToJSONTyped(value?: Omit<ModelVoucher, 'id'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'sumDiscounts'|'sumDiscountsForeignCurrency'|'paidAmount'|'recurringInterval'|'recurringStartDate'|'recurringNextVoucher'|'recurringLastVoucher'|'recurringEndDate'|'enshrined'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'mapAll': value['mapAll'],
        'sevClient': ModelVoucherSevClientToJSON(value['sevClient']),
        'createUser': ModelVoucherCreateUserToJSON(value['createUser']),
        'voucherDate': value['voucherDate'] === null ? null : ((value['voucherDate'] as any)?.toISOString()),
        'supplier': ModelVoucherSupplierToJSON(value['supplier']),
        ...
        'taxSet': ModelVoucherTaxSetToJSON(value['taxSet']),
        ...
        'document': ModelVoucherDocumentToJSON(value['document']),
        'costCentre': ModelVoucherCostCentreToJSON(value['costCentre']),
    };
}
