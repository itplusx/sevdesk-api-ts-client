 ...
 * creditNote model
 * @export
 * @interface ModelCreditNoteResponse
 */
export interface ModelCreditNoteResponse {
    /**
     * The creditNote id
     * @type {string}
     * @memberof ModelCreditNoteResponse
     */
    readonly id?: string;
    /**
     ...
     * @memberof ModelCreditNoteResponse
     */
    status?: ModelCreditNoteResponseStatusEnum;
    /**
     ...
     * @memberof ModelCreditNoteResponse
     */
    sendType?: ModelCreditNoteResponseSendTypeEnum | null;
}
 ...
 * @export
 */
export const ModelCreditNoteResponseStatusEnum = {
    _100: '100',
    _200: '200',
    _750: '750',
    _1000: '1000'
} as const;
export type ModelCreditNoteResponseStatusEnum = typeof ModelCreditNoteResponseStatusEnum[keyof typeof ModelCreditNoteResponseStatusEnum];

/**
 * @export
 */
export const ModelCreditNoteResponseSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type ModelCreditNoteResponseSendTypeEnum = typeof ModelCreditNoteResponseSendTypeEnum[keyof typeof ModelCreditNoteResponseSendTypeEnum];


/**
 * Check if a given object implements the ModelCreditNoteResponse interface.
 */
export function instanceOfModelCreditNoteResponse(value: object): value is ModelCreditNoteResponse {
    return true;
}

export function ModelCreditNoteResponseFromJSON(json: any): ModelCreditNoteResponse {
    return ModelCreditNoteResponseFromJSONTyped(json, false);
}

export function ModelCreditNoteResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCreditNoteResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelCreditNoteResponseToJSON(json: any): ModelCreditNoteResponse {
    return ModelCreditNoteResponseToJSONTyped(json, false);
}

export function ModelCreditNoteResponseToJSONTyped(value?: Omit<ModelCreditNoteResponse, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
