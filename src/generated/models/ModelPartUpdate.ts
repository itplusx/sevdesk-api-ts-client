...
import type { ModelPartSevClient } from './ModelPartSevClient';
import {
    ModelPartSevClientFromJSON,
    ModelPartSevClientFromJSONTyped,
    ModelPartSevClientToJSON,
    ModelPartSevClientToJSONTyped,
} from './ModelPartSevClient';
import type { ModelPartUnity } from './ModelPartUnity';
import {
    ModelPartUnityFromJSON,
    ModelPartUnityFromJSONTyped,
    ModelPartUnityToJSON,
    ModelPartUnityToJSONTyped,
} from './ModelPartUnity';
import type { ModelPartCategory } from './ModelPartCategory';
import {
    ModelPartCategoryFromJSON,
    ModelPartCategoryFromJSONTyped,
    ModelPartCategoryToJSON,
    ModelPartCategoryToJSONTyped,
} from './ModelPartCategory';

/**
 * Part model
 * @export
 * @interface ModelPartUpdate
 */
export interface ModelPartUpdate {
    /**
     * The part id
     * @type {number}
     * @memberof ModelPartUpdate
     */
     ...
     * @memberof ModelPartUpdate
     */
    category?: ModelPartCategory | null;
    /**
    ...
    /**
     * 
     * @type {ModelPartSevClient}
     * @memberof ModelPartUpdate
     */
    sevClient?: ModelPartSevClient;
    /**
     ...
     * @memberof ModelPartUpdate
     */
    status?: ModelPartUpdateStatusEnum | null;
    /**
 ...
 * @export
 */
export const ModelPartUpdateStatusEnum = {
    NUMBER_50: 50,
    NUMBER_100: 100
} as const;
export type ModelPartUpdateStatusEnum = typeof ModelPartUpdateStatusEnum[keyof typeof ModelPartUpdateStatusEnum];


/**
 * Check if a given object implements the ModelPartUpdate interface.
 */
export function instanceOfModelPartUpdate(value: object): value is ModelPartUpdate {
    return true;
}

export function ModelPartUpdateFromJSON(json: any): ModelPartUpdate {
    return ModelPartUpdateFromJSONTyped(json, false);
}

export function ModelPartUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelPartUpdate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'category': json['category'] == null ? undefined : ModelPartCategoryFromJSON(json['category']),
        'stock': json['stock'] == null ? undefined : json['stock'],
        'stockEnabled': json['stockEnabled'] == null ? undefined : json['stockEnabled'],
        'unity': json['unity'] == null ? undefined : ModelPartUnityFromJSON(json['unity']),
        'price': json['price'] == null ? undefined : json['price'],
        'priceNet': json['priceNet'] == null ? undefined : json['priceNet'],
        'priceGross': json['priceGross'] == null ? undefined : json['priceGross'],
        'sevClient': json['sevClient'] == null ? undefined : ModelPartSevClientFromJSON(json['sevClient']),
        'pricePurchase': json['pricePurchase'] == null ? undefined : json['pricePurchase'],
        'taxRate': json['taxRate'] == null ? undefined : json['taxRate'],
        'status': json['status'] == null ? undefined : json['status'],
        'internalComment': json['internalComment'] == null ? undefined : json['internalComment'],
    };
}

export function ModelPartUpdateToJSON(json: any): ModelPartUpdate {
    return ModelPartUpdateToJSONTyped(json, false);
}

export function ModelPartUpdateToJSONTyped(value?: Omit<ModelPartUpdate, 'id'|'objectName'|'create'|'update'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'text': value['text'],
        'category': ModelPartCategoryToJSON(value['category']),
        'stock': value['stock'],
        'stockEnabled': value['stockEnabled'],
        'unity': ModelPartUnityToJSON(value['unity']),
        'price': value['price'],
        'priceNet': value['priceNet'],
        'priceGross': value['priceGross'],
        'sevClient': ModelPartSevClientToJSON(value['sevClient']),
