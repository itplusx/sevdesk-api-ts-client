...
import type { ModelContactUpdateCategory } from './ModelContactUpdateCategory';
import {
    ModelContactUpdateCategoryFromJSON,
    ModelContactUpdateCategoryFromJSONTyped,
    ModelContactUpdateCategoryToJSON,
    ModelContactUpdateCategoryToJSONTyped,
} from './ModelContactUpdateCategory';
import type { ModelContactUpdateParent } from './ModelContactUpdateParent';
import {
    ModelContactUpdateParentFromJSON,
    ModelContactUpdateParentFromJSONTyped,
    ModelContactUpdateParentToJSON,
    ModelContactUpdateParentToJSONTyped,
} from './ModelContactUpdateParent';

/**
 * Contact model
 * @export
 * @interface ModelContactUpdate
 */
export interface ModelContactUpdate {
    /**
    ...
    /**
     * 
     * @type {ModelContactUpdateParent}
     * @memberof ModelContactUpdate
     */
    parent?: ModelContactUpdateParent | null;
    /**
    ...
    /**
     * 
     * @type {ModelContactUpdateCategory}
     * @memberof ModelContactUpdate
     */
    category?: ModelContactUpdateCategory | null;
    /**
...
/**
 * Check if a given object implements the ModelContactUpdate interface.
 */
export function instanceOfModelContactUpdate(value: object): value is ModelContactUpdate {
    return true;
}

export function ModelContactUpdateFromJSON(json: any): ModelContactUpdate {
    return ModelContactUpdateFromJSONTyped(json, false);
}

export function ModelContactUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelContactUpdate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'parent': json['parent'] == null ? undefined : ModelContactUpdateParentFromJSON(json['parent']),
        'surename': json['surename'] == null ? undefined : json['surename'],
        'familyname': json['familyname'] == null ? undefined : json['familyname'],
        'titel': json['titel'] == null ? undefined : json['titel'],
        'category': json['category'] == null ? undefined : ModelContactUpdateCategoryFromJSON(json['category']),
...
export function ModelContactUpdateToJSON(json: any): ModelContactUpdate {
    return ModelContactUpdateToJSONTyped(json, false);
}

export function ModelContactUpdateToJSONTyped(value?: ModelContactUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'parent': ModelContactUpdateParentToJSON(value['parent']),
        'surename': value['surename'],
        'familyname': value['familyname'],
        'titel': value['titel'],
        'category': ModelContactUpdateCategoryToJSON(value['category']),
        'description': value['description'],
        'academicTitle': value['academicTitle'],
        'gender': value['gender'],
        'name2': value['name2'],
        'birthday': value['birthday'] === null ? null : ((value['birthday'] as any)?.toISOString().substring(0,10)),
        'vatNumber': value['vatNumber'],
        'bankAccount': value['bankAccount'],
        'bankNumber': value['bankNumber'],
        'defaultCashbackTime': value['defaultCashbackTime'],
        'defaultCashbackPercent': value['defaultCashbackPercent'],
        'defaultTimeToPay': value['defaultTimeToPay'],
        'taxNumber': value['taxNumber'],
        'taxOffice': value['taxOffice'],
        'exemptVat': value['exemptVat'],
        'defaultDiscountAmount': value['defaultDiscountAmount'],
        'defaultDiscountPercentage': value['defaultDiscountPercentage'],
        'buyerReference': value['buyerReference'],
        'governmentAgency': value['governmentAgency'],
    };
}
