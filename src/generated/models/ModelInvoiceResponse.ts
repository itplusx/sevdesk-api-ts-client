 ...
 * Invoice model
 * @export
 * @interface ModelInvoiceResponse
 */
export interface ModelInvoiceResponse {
    /**
     * The invoice id
     * @type {string}
     * @memberof ModelInvoiceResponse
     */
    readonly id?: string;
    /**
     ...
     * @memberof ModelInvoiceResponse
     */
    readonly status?: ModelInvoiceResponseStatusEnum;
    /**
     ...
     * @memberof ModelInvoiceResponse
     */
    readonly taxType?: ModelInvoiceResponseTaxTypeEnum;
    /**
     * 
     ...
     * @memberof ModelInvoiceResponse
     */
    readonly invoiceType?: ModelInvoiceResponseInvoiceTypeEnum;
    /**
     ...
     * @memberof ModelInvoiceResponse
     */
    readonly sendType?: ModelInvoiceResponseSendTypeEnum;
    /**
 ...
 * @export
 */
export const ModelInvoiceResponseStatusEnum = {
    _50: '50',
    _100: '100',
    _200: '200',
    _750: '750',
...
export type ModelInvoiceResponseStatusEnum = typeof ModelInvoiceResponseStatusEnum[keyof typeof ModelInvoiceResponseStatusEnum];

/**
 * @export
 */
export const ModelInvoiceResponseTaxTypeEnum = {
    Default: 'default',
    Eu: 'eu',
    Noteu: 'noteu',
    Custom: 'custom'
} as const;
export type ModelInvoiceResponseTaxTypeEnum = typeof ModelInvoiceResponseTaxTypeEnum[keyof typeof ModelInvoiceResponseTaxTypeEnum];

/**
 * @export
 */
export const ModelInvoiceResponseInvoiceTypeEnum = {
    Re: 'RE',
    Wkr: 'WKR',
    Sr: 'SR',
    Ma: 'MA',
...
export type ModelInvoiceResponseInvoiceTypeEnum = typeof ModelInvoiceResponseInvoiceTypeEnum[keyof typeof ModelInvoiceResponseInvoiceTypeEnum];

/**
 * @export
 */
export const ModelInvoiceResponseSendTypeEnum = {
    Vpr: 'VPR',
    Vpdf: 'VPDF',
    Vm: 'VM',
    Vp: 'VP'
} as const;
export type ModelInvoiceResponseSendTypeEnum = typeof ModelInvoiceResponseSendTypeEnum[keyof typeof ModelInvoiceResponseSendTypeEnum];


/**
 * Check if a given object implements the ModelInvoiceResponse interface.
 */
export function instanceOfModelInvoiceResponse(value: object): value is ModelInvoiceResponse {
    return true;
}

export function ModelInvoiceResponseFromJSON(json: any): ModelInvoiceResponse {
    return ModelInvoiceResponseFromJSONTyped(json, false);
}

export function ModelInvoiceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelInvoiceResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelInvoiceResponseToJSON(json: any): ModelInvoiceResponse {
    return ModelInvoiceResponseToJSONTyped(json, false);
}

export function ModelInvoiceResponseToJSONTyped(value?: Omit<ModelInvoiceResponse, 'id'|'objectName'|'invoiceNumber'|'create'|'update'|'invoiceDate'|'header'|'headText'|'footText'|'timeToPay'|'discountTime'|'discount'|'payDate'|'deliveryDate'|'status'|'smallSettlement'|'taxRate'|'taxText'|'dunningLevel'|'taxType'|'sendDate'|'invoiceType'|'accountIntervall'|'accountNextInvoice'|'reminderTotal'|'reminderDebit'|'reminderDeadline'|'reminderCharge'|'address'|'currency'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'paidAmount'|'customerInternalNote'|'showNet'|'enshrined'|'sendType'|'deliveryDateUntil'|'datevConnectOnline'|'sendPaymentReceivedNotificationDate'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
