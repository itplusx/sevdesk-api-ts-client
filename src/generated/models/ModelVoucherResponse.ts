 ...
 * Voucher model
 * @export
 * @interface ModelVoucherResponse
 */
export interface ModelVoucherResponse {
    /**
     * The voucher id
     * @type {string}
     * @memberof ModelVoucherResponse
     */
    readonly id?: string;
    /**
     ...
     * @memberof ModelVoucherResponse
     */
    status?: ModelVoucherResponseStatusEnum | null;
    /**
     ...
     * @memberof ModelVoucherResponse
     */
    creditDebit?: ModelVoucherResponseCreditDebitEnum | null;
    /**
     * 
     ...
     * @memberof ModelVoucherResponse
     */
    voucherType?: ModelVoucherResponseVoucherTypeEnum | null;
    /**
     ...
     * @memberof ModelVoucherResponse
     */
    recurringInterval?: ModelVoucherResponseRecurringIntervalEnum | null;
    /**
 ...
 * @export
 */
export const ModelVoucherResponseStatusEnum = {
    _50: '50',
    _100: '100',
    _1000: '1000'
} as const;
export type ModelVoucherResponseStatusEnum = typeof ModelVoucherResponseStatusEnum[keyof typeof ModelVoucherResponseStatusEnum];

/**
 * @export
 */
export const ModelVoucherResponseCreditDebitEnum = {
    C: 'C',
    D: 'D'
} as const;
export type ModelVoucherResponseCreditDebitEnum = typeof ModelVoucherResponseCreditDebitEnum[keyof typeof ModelVoucherResponseCreditDebitEnum];

/**
 * @export
 */
export const ModelVoucherResponseVoucherTypeEnum = {
    Vou: 'VOU',
    Rv: 'RV'
} as const;
export type ModelVoucherResponseVoucherTypeEnum = typeof ModelVoucherResponseVoucherTypeEnum[keyof typeof ModelVoucherResponseVoucherTypeEnum];

/**
 * @export
 */
export const ModelVoucherResponseRecurringIntervalEnum = {
    P0Y0M1W: 'P0Y0M1W',
    P0Y0M2W: 'P0Y0M2W',
    P0Y1M0W: 'P0Y1M0W',
    P0Y3M0W: 'P0Y3M0W',
...
export type ModelVoucherResponseRecurringIntervalEnum = typeof ModelVoucherResponseRecurringIntervalEnum[keyof typeof ModelVoucherResponseRecurringIntervalEnum];


/**
 * Check if a given object implements the ModelVoucherResponse interface.
 */
export function instanceOfModelVoucherResponse(value: object): value is ModelVoucherResponse {
    return true;
}

export function ModelVoucherResponseFromJSON(json: any): ModelVoucherResponse {
    return ModelVoucherResponseFromJSONTyped(json, false);
}

export function ModelVoucherResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelVoucherResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelVoucherResponseToJSON(json: any): ModelVoucherResponse {
    return ModelVoucherResponseToJSONTyped(json, false);
}

export function ModelVoucherResponseToJSONTyped(value?: Omit<ModelVoucherResponse, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'sumDiscounts'|'sumDiscountsForeignCurrency'|'paidAmount'|'enshrined'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
