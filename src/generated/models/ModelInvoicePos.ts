...
import type { ModelInvoicePosUnity } from './ModelInvoicePosUnity';
import {
    ModelInvoicePosUnityFromJSON,
    ModelInvoicePosUnityFromJSONTyped,
    ModelInvoicePosUnityToJSON,
    ModelInvoicePosUnityToJSONTyped,
} from './ModelInvoicePosUnity';
...
import type { ModelInvoicePosSevClient } from './ModelInvoicePosSevClient';
import {
    ModelInvoicePosSevClientFromJSON,
    ModelInvoicePosSevClientFromJSONTyped,
    ModelInvoicePosSevClientToJSON,
    ModelInvoicePosSevClientToJSONTyped,
} from './ModelInvoicePosSevClient';
import type { ModelInvoicePosInvoice } from './ModelInvoicePosInvoice';
import {
    ModelInvoicePosInvoiceFromJSON,
    ModelInvoicePosInvoiceFromJSONTyped,
    ModelInvoicePosInvoiceToJSON,
    ModelInvoicePosInvoiceToJSONTyped,
} from './ModelInvoicePosInvoice';
...
export interface ModelInvoicePos {
    ...
    /**
     * 
     * @type {ModelInvoicePosUnity}
     * @memberof ModelInvoicePos
     */
    unity: ModelInvoicePosUnity;
    /**
     * 
     * @type {ModelInvoicePosSevClient}
     * @memberof ModelInvoicePos
     */
    sevClient?: ModelInvoicePosSevClient;
    /**
...
/**
 * Check if a given object implements the ModelInvoicePos interface.
 */
export function instanceOfModelInvoicePos(value: object): value is ModelInvoicePos {
...
export function ModelInvoicePosFromJSON(json: any): ModelInvoicePos {
    return ModelInvoicePosFromJSONTyped(json, false);
}

export function ModelInvoicePosFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelInvoicePos {
    if (json == null) {
        return json;
    }
    return {
        ...
        'invoice': json['invoice'] == null ? undefined : ModelInvoicePosInvoiceFromJSON(json['invoice']),
        'part': json['part'] == null ? undefined : ModelCreditNotePosPartFromJSON(json['part']),
        'quantity': json['quantity'],
        'price': json['price'] == null ? undefined : json['price'],
        'name': json['name'] == null ? undefined : json['name'],
        'unity': ModelInvoicePosUnityFromJSON(json['unity']),
        'sevClient': json['sevClient'] == null ? undefined : ModelInvoicePosSevClientFromJSON(json['sevClient']),
...
export function ModelInvoicePosToJSON(json: any): ModelInvoicePos {
    return ModelInvoicePosToJSONTyped(json, false);
}

export function ModelInvoicePosToJSONTyped(value?: Omit<ModelInvoicePos, 'create'|'update'|'sumDiscount'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'priceNet'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'mapAll': value['mapAll'],
        'invoice': ModelInvoicePosInvoiceToJSON(value['invoice']),
        'part': ModelCreditNotePosPartToJSON(value['part']),
        'quantity': value['quantity'],
        'price': value['price'],
        'name': value['name'],
        'unity': ModelInvoicePosUnityToJSON(value['unity']),
        'sevClient': ModelInvoicePosSevClientToJSON(value['sevClient']),
