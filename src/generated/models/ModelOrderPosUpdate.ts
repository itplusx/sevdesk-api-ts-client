...
import type { ModelOrderPosOrder } from './ModelOrderPosOrder';
import {
    ModelOrderPosOrderFromJSON,
    ModelOrderPosOrderFromJSONTyped,
    ModelOrderPosOrderToJSON,
    ModelOrderPosOrderToJSONTyped,
} from './ModelOrderPosOrder';
...
import type { ModelOrderPosSevClient } from './ModelOrderPosSevClient';
import {
    ModelOrderPosSevClientFromJSON,
    ModelOrderPosSevClientFromJSONTyped,
    ModelOrderPosSevClientToJSON,
    ModelOrderPosSevClientToJSONTyped,
} from './ModelOrderPosSevClient';

/**
 * Order position model
 * @export
 * @interface ModelOrderPosUpdate
 */
export interface ModelOrderPosUpdate {
    /**
     * The order position id
     * @type {number}
     * @memberof ModelOrderPosUpdate
     */
    readonly id?: number;
    /**
    ...
    /**
     * 
     * @type {ModelOrderPosSevClient}
     * @memberof ModelOrderPosUpdate
     */
    sevClient?: ModelOrderPosSevClient;
    /**
...
/**
 * Check if a given object implements the ModelOrderPosUpdate interface.
 */
export function instanceOfModelOrderPosUpdate(value: object): value is ModelOrderPosUpdate {
    return true;
}

export function ModelOrderPosUpdateFromJSON(json: any): ModelOrderPosUpdate {
    return ModelOrderPosUpdateFromJSONTyped(json, false);
}

export function ModelOrderPosUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelOrderPosUpdate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'order': json['order'] == null ? undefined : ModelOrderPosOrderFromJSON(json['order']),
        ...
        'unity': json['unity'] == null ? undefined : ModelCreditNotePosUnityFromJSON(json['unity']),
        'sevClient': json['sevClient'] == null ? undefined : ModelOrderPosSevClientFromJSON(json['sevClient']),
...
export function ModelOrderPosUpdateToJSON(json: any): ModelOrderPosUpdate {
    return ModelOrderPosUpdateToJSONTyped(json, false);
}

export function ModelOrderPosUpdateToJSONTyped(value?: Omit<ModelOrderPosUpdate, 'id'|'objectName'|'create'|'update'|'priceNet'|'sumDiscount'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'order': ModelOrderPosOrderToJSON(value['order']),
        ...
        'sevClient': ModelOrderPosSevClientToJSON(value['sevClient']),
