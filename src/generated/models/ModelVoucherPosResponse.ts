...
import type { ModelVoucherPosAccountDatev } from './ModelVoucherPosAccountDatev';
import {
    ModelVoucherPosAccountDatevFromJSON,
    ModelVoucherPosAccountDatevFromJSONTyped,
    ModelVoucherPosAccountDatevToJSON,
    ModelVoucherPosAccountDatevToJSONTyped,
} from './ModelVoucherPosAccountDatev';
import type { ModelVoucherPosResponseEstimatedAccountingType } from './ModelVoucherPosResponseEstimatedAccountingType';
import {
    ModelVoucherPosResponseEstimatedAccountingTypeFromJSON,
    ModelVoucherPosResponseEstimatedAccountingTypeFromJSONTyped,
    ModelVoucherPosResponseEstimatedAccountingTypeToJSON,
    ModelVoucherPosResponseEstimatedAccountingTypeToJSONTyped,
} from './ModelVoucherPosResponseEstimatedAccountingType';
import type { ModelVoucherPosResponseAccountingType } from './ModelVoucherPosResponseAccountingType';
import {
    ModelVoucherPosResponseAccountingTypeFromJSON,
    ModelVoucherPosResponseAccountingTypeFromJSONTyped,
    ModelVoucherPosResponseAccountingTypeToJSON,
    ModelVoucherPosResponseAccountingTypeToJSONTyped,
} from './ModelVoucherPosResponseAccountingType';
import type { ModelVoucherPosResponseVoucher } from './ModelVoucherPosResponseVoucher';
import {
    ModelVoucherPosResponseVoucherFromJSON,
    ModelVoucherPosResponseVoucherFromJSONTyped,
    ModelVoucherPosResponseVoucherToJSON,
    ModelVoucherPosResponseVoucherToJSONTyped,
} from './ModelVoucherPosResponseVoucher';
import type { ModelVoucherPosResponseSevClient } from './ModelVoucherPosResponseSevClient';
import {
    ModelVoucherPosResponseSevClientFromJSON,
    ModelVoucherPosResponseSevClientFromJSONTyped,
    ModelVoucherPosResponseSevClientToJSON,
    ModelVoucherPosResponseSevClientToJSONTyped,
} from './ModelVoucherPosResponseSevClient';

/**
 * Voucher position model
 * @export
 * @interface ModelVoucherPosResponse
 */
export interface ModelVoucherPosResponse {
    /**
     * The voucher position id
     * @type {string}
     * @memberof ModelVoucherPosResponse
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelVoucherPosResponseSevClient}
     * @memberof ModelVoucherPosResponse
     */
    sevClient?: ModelVoucherPosResponseSevClient;
    /**
     * 
     * @type {ModelVoucherPosResponseVoucher}
     * @memberof ModelVoucherPosResponse
     */
    voucher: ModelVoucherPosResponseVoucher;
    /**
     * 
     * @type {ModelVoucherPosAccountDatev}
     * @memberof ModelVoucherPosResponse
     */
    accountDatev: ModelVoucherPosAccountDatev;
    /**
     * 
     * @type {ModelVoucherPosResponseAccountingType}
     * @memberof ModelVoucherPosResponse
     */
    accountingType: ModelVoucherPosResponseAccountingType;
    /**
     * 
     * @type {ModelVoucherPosResponseEstimatedAccountingType}
     * @memberof ModelVoucherPosResponse
     */
    estimatedAccountingType?: ModelVoucherPosResponseEstimatedAccountingType;
    /**
...
/**
 * Check if a given object implements the ModelVoucherPosResponse interface.
 */
export function instanceOfModelVoucherPosResponse(value: object): value is ModelVoucherPosResponse {
    if (!('voucher' in value) || value['voucher'] === undefined) return false;
    if (!('accountDatev' in value) || value['accountDatev'] === undefined) return false;
    if (!('accountingType' in value) || value['accountingType'] === undefined) return false;
    if (!('taxRate' in value) || value['taxRate'] === undefined) return false;
    if (!('net' in value) || value['net'] === undefined) return false;
    if (!('sumNet' in value) || value['sumNet'] === undefined) return false;
    if (!('sumGross' in value) || value['sumGross'] === undefined) return false;
    return true;
}

export function ModelVoucherPosResponseFromJSON(json: any): ModelVoucherPosResponse {
    return ModelVoucherPosResponseFromJSONTyped(json, false);
}

export function ModelVoucherPosResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelVoucherPosResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sevClient': json['sevClient'] == null ? undefined : ModelVoucherPosResponseSevClientFromJSON(json['sevClient']),
        'voucher': ModelVoucherPosResponseVoucherFromJSON(json['voucher']),
        'accountDatev': ModelVoucherPosAccountDatevFromJSON(json['accountDatev']),
        'accountingType': ModelVoucherPosResponseAccountingTypeFromJSON(json['accountingType']),
        'estimatedAccountingType': json['estimatedAccountingType'] == null ? undefined : ModelVoucherPosResponseEstimatedAccountingTypeFromJSON(json['estimatedAccountingType']),
        'taxRate': json['taxRate'],
        'net': json['net'],
        'isAsset': json['isAsset'] == null ? undefined : json['isAsset'],
        'sumNet': json['sumNet'],
        'sumTax': json['sumTax'] == null ? undefined : json['sumTax'],
        'sumGross': json['sumGross'],
...
export function ModelVoucherPosResponseToJSON(json: any): ModelVoucherPosResponse {
    return ModelVoucherPosResponseToJSONTyped(json, false);
}

export function ModelVoucherPosResponseToJSONTyped(value?: Omit<ModelVoucherPosResponse, 'id'|'objectName'|'create'|'update'|'sumTax'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sevClient': ModelVoucherPosResponseSevClientToJSON(value['sevClient']),
        'voucher': ModelVoucherPosResponseVoucherToJSON(value['voucher']),
        'accountDatev': ModelVoucherPosAccountDatevToJSON(value['accountDatev']),
        'accountingType': ModelVoucherPosResponseAccountingTypeToJSON(value['accountingType']),
        'estimatedAccountingType': ModelVoucherPosResponseEstimatedAccountingTypeToJSON(value['estimatedAccountingType']),
        'taxRate': value['taxRate'],
        'net': value['net'],
        'isAsset': value['isAsset'],
        'sumNet': value['sumNet'],
        'sumGross': value['sumGross'],
