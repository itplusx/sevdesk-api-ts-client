...
import type { ModelContactResponseParent } from './ModelContactResponseParent';
import {
    ModelContactResponseParentFromJSON,
    ModelContactResponseParentFromJSONTyped,
    ModelContactResponseParentToJSON,
    ModelContactResponseParentToJSONTyped,
} from './ModelContactResponseParent';
import type { ModelContactResponseCategory } from './ModelContactResponseCategory';
import {
    ModelContactResponseCategoryFromJSON,
    ModelContactResponseCategoryFromJSONTyped,
    ModelContactResponseCategoryToJSON,
    ModelContactResponseCategoryToJSONTyped,
} from './ModelContactResponseCategory';
import type { ModelContactResponseSevClient } from './ModelContactResponseSevClient';
import {
    ModelContactResponseSevClientFromJSON,
    ModelContactResponseSevClientFromJSONTyped,
    ModelContactResponseSevClientToJSON,
    ModelContactResponseSevClientToJSONTyped,
} from './ModelContactResponseSevClient';

/**
 * Contact model
 * @export
 * @interface ModelContactResponse
 */
export interface ModelContactResponse {
    /**
     * The contact id
     * @type {string}
     * @memberof ModelContactResponse
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelContactResponseParent}
     * @memberof ModelContactResponse
     */
    ...
    /**
     * 
     * @type {ModelContactResponseCategory}
     * @memberof ModelContactResponse
     */
    ...
    /**
     * 
     * @type {ModelContactResponseSevClient}
     * @memberof ModelContactResponse
     */
    sevClient?: ModelContactResponseSevClient;
    /**
     ...
     * @memberof ModelContactResponse
     */
    readonly defaultCashbackPercent?: number;
    /**
     ...
     * @memberof ModelContactResponse
     */
    readonly defaultDiscountAmount?: number;
    /**
...
/**
 * Check if a given object implements the ModelContactResponse interface.
 */
export function instanceOfModelContactResponse(value: object): value is ModelContactResponse {
    return true;
}

export function ModelContactResponseFromJSON(json: any): ModelContactResponse {
    return ModelContactResponseFromJSONTyped(json, false);
}

export function ModelContactResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelContactResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'parent': json['parent'] == null ? undefined : ModelContactResponseParentFromJSON(json['parent']),
        'surename': json['surename'] == null ? undefined : json['surename'],
        'familyname': json['familyname'] == null ? undefined : json['familyname'],
        'titel': json['titel'] == null ? undefined : json['titel'],
        'category': json['category'] == null ? undefined : ModelContactResponseCategoryFromJSON(json['category']),
        'description': json['description'] == null ? undefined : json['description'],
        'academicTitle': json['academicTitle'] == null ? undefined : json['academicTitle'],
        'gender': json['gender'] == null ? undefined : json['gender'],
        'sevClient': json['sevClient'] == null ? undefined : ModelContactResponseSevClientFromJSON(json['sevClient']),
        ...
        'bankNumber': json['bankNumber'] == null ? undefined : json['bankNumber'],
        'defaultCashbackTime': json['defaultCashbackTime'] == null ? undefined : json['defaultCashbackTime'],
        'defaultCashbackPercent': json['defaultCashbackPercent'] == null ? undefined : json['defaultCashbackPercent'],
        'defaultTimeToPay': json['defaultTimeToPay'] == null ? undefined : json['defaultTimeToPay'],
        'taxNumber': json['taxNumber'] == null ? undefined : json['taxNumber'],
        'taxOffice': json['taxOffice'] == null ? undefined : json['taxOffice'],
        'exemptVat': json['exemptVat'] == null ? undefined : json['exemptVat'],
        'defaultDiscountAmount': json['defaultDiscountAmount'] == null ? undefined : json['defaultDiscountAmount'],
        'defaultDiscountPercentage': json['defaultDiscountPercentage'] == null ? undefined : json['defaultDiscountPercentage'],
        'buyerReference': json['buyerReference'] == null ? undefined : json['buyerReference'],
        'governmentAgency': json['governmentAgency'] == null ? undefined : json['governmentAgency'],
        'additionalInformation': json['additionalInformation'] == null ? undefined : json['additionalInformation'],
    };
}

export function ModelContactResponseToJSON(json: any): ModelContactResponse {
    return ModelContactResponseToJSONTyped(json, false);
}

export function ModelContactResponseToJSONTyped(value?: Omit<ModelContactResponse, 'id'|'objectName'|'create'|'update'|'name'|'status'|'customerNumber'|'surename'|'familyname'|'titel'|'description'|'academicTitle'|'gender'|'name2'|'birthday'|'vatNumber'|'bankAccount'|'bankNumber'|'defaultCashbackTime'|'defaultCashbackPercent'|'defaultTimeToPay'|'taxNumber'|'taxOffice'|'exemptVat'|'defaultDiscountAmount'|'defaultDiscountPercentage'|'buyerReference'|'governmentAgency'|'additionalInformation'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'parent': ModelContactResponseParentToJSON(value['parent']),
        'category': ModelContactResponseCategoryToJSON(value['category']),
        'sevClient': ModelContactResponseSevClientToJSON(value['sevClient']),
    };
}
