...
import type { ModelCheckAccountTransactionSevClient } from './ModelCheckAccountTransactionSevClient';
import {
    ModelCheckAccountTransactionSevClientFromJSON,
    ModelCheckAccountTransactionSevClientFromJSONTyped,
    ModelCheckAccountTransactionSevClientToJSON,
    ModelCheckAccountTransactionSevClientToJSONTyped,
} from './ModelCheckAccountTransactionSevClient';
import type { ModelCheckAccountTransactionCheckAccount } from './ModelCheckAccountTransactionCheckAccount';
import {
    ModelCheckAccountTransactionCheckAccountFromJSON,
    ModelCheckAccountTransactionCheckAccountFromJSONTyped,
    ModelCheckAccountTransactionCheckAccountToJSON,
    ModelCheckAccountTransactionCheckAccountToJSONTyped,
} from './ModelCheckAccountTransactionCheckAccount';
import type { ModelCheckAccountTransactionTargetTransaction } from './ModelCheckAccountTransactionTargetTransaction';
import {
    ModelCheckAccountTransactionTargetTransactionFromJSON,
    ModelCheckAccountTransactionTargetTransactionFromJSONTyped,
    ModelCheckAccountTransactionTargetTransactionToJSON,
    ModelCheckAccountTransactionTargetTransactionToJSONTyped,
} from './ModelCheckAccountTransactionTargetTransaction';
import type { ModelCheckAccountTransactionSourceTransaction } from './ModelCheckAccountTransactionSourceTransaction';
import {
    ModelCheckAccountTransactionSourceTransactionFromJSON,
    ModelCheckAccountTransactionSourceTransactionFromJSONTyped,
    ModelCheckAccountTransactionSourceTransactionToJSON,
    ModelCheckAccountTransactionSourceTransactionToJSONTyped,
} from './ModelCheckAccountTransactionSourceTransaction';
...
export interface ModelCheckAccountTransaction {
    ...
    /**
     * 
     * @type {ModelCheckAccountTransactionSevClient}
     * @memberof ModelCheckAccountTransaction
     */
    sevClient?: ModelCheckAccountTransactionSevClient;
    /**
    ...
    /**
     * 
     * @type {ModelCheckAccountTransactionCheckAccount}
     * @memberof ModelCheckAccountTransaction
     */
    checkAccount: ModelCheckAccountTransactionCheckAccount;
    /**
     ...
     * @memberof ModelCheckAccountTransaction
     */
    status: ModelCheckAccountTransactionStatusEnum;
    /**
     * 
     * @type {ModelCheckAccountTransactionSourceTransaction}
     * @memberof ModelCheckAccountTransaction
     */
    sourceTransaction?: ModelCheckAccountTransactionSourceTransaction | null;
    /**
     * 
     * @type {ModelCheckAccountTransactionTargetTransaction}
     * @memberof ModelCheckAccountTransaction
     */
    targetTransaction?: ModelCheckAccountTransactionTargetTransaction | null;
}
 ...
 * @export
 */
export const ModelCheckAccountTransactionStatusEnum = {
    NUMBER_100: 100,
    NUMBER_200: 200,
    NUMBER_300: 300,
    NUMBER_400: 400
} as const;
export type ModelCheckAccountTransactionStatusEnum = typeof ModelCheckAccountTransactionStatusEnum[keyof typeof ModelCheckAccountTransactionStatusEnum];


/**
 * Check if a given object implements the ModelCheckAccountTransaction interface.
 */
export function instanceOfModelCheckAccountTransaction(value: object): value is ModelCheckAccountTransaction {
    if (!('valueDate' in value) || value['valueDate'] === undefined) return false;
    if (!('amount' in value) || value['amount'] === undefined) return false;
    if (!('payeePayerName' in value) || value['payeePayerName'] === undefined) return false;
    if (!('checkAccount' in value) || value['checkAccount'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function ModelCheckAccountTransactionFromJSON(json: any): ModelCheckAccountTransaction {
    return ModelCheckAccountTransactionFromJSONTyped(json, false);
}

export function ModelCheckAccountTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCheckAccountTransaction {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sevClient': json['sevClient'] == null ? undefined : ModelCheckAccountTransactionSevClientFromJSON(json['sevClient']),
        ...
        'amount': json['amount'],
        'payeePayerName': json['payeePayerName'],
        ...
        'checkAccount': ModelCheckAccountTransactionCheckAccountFromJSON(json['checkAccount']),
        'status': json['status'],
        'sourceTransaction': json['sourceTransaction'] == null ? undefined : ModelCheckAccountTransactionSourceTransactionFromJSON(json['sourceTransaction']),
        'targetTransaction': json['targetTransaction'] == null ? undefined : ModelCheckAccountTransactionTargetTransactionFromJSON(json['targetTransaction']),
    };
}

export function ModelCheckAccountTransactionToJSON(json: any): ModelCheckAccountTransaction {
    return ModelCheckAccountTransactionToJSONTyped(json, false);
}

export function ModelCheckAccountTransactionToJSONTyped(value?: Omit<ModelCheckAccountTransaction, 'id'|'objectName'|'create'|'update'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sevClient': ModelCheckAccountTransactionSevClientToJSON(value['sevClient']),
        ...
        'checkAccount': ModelCheckAccountTransactionCheckAccountToJSON(value['checkAccount']),
        'status': value['status'],
        'sourceTransaction': ModelCheckAccountTransactionSourceTransactionToJSON(value['sourceTransaction']),
        'targetTransaction': ModelCheckAccountTransactionTargetTransactionToJSON(value['targetTransaction']),
    };
}
