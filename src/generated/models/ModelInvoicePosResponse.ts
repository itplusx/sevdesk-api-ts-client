...
import type { ModelInvoicePosResponseUnity } from './ModelInvoicePosResponseUnity';
import {
    ModelInvoicePosResponseUnityFromJSON,
    ModelInvoicePosResponseUnityFromJSONTyped,
    ModelInvoicePosResponseUnityToJSON,
    ModelInvoicePosResponseUnityToJSONTyped,
} from './ModelInvoicePosResponseUnity';
import type { ModelInvoicePosResponsePart } from './ModelInvoicePosResponsePart';
import {
    ModelInvoicePosResponsePartFromJSON,
    ModelInvoicePosResponsePartFromJSONTyped,
    ModelInvoicePosResponsePartToJSON,
    ModelInvoicePosResponsePartToJSONTyped,
} from './ModelInvoicePosResponsePart';
import type { ModelInvoicePosResponseSevClient } from './ModelInvoicePosResponseSevClient';
import {
    ModelInvoicePosResponseSevClientFromJSON,
    ModelInvoicePosResponseSevClientFromJSONTyped,
    ModelInvoicePosResponseSevClientToJSON,
    ModelInvoicePosResponseSevClientToJSONTyped,
} from './ModelInvoicePosResponseSevClient';
import type { ModelInvoicePosResponseInvoice } from './ModelInvoicePosResponseInvoice';
import {
    ModelInvoicePosResponseInvoiceFromJSON,
    ModelInvoicePosResponseInvoiceFromJSONTyped,
    ModelInvoicePosResponseInvoiceToJSON,
    ModelInvoicePosResponseInvoiceToJSONTyped,
} from './ModelInvoicePosResponseInvoice';

/**
 * Invoice position model
 * @export
 * @interface ModelInvoicePosResponse
 */
export interface ModelInvoicePosResponse {
    /**
     * The invoice position id
     * @type {string}
     * @memberof ModelInvoicePosResponse
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ModelInvoicePosResponseInvoice}
     * @memberof ModelInvoicePosResponse
     */
    invoice?: ModelInvoicePosResponseInvoice;
    /**
     * 
     * @type {ModelInvoicePosResponsePart}
     * @memberof ModelInvoicePosResponse
     */
    ...
    /**
     * 
     * @type {ModelInvoicePosResponseUnity}
     * @memberof ModelInvoicePosResponse
     */
    unity?: ModelInvoicePosResponseUnity;
    /**
     * 
     * @type {ModelInvoicePosResponseSevClient}
     * @memberof ModelInvoicePosResponse
     */
    sevClient?: ModelInvoicePosResponseSevClient;
    /**
...
/**
 * Check if a given object implements the ModelInvoicePosResponse interface.
 */
export function instanceOfModelInvoicePosResponse(value: object): value is ModelInvoicePosResponse {
    return true;
}

export function ModelInvoicePosResponseFromJSON(json: any): ModelInvoicePosResponse {
    return ModelInvoicePosResponseFromJSONTyped(json, false);
}

export function ModelInvoicePosResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelInvoicePosResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'invoice': json['invoice'] == null ? undefined : ModelInvoicePosResponseInvoiceFromJSON(json['invoice']),
        'part': json['part'] == null ? undefined : ModelInvoicePosResponsePartFromJSON(json['part']),
        'quantity': json['quantity'] == null ? undefined : json['quantity'],
        'price': json['price'] == null ? undefined : json['price'],
        'name': json['name'] == null ? undefined : json['name'],
        'unity': json['unity'] == null ? undefined : ModelInvoicePosResponseUnityFromJSON(json['unity']),
        'sevClient': json['sevClient'] == null ? undefined : ModelInvoicePosResponseSevClientFromJSON(json['sevClient']),
...
export function ModelInvoicePosResponseToJSON(json: any): ModelInvoicePosResponse {
    return ModelInvoicePosResponseToJSONTyped(json, false);
}

export function ModelInvoicePosResponseToJSONTyped(value?: Omit<ModelInvoicePosResponse, 'id'|'objectName'|'create'|'update'|'quantity'|'price'|'name'|'positionNumber'|'text'|'discount'|'taxRate'|'sumDiscount'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'priceNet'|'priceGross'|'priceTax'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'invoice': ModelInvoicePosResponseInvoiceToJSON(value['invoice']),
        'part': ModelInvoicePosResponsePartToJSON(value['part']),
        'unity': ModelInvoicePosResponseUnityToJSON(value['unity']),
        'sevClient': ModelInvoicePosResponseSevClientToJSON(value['sevClient']),
    };
}
