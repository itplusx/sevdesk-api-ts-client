...
import {
    ...
    GetDiscounts200ResponseFromJSON,
    GetDiscounts200ResponseToJSON,
    GetOrderPositionsById200ResponseFromJSON,
    GetOrderPositionsById200ResponseToJSON,
    GetOrders200ResponseFromJSON,
    GetOrders200ResponseToJSON,
    ModelCreatePackingListFromOrderFromJSON,
    ModelCreatePackingListFromOrderToJSON,
    ModelOrderResponseFromJSON,
    ModelOrderResponseToJSON,
    ModelOrderUpdateFromJSON,
    ModelOrderUpdateToJSON,
    OrderGetPdf200ResponseFromJSON,
    OrderGetPdf200ResponseToJSON,
    OrderSendByRequestFromJSON,
    OrderSendByRequestToJSON,
    SaveOrderFromJSON,
    SaveOrderToJSON,
    SaveOrderResponseFromJSON,
    SaveOrderResponseToJSON,
    SendorderViaEMail201ResponseFromJSON,
    SendorderViaEMail201ResponseToJSON,
    SendorderViaEMailRequestFromJSON,
    SendorderViaEMailRequestToJSON,
} from '../models/index';

export interface CreateContractNoteFromOrderRequest {
    orderId: number;
...
export interface CreatePackingListFromOrderRequest {
    orderId: number;
    orderObjectName: string;
    modelCreatePackingListFromOrder?: ModelCreatePackingListFromOrder;
}
...
export interface GetOrderPositionsByIdRequest {
    orderId: number;
    limit?: number;
    offset?: number;
    embed?: Array<string>;
...
export interface OrderGetPdfRequest {
    orderId: number;
    download?: boolean;
    preventSendBy?: boolean;
}

export interface OrderSendByOperationRequest {
    orderId: number;
    orderSendByRequest?: OrderSendByRequest;
}

export interface SendorderViaEMailOperationRequest {
    orderId: number;
    sendorderViaEMailRequest?: SendorderViaEMailRequest;
}

export interface UpdateOrderRequest {
    orderId: number;
    modelOrderUpdate?: Omit<ModelOrderUpdate, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'>;
}
...
export class OrderApi extends runtime.BaseAPI {
     ...
     * Create contract note from order
     */
    async createContractNoteFromOrderRaw(requestParameters: CreateContractNoteFromOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelOrderResponse>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
                'Required parameter "orderId" was null or undefined when calling createContractNoteFromOrder().'
            );
        }

        if (requestParameters['orderObjectName'] == null) {
            throw new runtime.RequiredError(
                'orderObjectName',
                'Required parameter "orderObjectName" was null or undefined when calling createContractNoteFromOrder().'
            );
        }
        ...
        if (requestParameters['orderObjectName'] != null) {
            queryParameters['order[objectName]'] = requestParameters['orderObjectName'];
        }
        ...
        let urlPath = `/Order/Factory/createContractNoteFromOrder`;
        ...
        const response = await this.request({
            ...
            body: ModelCreatePackingListFromOrderToJSON(requestParameters['modelCreatePackingListFromOrder']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelOrderResponseFromJSON(jsonValue));
    }
     ...
     * Create contract note from order
     */
    async createContractNoteFromOrder(requestParameters: CreateContractNoteFromOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelOrderResponse> {
        const response = await this.createContractNoteFromOrderRaw(requestParameters, initOverrides);
     ...
     * Create a new order
     */
    async createOrderRaw(requestParameters: CreateOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SaveOrderResponse>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/Order/Factory/saveOrder`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SaveOrderToJSON(requestParameters['saveOrder']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SaveOrderResponseFromJSON(jsonValue));
    }
     ...
     * Create a new order
     */
    async createOrder(requestParameters: CreateOrderRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SaveOrderResponse> {
     ...
     * Create packing list from order
     */
    async createPackingListFromOrderRaw(requestParameters: CreatePackingListFromOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelOrderResponse>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
                'Required parameter "orderId" was null or undefined when calling createPackingListFromOrder().'
            );
        }
        ...
        if (requestParameters['orderObjectName'] == null) {
            throw new runtime.RequiredError(
                'orderObjectName',
                'Required parameter "orderObjectName" was null or undefined when calling createPackingListFromOrder().'
            );
        }
        ...
        let urlPath = `/Order/Factory/createPackingListFromOrder`;
     ...
     * Create packing list from order
     */
    async createPackingListFromOrder(requestParameters: CreatePackingListFromOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelOrderResponse> {
        const response = await this.createPackingListFromOrderRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Deletes an order
     */
    async deleteOrderRaw(requestParameters: DeleteOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
     ...
     * Deletes an order
     */
    async deleteOrder(requestParameters: DeleteOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
     ...
     */
    async getDiscountsRaw(requestParameters: GetDiscountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetDiscounts200Response>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
                'Required parameter "orderId" was null or undefined when calling getDiscounts().'
            );
        }
        ...
        let urlPath = `/Order/{orderId}/getDiscounts`;
        urlPath = urlPath.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetDiscounts200ResponseFromJSON(jsonValue));
    }
     ...
     * Find order discounts
     */
    async getDiscounts(requestParameters: GetDiscountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetDiscounts200Response> {
     ...
     * Find order by ID
     */
    async getOrderByIdRaw(requestParameters: GetOrderByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetOrders200Response>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
     ...
     * Find order by ID
     */
    async getOrderById(requestParameters: GetOrderByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetOrders200Response> {
     ...
     */
    async getOrderPositionsByIdRaw(requestParameters: GetOrderPositionsByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetOrderPositionsById200Response>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
                'Required parameter "orderId" was null or undefined when calling getOrderPositionsById().'
            );
        }
        ...
        let urlPath = `/Order/{orderId}/getPositions`;
        urlPath = urlPath.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetOrderPositionsById200ResponseFromJSON(jsonValue));
    }
     ...
     * Find order positions
     */
    async getOrderPositionsById(requestParameters: GetOrderPositionsByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetOrderPositionsById200Response> {
        const response = await this.getOrderPositionsByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getRelatedObjectsRaw(requestParameters: GetRelatedObjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetOrderPositionsById200Response>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
                'Required parameter "orderId" was null or undefined when calling getRelatedObjects().'
            );
        }

        const queryParameters: any = {};

        if (requestParameters['includeItself'] != null) {
            queryParameters['includeItself'] = requestParameters['includeItself'];
        }

        if (requestParameters['sortByType'] != null) {
            queryParameters['sortByType'] = requestParameters['sortByType'];
        }
        ...
        let urlPath = `/Order/{orderId}/getRelatedObjects`;
        urlPath = urlPath.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId'])));
     ...
     * Find related objects
     */
    async getRelatedObjects(requestParameters: GetRelatedObjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetOrderPositionsById200Response> {
        const response = await this.getRelatedObjectsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async orderGetPdfRaw(requestParameters: OrderGetPdfRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderGetPdf200Response>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
                'Required parameter "orderId" was null or undefined when calling orderGetPdf().'
            );
        }
        ...
        let urlPath = `/Order/{orderId}/getPdf`;
        urlPath = urlPath.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => OrderGetPdf200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve pdf document of an order
     */
    async orderGetPdf(requestParameters: OrderGetPdfRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderGetPdf200Response> {
        const response = await this.orderGetPdfRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Mark order as sent
     */
    async orderSendByRaw(requestParameters: OrderSendByOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelOrderResponse>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
                'Required parameter "orderId" was null or undefined when calling orderSendBy().'
            );
        }
        ...
        let urlPath = `/Order/{orderId}/sendBy`;
        urlPath = urlPath.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId'])));
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: OrderSendByRequestToJSON(requestParameters['orderSendByRequest']),
        }, initOverrides);
     ...
     * Mark order as sent
     */
    async orderSendBy(requestParameters: OrderSendByOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelOrderResponse> {
        const response = await this.orderSendByRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async sendorderViaEMailRaw(requestParameters: SendorderViaEMailOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SendorderViaEMail201Response>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
                'Required parameter "orderId" was null or undefined when calling sendorderViaEMail().'
            );
        }
        ...
        let urlPath = `/Order/{orderId}/sendViaEmail`;
        urlPath = urlPath.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId'])));
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SendorderViaEMailRequestToJSON(requestParameters['sendorderViaEMailRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SendorderViaEMail201ResponseFromJSON(jsonValue));
    }
     ...
     * Send order via email
     */
    async sendorderViaEMail(requestParameters: SendorderViaEMailOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SendorderViaEMail201Response> {
        const response = await this.sendorderViaEMailRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateOrderRaw(requestParameters: UpdateOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelOrderResponse>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelOrderUpdateToJSON(requestParameters['modelOrderUpdate']),
        }, initOverrides);
     ...
     * Update an existing order
     */
    async updateOrder(requestParameters: UpdateOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelOrderResponse> {
