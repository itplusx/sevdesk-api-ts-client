...
import {
    ...
    GetTagRelations200ResponseFromJSON,
    GetTagRelations200ResponseToJSON,
    GetTags200ResponseFromJSON,
    GetTags200ResponseToJSON,
    ModelTagCreateResponseFromJSON,
    ModelTagCreateResponseToJSON,
    ModelTagResponseFromJSON,
    ModelTagResponseToJSON,
...
export class TagApi extends runtime.BaseAPI {
     ...
     * Create a new tag
     */
    async createTagRaw(requestParameters: CreateTagOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelTagCreateResponse>> {
        ...
        let urlPath = `/Tag/Factory/create`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ModelTagCreateResponseFromJSON(jsonValue));
    }
     ...
     * Create a new tag
     */
    async createTag(requestParameters: CreateTagOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelTagCreateResponse> {
     ...
     * Deletes a tag
     */
    async deleteTagRaw(requestParameters: DeleteTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
     ...
     * Deletes a tag
     */
    async deleteTag(requestParameters: DeleteTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
     ...
     * Find tag by ID
     */
    async getTagByIdRaw(requestParameters: GetTagByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetTags200Response>> {
        if (requestParameters['tagId'] == null) {
            throw new runtime.RequiredError(
                'tagId',
     ...
     * Find tag by ID
     */
    async getTagById(requestParameters: GetTagByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetTags200Response> {
     ...
     */
    async getTagRelationsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetTagRelations200Response>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetTagRelations200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve tag relations
     */
    async getTagRelations(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetTagRelations200Response> {
        const response = await this.getTagRelationsRaw(initOverrides);
        return await response.value();
    }
     ...
     * Update tag
     */
    async updateTagRaw(requestParameters: UpdateTagOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelTagResponse>> {
        if (requestParameters['tagId'] == null) {
            throw new runtime.RequiredError(
                'tagId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ModelTagResponseFromJSON(jsonValue));
    }
     ...
     * Update tag
     */
    async updateTag(requestParameters: UpdateTagOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelTagResponse> {
