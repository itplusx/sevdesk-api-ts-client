...
import {
    ...
    GetAccountingContact200ResponseFromJSON,
    GetAccountingContact200ResponseToJSON,
    ModelAccountingContactFromJSON,
    ModelAccountingContactToJSON,
    ModelAccountingContactResponseFromJSON,
    ModelAccountingContactResponseToJSON,
    ModelAccountingContactUpdateFromJSON,
    ModelAccountingContactUpdateToJSON,
} from '../models/index';

export interface CreateAccountingContactRequest {
    modelAccountingContact?: ModelAccountingContact;
}

export interface DeleteAccountingContactRequest {
    accountingContactId: number;
}

export interface GetAccountingContactRequest {
    contactId?: string;
    contactObjectName?: string;
}

export interface GetAccountingContactByIdRequest {
    accountingContactId: number;
}

export interface UpdateAccountingContactRequest {
    accountingContactId: number;
 ...
 * 
 */
export class AccountingContactApi extends runtime.BaseAPI {

    /**
     * Creates a new accounting contact.
     * Create a new accounting contact
     */
    async createAccountingContactRaw(requestParameters: CreateAccountingContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelAccountingContactResponse>> {
        ...
        const response = await this.request({
            ...
            body: ModelAccountingContactToJSON(requestParameters['modelAccountingContact']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelAccountingContactResponseFromJSON(jsonValue));
    }
     ...
     * Create a new accounting contact
     */
    async createAccountingContact(requestParameters: CreateAccountingContactRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelAccountingContactResponse> {
        const response = await this.createAccountingContactRaw(requestParameters, initOverrides);
     ...
     */
    async deleteAccountingContactRaw(requestParameters: DeleteAccountingContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['accountingContactId'] == null) {
            throw new runtime.RequiredError(
                'accountingContactId',
                'Required parameter "accountingContactId" was null or undefined when calling deleteAccountingContact().'
            );
        }
        ...
        let urlPath = `/AccountingContact/{accountingContactId}`;
        urlPath = urlPath.replace(`{${"accountingContactId"}}`, encodeURIComponent(String(requestParameters['accountingContactId'])));
     ...
     * Deletes an accounting contact
     */
    async deleteAccountingContact(requestParameters: DeleteAccountingContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
        const response = await this.deleteAccountingContactRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getAccountingContactRaw(requestParameters: GetAccountingContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAccountingContact200Response>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetAccountingContact200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve accounting contact
     */
    async getAccountingContact(requestParameters: GetAccountingContactRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAccountingContact200Response> {
        const response = await this.getAccountingContactRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getAccountingContactByIdRaw(requestParameters: GetAccountingContactByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAccountingContact200Response>> {
        if (requestParameters['accountingContactId'] == null) {
            throw new runtime.RequiredError(
                'accountingContactId',
                'Required parameter "accountingContactId" was null or undefined when calling getAccountingContactById().'
            );
        }
     ...
     * Find accounting contact by ID
     */
    async getAccountingContactById(requestParameters: GetAccountingContactByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAccountingContact200Response> {
        const response = await this.getAccountingContactByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateAccountingContactRaw(requestParameters: UpdateAccountingContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelAccountingContactResponse>> {
        if (requestParameters['accountingContactId'] == null) {
            throw new runtime.RequiredError(
                'accountingContactId',
                'Required parameter "accountingContactId" was null or undefined when calling updateAccountingContact().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelAccountingContactUpdateToJSON(requestParameters['modelAccountingContactUpdate']),
        }, initOverrides);
     ...
     * Update an existing accounting contact
     */
    async updateAccountingContact(requestParameters: UpdateAccountingContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelAccountingContactResponse> {
        const response = await this.updateAccountingContactRaw(requestParameters, initOverrides);
        return await response.value();
    }
