...
import {
    ...
    ExportContact200ResponseFromJSON,
    ExportContact200ResponseToJSON,
    ExportContactSevQueryParameterFromJSON,
    ExportContactSevQueryParameterToJSON,
    ExportCreditNote200ResponseFromJSON,
    ExportCreditNote200ResponseToJSON,
    ExportCreditNoteSevQueryParameterFromJSON,
    ExportCreditNoteSevQueryParameterToJSON,
    ExportDatevCSV200ResponseFromJSON,
    ExportDatevCSV200ResponseToJSON,
    ExportInvoice200ResponseFromJSON,
    ExportInvoice200ResponseToJSON,
    ExportInvoiceSevQueryParameterFromJSON,
    ExportInvoiceSevQueryParameterToJSON,
    ExportInvoiceZip200ResponseFromJSON,
    ExportInvoiceZip200ResponseToJSON,
    ExportInvoiceZipSevQueryParameterFromJSON,
    ExportInvoiceZipSevQueryParameterToJSON,
    ExportTransactions200ResponseFromJSON,
    ExportTransactions200ResponseToJSON,
    ExportTransactionsSevQueryParameterFromJSON,
    ExportTransactionsSevQueryParameterToJSON,
    ExportVoucher200ResponseFromJSON,
    ExportVoucher200ResponseToJSON,
    ExportVoucherSevQueryParameterFromJSON,
    ExportVoucherSevQueryParameterToJSON,
    ExportVoucherZip200ResponseFromJSON,
    ExportVoucherZip200ResponseToJSON,
    ExportVoucherZipSevQueryParameterFromJSON,
    ExportVoucherZipSevQueryParameterToJSON,
    GenerateDownloadHash200ResponseFromJSON,
    GenerateDownloadHash200ResponseToJSON,
    JobDownloadInfo200ResponseFromJSON,
    JobDownloadInfo200ResponseToJSON,
    UpdateExportConfigRequestFromJSON,
    UpdateExportConfigRequestToJSON,
} from '../models/index';
...
export interface ExportCreditNoteRequest {
    sevQuery: ExportCreditNoteSevQueryParameter;
    download?: boolean;
}

export interface ExportDatevCSVRequest {
    startDate: number;
    endDate: number;
    scope: string;
...
export interface ExportDatevDepricatedRequest {
    startDate: number;
    endDate: number;
    scope: string;
    download?: boolean;
...
export interface ExportDatevXMLRequest {
    startDate: number;
    endDate: number;
    scope: string;
    exportByPaydate?: boolean;
...
export interface ExportInvoiceZipRequest {
    sevQuery: ExportInvoiceZipSevQueryParameter;
    download?: boolean;
}
...
export interface ExportVoucherRequest {
    sevQuery: ExportVoucherSevQueryParameter;
    download?: boolean;
}

export interface ExportVoucherZipRequest {
    sevQuery: ExportVoucherZipSevQueryParameter;
    download?: boolean;
}

export interface GenerateDownloadHashRequest {
    jobId: string;
}
...
export interface JobDownloadInfoRequest {
    jobId: string;
}

export interface UpdateExportConfigOperationRequest {
    sevClientId: number;
    updateExportConfigRequest?: UpdateExportConfigRequest;
}
...
export class ExportApi extends runtime.BaseAPI {
     ...
     * Export contact
     */
    async exportContactRaw(requestParameters: ExportContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportContact200Response>> {
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling exportContact().'
            );
        }
        ...
        if (requestParameters['sevQuery'] != null) {
            queryParameters['sevQuery'] = requestParameters['sevQuery'];
        }
        ...
        let urlPath = `/Export/contactListCsv`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ExportContact200ResponseFromJSON(jsonValue));
    }
     ...
     * Export contact
     */
    async exportContact(requestParameters: ExportContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExportContact200Response> {
        const response = await this.exportContactRaw(requestParameters, initOverrides);
     ...
     * Export creditNote
     */
    async exportCreditNoteRaw(requestParameters: ExportCreditNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportCreditNote200Response>> {
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling exportCreditNote().'
            );
        }
        ...
        let urlPath = `/Export/creditNoteCsv`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ExportCreditNote200ResponseFromJSON(jsonValue));
    }
     ...
     * Export creditNote
     */
    async exportCreditNote(requestParameters: ExportCreditNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExportCreditNote200Response> {
        const response = await this.exportCreditNoteRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async exportDatevCSVRaw(requestParameters: ExportDatevCSVRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportDatevCSV200Response>> {
        if (requestParameters['startDate'] == null) {
            throw new runtime.RequiredError(
                'startDate',
                'Required parameter "startDate" was null or undefined when calling exportDatevCSV().'
            );
        }
        ...
        if (requestParameters['endDate'] == null) {
            throw new runtime.RequiredError(
                'endDate',
                'Required parameter "endDate" was null or undefined when calling exportDatevCSV().'
            );
        }
        ...
        if (requestParameters['scope'] == null) {
            throw new runtime.RequiredError(
                'scope',
                'Required parameter "scope" was null or undefined when calling exportDatevCSV().'
            );
        }
        ...
        if (requestParameters['exportByPaydate'] != null) {
            queryParameters['exportByPaydate'] = requestParameters['exportByPaydate'];
        }

        if (requestParameters['includeEnshrined'] != null) {
            queryParameters['includeEnshrined'] = requestParameters['includeEnshrined'];
        }

        if (requestParameters['enshrineDocuments'] != null) {
            queryParameters['enshrineDocuments'] = requestParameters['enshrineDocuments'];
        }

        if (requestParameters['includeDocumentImages'] != null) {
            queryParameters['includeDocumentImages'] = requestParameters['includeDocumentImages'];
        }
        ...
        let urlPath = `/Export/createDatevCsvZipExportJob`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ExportDatevCSV200ResponseFromJSON(jsonValue));
    }
     ...
     * Start DATEV CSV ZIP export
     */
    async exportDatevCSV(requestParameters: ExportDatevCSVRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExportDatevCSV200Response> {
        const response = await this.exportDatevCSVRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * @deprecated
     */
    async exportDatevDepricatedRaw(requestParameters: ExportDatevDepricatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters['startDate'] == null) {
            throw new runtime.RequiredError(
                'startDate',
                'Required parameter "startDate" was null or undefined when calling exportDatevDepricated().'
            );
        }
        ...
        if (requestParameters['endDate'] == null) {
            throw new runtime.RequiredError(
                'endDate',
                'Required parameter "endDate" was null or undefined when calling exportDatevDepricated().'
            );
        }
        ...
        if (requestParameters['scope'] == null) {
            throw new runtime.RequiredError(
                'scope',
                'Required parameter "scope" was null or undefined when calling exportDatevDepricated().'
            );
        }
        ...
        if (requestParameters['withUnpaidDocuments'] != null) {
            queryParameters['withUnpaidDocuments'] = requestParameters['withUnpaidDocuments'];
        }

        if (requestParameters['withEnshrinedDocuments'] != null) {
            queryParameters['withEnshrinedDocuments'] = requestParameters['withEnshrinedDocuments'];
        }

        if (requestParameters['enshrine'] != null) {
            queryParameters['enshrine'] = requestParameters['enshrine'];
        }
     ...
     * @deprecated
     */
    async exportDatevDepricated(requestParameters: ExportDatevDepricatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.exportDatevDepricatedRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async exportDatevXMLRaw(requestParameters: ExportDatevXMLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportDatevCSV200Response>> {
        if (requestParameters['startDate'] == null) {
            throw new runtime.RequiredError(
                'startDate',
                'Required parameter "startDate" was null or undefined when calling exportDatevXML().'
            );
        }
        ...
        if (requestParameters['endDate'] == null) {
            throw new runtime.RequiredError(
                'endDate',
                'Required parameter "endDate" was null or undefined when calling exportDatevXML().'
            );
        }
        ...
        if (requestParameters['scope'] == null) {
            throw new runtime.RequiredError(
                'scope',
                'Required parameter "scope" was null or undefined when calling exportDatevXML().'
            );
        }
        ...
        if (requestParameters['includeExportedDocuments'] != null) {
            queryParameters['includeExportedDocuments'] = requestParameters['includeExportedDocuments'];
        }

        if (requestParameters['includeDocumentXml'] != null) {
            queryParameters['includeDocumentXml'] = requestParameters['includeDocumentXml'];
        }
        ...
        let urlPath = `/Export/createDatevXmlZipExportJob`;
     ...
     * Start DATEV XML ZIP export
     */
    async exportDatevXML(requestParameters: ExportDatevXMLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExportDatevCSV200Response> {
        const response = await this.exportDatevXMLRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Export invoice
     */
    async exportInvoiceRaw(requestParameters: ExportInvoiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportInvoice200Response>> {
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling exportInvoice().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ExportInvoice200ResponseFromJSON(jsonValue));
    }
     ...
     * Export invoice
     */
    async exportInvoice(requestParameters: ExportInvoiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExportInvoice200Response> {
        const response = await this.exportInvoiceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async exportInvoiceZipRaw(requestParameters: ExportInvoiceZipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportInvoiceZip200Response>> {
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling exportInvoiceZip().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ExportInvoiceZip200ResponseFromJSON(jsonValue));
    }
     ...
     * Export Invoice as zip
     */
    async exportInvoiceZip(requestParameters: ExportInvoiceZipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExportInvoiceZip200Response> {
        const response = await this.exportInvoiceZipRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Export transaction
     */
    async exportTransactionsRaw(requestParameters: ExportTransactionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportTransactions200Response>> {
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling exportTransactions().'
            );
        }
        ...
        let urlPath = `/Export/transactionsCsv`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ExportTransactions200ResponseFromJSON(jsonValue));
    }
     ...
     * Export transaction
     */
    async exportTransactions(requestParameters: ExportTransactionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExportTransactions200Response> {
     ...
     */
    async exportVoucherRaw(requestParameters: ExportVoucherRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportVoucher200Response>> {
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling exportVoucher().'
            );
        }
        ...
        let urlPath = `/Export/voucherListCsv`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ExportVoucher200ResponseFromJSON(jsonValue));
    }
     ...
     * Export voucher as zip
     */
    async exportVoucher(requestParameters: ExportVoucherRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExportVoucher200Response> {
        const response = await this.exportVoucherRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Export voucher zip
     */
    async exportVoucherZipRaw(requestParameters: ExportVoucherZipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExportVoucherZip200Response>> {
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling exportVoucherZip().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ExportVoucherZip200ResponseFromJSON(jsonValue));
    }
     ...
     * Export voucher zip
     */
    async exportVoucherZip(requestParameters: ExportVoucherZipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExportVoucherZip200Response> {
        const response = await this.exportVoucherZipRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async generateDownloadHashRaw(requestParameters: GenerateDownloadHashRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GenerateDownloadHash200Response>> {
        if (requestParameters['jobId'] == null) {
            throw new runtime.RequiredError(
                'jobId',
                'Required parameter "jobId" was null or undefined when calling generateDownloadHash().'
            );
        }
        ...
        let urlPath = `/Progress/generateDownloadHash`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GenerateDownloadHash200ResponseFromJSON(jsonValue));
    }
     ...
     * Generate download hash
     */
    async generateDownloadHash(requestParameters: GenerateDownloadHashRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GenerateDownloadHash200Response> {
        const response = await this.generateDownloadHashRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get progress
     */
    async getProgressRaw(requestParameters: GetProgressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GenerateDownloadHash200Response>> {
        if (requestParameters['hash'] == null) {
            throw new runtime.RequiredError(
                'hash',
                'Required parameter "hash" was null or undefined when calling getProgress().'
            );
        }
        ...
        let urlPath = `/Progress/getProgress`;
     ...
     * Get progress
     */
    async getProgress(requestParameters: GetProgressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GenerateDownloadHash200Response> {
     ...
     */
    async jobDownloadInfoRaw(requestParameters: JobDownloadInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JobDownloadInfo200Response>> {
        if (requestParameters['jobId'] == null) {
            throw new runtime.RequiredError(
                'jobId',
                'Required parameter "jobId" was null or undefined when calling jobDownloadInfo().'
            );
        }
        ...
        let urlPath = `/ExportJob/jobDownloadInfo`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => JobDownloadInfo200ResponseFromJSON(jsonValue));
    }
     ...
     * Get job download info
     */
    async jobDownloadInfo(requestParameters: JobDownloadInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JobDownloadInfo200Response> {
        const response = await this.jobDownloadInfoRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateExportConfigRaw(requestParameters: UpdateExportConfigOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CheckAccountTransactionEnshrine200Response>> {
        if (requestParameters['sevClientId'] == null) {
            throw new runtime.RequiredError(
                'sevClientId',
                'Required parameter "sevClientId" was null or undefined when calling updateExportConfig().'
            );
        }
        ...
        let urlPath = `/SevClient/{SevClientId}/updateExportConfig`;
        urlPath = urlPath.replace(`{${"SevClientId"}}`, encodeURIComponent(String(requestParameters['sevClientId'])));
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateExportConfigRequestToJSON(requestParameters['updateExportConfigRequest']),
        }, initOverrides);
     ...
     * Update export config
     */
    async updateExportConfig(requestParameters: UpdateExportConfigOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CheckAccountTransactionEnshrine200Response> {
        const response = await this.updateExportConfigRaw(requestParameters, initOverrides);
        return await response.value();
    }
