...
import {
    ...
    GetContactFieldSettings200ResponseFromJSON,
    GetContactFieldSettings200ResponseToJSON,
    GetContactFields200ResponseFromJSON,
    GetContactFields200ResponseToJSON,
    GetPlaceholder200ResponseFromJSON,
    GetPlaceholder200ResponseToJSON,
    GetReferenceCount200ResponseFromJSON,
    GetReferenceCount200ResponseToJSON,
    ModelContactCustomFieldFromJSON,
    ModelContactCustomFieldToJSON,
    ModelContactCustomFieldResponseFromJSON,
    ModelContactCustomFieldResponseToJSON,
    ModelContactCustomFieldSettingFromJSON,
    ModelContactCustomFieldSettingToJSON,
    ModelContactCustomFieldSettingResponseFromJSON,
    ModelContactCustomFieldSettingResponseToJSON,
    ModelContactCustomFieldSettingUpdateFromJSON,
    ModelContactCustomFieldSettingUpdateToJSON,
    ModelContactCustomFieldUpdateFromJSON,
    ModelContactCustomFieldUpdateToJSON,
} from '../models/index';
...
export interface CreateContactFieldSettingRequest {
    modelContactCustomFieldSetting?: ModelContactCustomFieldSetting;
}

export interface DeleteContactCustomFieldIdRequest {
    contactCustomFieldId: number;
}

export interface DeleteContactFieldSettingRequest {
    contactCustomFieldSettingId: number;
}

export interface GetContactFieldSettingByIdRequest {
    contactCustomFieldSettingId: number;
}

export interface GetContactFieldsByIdRequest {
    contactCustomFieldId: number;
}

export interface GetPlaceholderRequest {
    objectName: GetPlaceholderObjectNameEnum;
    subObjectName?: GetPlaceholderSubObjectNameEnum;
}

export interface GetReferenceCountRequest {
    contactCustomFieldSettingId: number;
}

export interface UpdateContactFieldSettingRequest {
    contactCustomFieldSettingId: number;
 ...
 * 
 */
export class ContactFieldApi extends runtime.BaseAPI {

    /**
     * Create contact field
     * Create contact field
     */
    async createContactFieldRaw(requestParameters: CreateContactFieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelContactCustomFieldResponse>> {
        ...
        let urlPath = `/ContactCustomField`;
        ...
        const response = await this.request({
            ...
            body: ModelContactCustomFieldToJSON(requestParameters['modelContactCustomField']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelContactCustomFieldResponseFromJSON(jsonValue));
    }
     ...
     * Create contact field
     */
    async createContactField(requestParameters: CreateContactFieldRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelContactCustomFieldResponse> {
        const response = await this.createContactFieldRaw(requestParameters, initOverrides);
     ...
     * Create contact field setting
     */
    async createContactFieldSettingRaw(requestParameters: CreateContactFieldSettingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetContactFieldSettings200Response>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/ContactCustomFieldSetting`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelContactCustomFieldSettingToJSON(requestParameters['modelContactCustomFieldSetting']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GetContactFieldSettings200ResponseFromJSON(jsonValue));
    }
     ...
     * Create contact field setting
     */
    async createContactFieldSetting(requestParameters: CreateContactFieldSettingRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetContactFieldSettings200Response> {
        const response = await this.createContactFieldSettingRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteContactCustomFieldIdRaw(requestParameters: DeleteContactCustomFieldIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['contactCustomFieldId'] == null) {
            throw new runtime.RequiredError(
                'contactCustomFieldId',
                'Required parameter "contactCustomFieldId" was null or undefined when calling deleteContactCustomFieldId().'
            );
        }
        ...
        let urlPath = `/ContactCustomField/{contactCustomFieldId}`;
        urlPath = urlPath.replace(`{${"contactCustomFieldId"}}`, encodeURIComponent(String(requestParameters['contactCustomFieldId'])));
     ...
     * delete a contact field
     */
    async deleteContactCustomFieldId(requestParameters: DeleteContactCustomFieldIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
        const response = await this.deleteContactCustomFieldIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteContactFieldSettingRaw(requestParameters: DeleteContactFieldSettingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['contactCustomFieldSettingId'] == null) {
            throw new runtime.RequiredError(
                'contactCustomFieldSettingId',
                'Required parameter "contactCustomFieldSettingId" was null or undefined when calling deleteContactFieldSetting().'
            );
        }
        ...
        let urlPath = `/ContactCustomFieldSetting/{contactCustomFieldSettingId}`;
        urlPath = urlPath.replace(`{${"contactCustomFieldSettingId"}}`, encodeURIComponent(String(requestParameters['contactCustomFieldSettingId'])));
     ...
     * Deletes a contact field setting
     */
    async deleteContactFieldSetting(requestParameters: DeleteContactFieldSettingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
        const response = await this.deleteContactFieldSettingRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getContactFieldSettingByIdRaw(requestParameters: GetContactFieldSettingByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetContactFieldSettings200Response>> {
        if (requestParameters['contactCustomFieldSettingId'] == null) {
            throw new runtime.RequiredError(
                'contactCustomFieldSettingId',
                'Required parameter "contactCustomFieldSettingId" was null or undefined when calling getContactFieldSettingById().'
            );
        }
     ...
     * Find contact field setting by ID
     */
    async getContactFieldSettingById(requestParameters: GetContactFieldSettingByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetContactFieldSettings200Response> {
        const response = await this.getContactFieldSettingByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getContactFieldSettingsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetContactFieldSettings200Response>> {
        const queryParameters: any = {};
     ...
     * Retrieve contact field settings
     */
    async getContactFieldSettings(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetContactFieldSettings200Response> {
        const response = await this.getContactFieldSettingsRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async getContactFieldsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetContactFields200Response>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetContactFields200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve contact fields
     */
    async getContactFields(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetContactFields200Response> {
        const response = await this.getContactFieldsRaw(initOverrides);
        return await response.value();
    }
     ...
     * Retrieve contact fields
     */
    async getContactFieldsByIdRaw(requestParameters: GetContactFieldsByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetContactFields200Response>> {
        if (requestParameters['contactCustomFieldId'] == null) {
            throw new runtime.RequiredError(
                'contactCustomFieldId',
                'Required parameter "contactCustomFieldId" was null or undefined when calling getContactFieldsById().'
            );
        }
     ...
     * Retrieve contact fields
     */
    async getContactFieldsById(requestParameters: GetContactFieldsByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetContactFields200Response> {
        const response = await this.getContactFieldsByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getPlaceholderRaw(requestParameters: GetPlaceholderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetPlaceholder200Response>> {
        if (requestParameters['objectName'] == null) {
            throw new runtime.RequiredError(
                'objectName',
                'Required parameter "objectName" was null or undefined when calling getPlaceholder().'
            );
        }
        ...
        if (requestParameters['subObjectName'] != null) {
            queryParameters['subObjectName'] = requestParameters['subObjectName'];
        }
        ...
        let urlPath = `/Textparser/fetchDictionaryEntriesByType`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetPlaceholder200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve Placeholders
     */
    async getPlaceholder(requestParameters: GetPlaceholderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetPlaceholder200Response> {
        const response = await this.getPlaceholderRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Receive count reference
     */
    async getReferenceCountRaw(requestParameters: GetReferenceCountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetReferenceCount200Response>> {
        if (requestParameters['contactCustomFieldSettingId'] == null) {
            throw new runtime.RequiredError(
                'contactCustomFieldSettingId',
                'Required parameter "contactCustomFieldSettingId" was null or undefined when calling getReferenceCount().'
            );
        }
        ...
        let urlPath = `/ContactCustomFieldSetting/{contactCustomFieldSettingId}/getReferenceCount`;
        urlPath = urlPath.replace(`{${"contactCustomFieldSettingId"}}`, encodeURIComponent(String(requestParameters['contactCustomFieldSettingId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetReferenceCount200ResponseFromJSON(jsonValue));
    }
     ...
     * Receive count reference
     */
    async getReferenceCount(requestParameters: GetReferenceCountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetReferenceCount200Response> {
        const response = await this.getReferenceCountRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateContactFieldSettingRaw(requestParameters: UpdateContactFieldSettingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelContactCustomFieldSettingResponse>> {
        if (requestParameters['contactCustomFieldSettingId'] == null) {
            throw new runtime.RequiredError(
                'contactCustomFieldSettingId',
                'Required parameter "contactCustomFieldSettingId" was null or undefined when calling updateContactFieldSetting().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelContactCustomFieldSettingUpdateToJSON(requestParameters['modelContactCustomFieldSettingUpdate']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelContactCustomFieldSettingResponseFromJSON(jsonValue));
    }
     ...
     * Update contact field setting
     */
    async updateContactFieldSetting(requestParameters: UpdateContactFieldSettingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelContactCustomFieldSettingResponse> {
        const response = await this.updateContactFieldSettingRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Update a contact field
     */
    async updateContactfieldRaw(requestParameters: UpdateContactfieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelContactCustomFieldResponse>> {
        if (requestParameters['contactCustomFieldId'] == null) {
            throw new runtime.RequiredError(
                'contactCustomFieldId',
                'Required parameter "contactCustomFieldId" was null or undefined when calling updateContactfield().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelContactCustomFieldUpdateToJSON(requestParameters['modelContactCustomFieldUpdate']),
        }, initOverrides);
     ...
     * Update a contact field
     */
    async updateContactfield(requestParameters: UpdateContactfieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelContactCustomFieldResponse> {
        const response = await this.updateContactfieldRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetPlaceholderObjectNameEnum = {
    Invoice: 'Invoice',
...
export type GetPlaceholderObjectNameEnum = typeof GetPlaceholderObjectNameEnum[keyof typeof GetPlaceholderObjectNameEnum];
/**
 * @export
 */
export const GetPlaceholderSubObjectNameEnum = {
    Invoice: 'Invoice',
    CreditNote: 'CreditNote',
    Order: 'Order',
    Contact: 'Contact',
...
export type GetPlaceholderSubObjectNameEnum = typeof GetPlaceholderSubObjectNameEnum[keyof typeof GetPlaceholderSubObjectNameEnum];
