...
import {
    ...
    GetContactAddresses200ResponseFromJSON,
    GetContactAddresses200ResponseToJSON,
    ModelContactAddressFromJSON,
    ModelContactAddressToJSON,
    ModelContactAddressResponseFromJSON,
    ModelContactAddressResponseToJSON,
    ModelContactAddressUpdateFromJSON,
    ModelContactAddressUpdateToJSON,
} from '../models/index';

export interface ContactAddressIdRequest {
    contactAddressId: number;
}

export interface CreateContactAddressRequest {
    modelContactAddress?: Omit<ModelContactAddress, 'id'|'objectName'|'create'|'update'>;
}

export interface DeleteContactAddressRequest {
    contactAddressId: number;
}
 ...
 * 
 */
export class ContactAddressApi extends runtime.BaseAPI {

    /**
     * Returns a single contact address
     * Find contact address by ID
     */
    async contactAddressIdRaw(requestParameters: ContactAddressIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetContactAddresses200Response>> {
        if (requestParameters['contactAddressId'] == null) {
            throw new runtime.RequiredError(
                'contactAddressId',
                'Required parameter "contactAddressId" was null or undefined when calling contactAddressId().'
            );
        }
        ...
        let urlPath = `/ContactAddress/{contactAddressId}`;
        urlPath = urlPath.replace(`{${"contactAddressId"}}`, encodeURIComponent(String(requestParameters['contactAddressId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetContactAddresses200ResponseFromJSON(jsonValue));
    }
     ...
     * Find contact address by ID
     */
    async contactAddressId(requestParameters: ContactAddressIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetContactAddresses200Response> {
        const response = await this.contactAddressIdRaw(requestParameters, initOverrides);
     ...
     */
    async createContactAddressRaw(requestParameters: CreateContactAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelContactAddressResponse>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelContactAddressToJSON(requestParameters['modelContactAddress']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelContactAddressResponseFromJSON(jsonValue));
    }
     ...
     * Create a new contact address
     */
    async createContactAddress(requestParameters: CreateContactAddressRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelContactAddressResponse> {
        const response = await this.createContactAddressRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteContactAddressRaw(requestParameters: DeleteContactAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['contactAddressId'] == null) {
            throw new runtime.RequiredError(
                'contactAddressId',
                'Required parameter "contactAddressId" was null or undefined when calling deleteContactAddress().'
            );
        }
     ...
     * Deletes a contact address
     */
    async deleteContactAddress(requestParameters: DeleteContactAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
        const response = await this.deleteContactAddressRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getContactAddressesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetContactAddresses200Response>> {
        const queryParameters: any = {};
     ...
     * Retrieve contact addresses
     */
    async getContactAddresses(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetContactAddresses200Response> {
        const response = await this.getContactAddressesRaw(initOverrides);
        return await response.value();
    }
     ...
     * update a existing contact address
     */
    async updateContactAddressRaw(requestParameters: UpdateContactAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelContactAddressResponse>> {
        if (requestParameters['contactAddressId'] == null) {
            throw new runtime.RequiredError(
                'contactAddressId',
                'Required parameter "contactAddressId" was null or undefined when calling updateContactAddress().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelContactAddressUpdateToJSON(requestParameters['modelContactAddressUpdate']),
        }, initOverrides);
     ...
     * update a existing contact address
     */
    async updateContactAddress(requestParameters: UpdateContactAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelContactAddressResponse> {
        const response = await this.updateContactAddressRaw(requestParameters, initOverrides);
        return await response.value();
    }
