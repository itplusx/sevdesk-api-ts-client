...
import {
    ...
    ModelOrderPosResponseFromJSON,
    ModelOrderPosResponseToJSON,
    ModelOrderPosUpdateFromJSON,
    ModelOrderPosUpdateToJSON,
} from '../models/index';

export interface DeleteOrderPosRequest {
    orderPosId: number;
}

export interface GetOrderPositionByIdRequest {
    orderPosId: number;
}

export interface GetOrderPositionsRequest {
    orderId?: number;
...
export interface UpdateOrderPositionRequest {
    orderPosId: number;
    modelOrderPosUpdate?: Omit<ModelOrderPosUpdate, 'id'|'objectName'|'create'|'update'|'priceNet'|'sumDiscount'>;
}

/**
 * 
 */
export class OrderPosApi extends runtime.BaseAPI {

    /**
     * Deletes an order Position
     */
    async deleteOrderPosRaw(requestParameters: DeleteOrderPosRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['orderPosId'] == null) {
            throw new runtime.RequiredError(
                'orderPosId',
                'Required parameter "orderPosId" was null or undefined when calling deleteOrderPos().'
            );
        }
        ...
        let urlPath = `/OrderPos/{orderPosId}`;
        urlPath = urlPath.replace(`{${"orderPosId"}}`, encodeURIComponent(String(requestParameters['orderPosId'])));
     ...
     * Deletes an order Position
     */
    async deleteOrderPos(requestParameters: DeleteOrderPosRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
        const response = await this.deleteOrderPosRaw(requestParameters, initOverrides);
     ...
     */
    async getOrderPositionByIdRaw(requestParameters: GetOrderPositionByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetOrderPositionsById200Response>> {
        if (requestParameters['orderPosId'] == null) {
            throw new runtime.RequiredError(
                'orderPosId',
                'Required parameter "orderPosId" was null or undefined when calling getOrderPositionById().'
            );
        }
     ...
     * Find order position by ID
     */
    async getOrderPositionById(requestParameters: GetOrderPositionByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetOrderPositionsById200Response> {
        const response = await this.getOrderPositionByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getOrderPositionsRaw(requestParameters: GetOrderPositionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetOrderPositionsById200Response>> {
        const queryParameters: any = {};
     ...
     * Retrieve order positions
     */
    async getOrderPositions(requestParameters: GetOrderPositionsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetOrderPositionsById200Response> {
        const response = await this.getOrderPositionsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateOrderPositionRaw(requestParameters: UpdateOrderPositionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelOrderPosResponse>> {
        if (requestParameters['orderPosId'] == null) {
            throw new runtime.RequiredError(
                'orderPosId',
                'Required parameter "orderPosId" was null or undefined when calling updateOrderPosition().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelOrderPosUpdateToJSON(requestParameters['modelOrderPosUpdate']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelOrderPosResponseFromJSON(jsonValue));
    }
     ...
     * Update an existing order position
     */
    async updateOrderPosition(requestParameters: UpdateOrderPositionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelOrderPosResponse> {
        const response = await this.updateOrderPositionRaw(requestParameters, initOverrides);
        return await response.value();
    }
