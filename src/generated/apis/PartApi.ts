...
import {
    GetParts200ResponseFromJSON,
    GetParts200ResponseToJSON,
    ModelPartFromJSON,
    ModelPartToJSON,
    ModelPartUpdateFromJSON,
    ModelPartUpdateToJSON,
    PartGetStock200ResponseFromJSON,
    PartGetStock200ResponseToJSON,
} from '../models/index';

export interface CreatePartRequest {
    modelPart?: Omit<ModelPart, 'id'|'objectName'|'create'|'update'>;
}
...
export interface PartGetStockRequest {
    partId: number;
}

export interface UpdatePartRequest {
    partId: number;
    modelPartUpdate?: Omit<ModelPartUpdate, 'id'|'objectName'|'create'|'update'>;
}
...
export class PartApi extends runtime.BaseAPI {
     ...
     * Create a new part
     */
    async createPartRaw(requestParameters: CreatePartRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelPart>> {
        ...
        const response = await this.request({
            ...
            body: ModelPartToJSON(requestParameters['modelPart']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelPartFromJSON(jsonValue));
    }
     ...
     * Create a new part
     */
    async createPart(requestParameters: CreatePartRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelPart> {
     ...
     * Find part by ID
     */
    async getPartByIdRaw(requestParameters: GetPartByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetParts200Response>> {
        if (requestParameters['partId'] == null) {
            throw new runtime.RequiredError(
                'partId',
                'Required parameter "partId" was null or undefined when calling getPartById().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetParts200ResponseFromJSON(jsonValue));
    }
     ...
     * Find part by ID
     */
    async getPartById(requestParameters: GetPartByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetParts200Response> {
        const response = await this.getPartByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Retrieve parts
     */
    async getPartsRaw(requestParameters: GetPartsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetParts200Response>> {
        const queryParameters: any = {};
     ...
     * Retrieve parts
     */
    async getParts(requestParameters: GetPartsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetParts200Response> {
        const response = await this.getPartsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get stock of a part
     */
    async partGetStockRaw(requestParameters: PartGetStockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PartGetStock200Response>> {
        if (requestParameters['partId'] == null) {
            throw new runtime.RequiredError(
                'partId',
                'Required parameter "partId" was null or undefined when calling partGetStock().'
            );
        }
        ...
        let urlPath = `/Part/{partId}/getStock`;
        urlPath = urlPath.replace(`{${"partId"}}`, encodeURIComponent(String(requestParameters['partId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PartGetStock200ResponseFromJSON(jsonValue));
    }
     ...
     * Get stock of a part
     */
    async partGetStock(requestParameters: PartGetStockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PartGetStock200Response> {
        const response = await this.partGetStockRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updatePartRaw(requestParameters: UpdatePartRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelPart>> {
        if (requestParameters['partId'] == null) {
            throw new runtime.RequiredError(
                'partId',
                'Required parameter "partId" was null or undefined when calling updatePart().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelPartUpdateToJSON(requestParameters['modelPartUpdate']),
        }, initOverrides);
     ...
     * Update an existing part
     */
    async updatePart(requestParameters: UpdatePartRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelPart> {
