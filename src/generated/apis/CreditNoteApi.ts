...
import {
    BookCreditNote200ResponseFromJSON,
    BookCreditNote200ResponseToJSON,
    BookCreditNoteRequestFromJSON,
    BookCreditNoteRequestToJSON,
    CheckAccountTransactionEnshrine200ResponseFromJSON,
    CheckAccountTransactionEnshrine200ResponseToJSON,
    CreateCreditNoteFromInvoice201ResponseFromJSON,
    CreateCreditNoteFromInvoice201ResponseToJSON,
    CreateCreditNoteFromInvoiceRequestFromJSON,
    CreateCreditNoteFromInvoiceRequestToJSON,
    CreateCreditNoteFromVoucherRequestFromJSON,
    CreateCreditNoteFromVoucherRequestToJSON,
    CreditNoteGetPdf200ResponseFromJSON,
    CreditNoteGetPdf200ResponseToJSON,
    CreditNoteResetToDraft200ResponseFromJSON,
    CreditNoteResetToDraft200ResponseToJSON,
    CreditNoteResetToOpen200ResponseFromJSON,
    CreditNoteResetToOpen200ResponseToJSON,
    CreditNoteSendByRequestFromJSON,
    CreditNoteSendByRequestToJSON,
    DeleteCheckAccount200ResponseFromJSON,
    DeleteCheckAccount200ResponseToJSON,
    GetCreditNotes200ResponseFromJSON,
    GetCreditNotes200ResponseToJSON,
    ModelCreditNoteResponseFromJSON,
    ModelCreditNoteResponseToJSON,
    ModelCreditNoteSendByWithRenderFromJSON,
    ModelCreditNoteSendByWithRenderToJSON,
    ModelCreditNoteUpdateFromJSON,
    ModelCreditNoteUpdateToJSON,
    SaveCreditNoteFromJSON,
    SaveCreditNoteToJSON,
    SaveCreditNoteResponseFromJSON,
    SaveCreditNoteResponseToJSON,
    SendCreditNoteViaEMail201ResponseFromJSON,
    SendCreditNoteViaEMail201ResponseToJSON,
    SendCreditNoteViaEMailRequestFromJSON,
    SendCreditNoteViaEMailRequestToJSON,
    ValidationErrorFromJSON,
    ValidationErrorToJSON,
} from '../models/index';

export interface BookCreditNoteOperationRequest {
    creditNoteId: number;
    bookCreditNoteRequest?: BookCreditNoteRequest;
}

export interface CreateCreditNoteFromInvoiceOperationRequest {
    createCreditNoteFromInvoiceRequest?: CreateCreditNoteFromInvoiceRequest;
}

export interface CreateCreditNoteFromVoucherOperationRequest {
    createCreditNoteFromVoucherRequest?: CreateCreditNoteFromVoucherRequest;
}
...
export interface CreditNoteEnshrineRequest {
    creditNoteId: number;
}

export interface CreditNoteGetPdfRequest {
    creditNoteId: number;
    download?: boolean;
    preventSendBy?: boolean;
}

export interface CreditNoteResetToDraftRequest {
    creditNoteId: number;
}

export interface CreditNoteResetToOpenRequest {
    creditNoteId: number;
}

export interface CreditNoteSendByOperationRequest {
    creditNoteId: number;
    creditNoteSendByRequest?: CreditNoteSendByRequest;
}

export interface DeletecreditNoteRequest {
    creditNoteId: number;
}

export interface GetCreditNotesRequest {
    status?: GetCreditNotesStatusEnum;
...
export interface GetcreditNoteByIdRequest {
    creditNoteId: number;
}

export interface SendCreditNoteByPrintingRequest {
    creditNoteId: number;
    sendType: string;
}

export interface SendCreditNoteViaEMailOperationRequest {
    creditNoteId: number;
    sendCreditNoteViaEMailRequest?: SendCreditNoteViaEMailRequest;
}

export interface UpdatecreditNoteRequest {
    creditNoteId: number;
    modelCreditNoteUpdate?: Omit<ModelCreditNoteUpdate, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'>;
}

/**
 * 
 */
export class CreditNoteApi extends runtime.BaseAPI {
     ...
     * Book a credit note
     */
    async bookCreditNoteRaw(requestParameters: BookCreditNoteOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BookCreditNote200Response>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling bookCreditNote().'
            );
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}/bookAmount`;
        ...
        const response = await this.request({
            ...
            body: BookCreditNoteRequestToJSON(requestParameters['bookCreditNoteRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => BookCreditNote200ResponseFromJSON(jsonValue));
    }
     ...
     * Book a credit note
     */
    async bookCreditNote(requestParameters: BookCreditNoteOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BookCreditNote200Response> {
        const response = await this.bookCreditNoteRaw(requestParameters, initOverrides);
     ...
     */
    async createCreditNoteFromInvoiceRaw(requestParameters: CreateCreditNoteFromInvoiceOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateCreditNoteFromInvoice201Response>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/CreditNote/Factory/createFromInvoice`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateCreditNoteFromInvoiceRequestToJSON(requestParameters['createCreditNoteFromInvoiceRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateCreditNoteFromInvoice201ResponseFromJSON(jsonValue));
    }
     ...
     * Creates a new creditNote from an invoice
     */
    async createCreditNoteFromInvoice(requestParameters: CreateCreditNoteFromInvoiceOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateCreditNoteFromInvoice201Response> {
        const response = await this.createCreditNoteFromInvoiceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async createCreditNoteFromVoucherRaw(requestParameters: CreateCreditNoteFromVoucherOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateCreditNoteFromInvoice201Response>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/CreditNote/Factory/createFromVoucher`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateCreditNoteFromVoucherRequestToJSON(requestParameters['createCreditNoteFromVoucherRequest']),
        }, initOverrides);
     ...
     * Creates a new creditNote from a voucher
     */
    async createCreditNoteFromVoucher(requestParameters: CreateCreditNoteFromVoucherOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateCreditNoteFromInvoice201Response> {
        const response = await this.createCreditNoteFromVoucherRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async createcreditNoteRaw(requestParameters: CreatecreditNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SaveCreditNoteResponse>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/CreditNote/Factory/saveCreditNote`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SaveCreditNoteToJSON(requestParameters['saveCreditNote']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SaveCreditNoteResponseFromJSON(jsonValue));
    }
     ...
     * Create a new creditNote
     */
    async createcreditNote(requestParameters: CreatecreditNoteRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SaveCreditNoteResponse> {
     ...
     * Enshrine
     */
    async creditNoteEnshrineRaw(requestParameters: CreditNoteEnshrineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CheckAccountTransactionEnshrine200Response>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling creditNoteEnshrine().'
            );
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}/enshrine`;
        urlPath = urlPath.replace(`{${"creditNoteId"}}`, encodeURIComponent(String(requestParameters['creditNoteId'])));
     ...
     * Enshrine
     */
    async creditNoteEnshrine(requestParameters: CreditNoteEnshrineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CheckAccountTransactionEnshrine200Response> {
        const response = await this.creditNoteEnshrineRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async creditNoteGetPdfRaw(requestParameters: CreditNoteGetPdfRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreditNoteGetPdf200Response>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling creditNoteGetPdf().'
            );
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}/getPdf`;
        urlPath = urlPath.replace(`{${"creditNoteId"}}`, encodeURIComponent(String(requestParameters['creditNoteId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreditNoteGetPdf200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve pdf document of a credit note
     */
    async creditNoteGetPdf(requestParameters: CreditNoteGetPdfRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreditNoteGetPdf200Response> {
        const response = await this.creditNoteGetPdfRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async creditNoteResetToDraftRaw(requestParameters: CreditNoteResetToDraftRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreditNoteResetToDraft200Response>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling creditNoteResetToDraft().'
            );
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}/resetToDraft`;
        urlPath = urlPath.replace(`{${"creditNoteId"}}`, encodeURIComponent(String(requestParameters['creditNoteId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreditNoteResetToDraft200ResponseFromJSON(jsonValue));
    }
     ...
     * Reset status to draft
     */
    async creditNoteResetToDraft(requestParameters: CreditNoteResetToDraftRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreditNoteResetToDraft200Response> {
        const response = await this.creditNoteResetToDraftRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async creditNoteResetToOpenRaw(requestParameters: CreditNoteResetToOpenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreditNoteResetToOpen200Response>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling creditNoteResetToOpen().'
            );
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}/resetToOpen`;
        urlPath = urlPath.replace(`{${"creditNoteId"}}`, encodeURIComponent(String(requestParameters['creditNoteId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreditNoteResetToOpen200ResponseFromJSON(jsonValue));
    }
     ...
     * Reset status to open
     */
    async creditNoteResetToOpen(requestParameters: CreditNoteResetToOpenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreditNoteResetToOpen200Response> {
        const response = await this.creditNoteResetToOpenRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async creditNoteSendByRaw(requestParameters: CreditNoteSendByOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelCreditNoteResponse>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling creditNoteSendBy().'
            );
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}/sendBy`;
        urlPath = urlPath.replace(`{${"creditNoteId"}}`, encodeURIComponent(String(requestParameters['creditNoteId'])));
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreditNoteSendByRequestToJSON(requestParameters['creditNoteSendByRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelCreditNoteResponseFromJSON(jsonValue));
    }
     ...
     * Mark credit note as sent
     */
    async creditNoteSendBy(requestParameters: CreditNoteSendByOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelCreditNoteResponse> {
        const response = await this.creditNoteSendByRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deletecreditNoteRaw(requestParameters: DeletecreditNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling deletecreditNote().'
            );
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}`;
        urlPath = urlPath.replace(`{${"creditNoteId"}}`, encodeURIComponent(String(requestParameters['creditNoteId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DeleteCheckAccount200ResponseFromJSON(jsonValue));
    }

    /**
     * Deletes an creditNote
     */
    async deletecreditNote(requestParameters: DeletecreditNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
        const response = await this.deletecreditNoteRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Retrieve CreditNote
     */
    async getCreditNotesRaw(requestParameters: GetCreditNotesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCreditNotes200Response>> {
        const queryParameters: any = {};
        ...
        if (requestParameters['creditNoteNumber'] != null) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetCreditNotes200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve CreditNote
     */
    async getCreditNotes(requestParameters: GetCreditNotesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCreditNotes200Response> {
        const response = await this.getCreditNotesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getcreditNoteByIdRaw(requestParameters: GetcreditNoteByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCreditNotes200Response>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling getcreditNoteById().'
            );
        }
     ...
     * Find creditNote by ID
     */
    async getcreditNoteById(requestParameters: GetcreditNoteByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCreditNotes200Response> {
        const response = await this.getcreditNoteByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async sendCreditNoteByPrintingRaw(requestParameters: SendCreditNoteByPrintingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelCreditNoteSendByWithRender>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling sendCreditNoteByPrinting().'
            );
        }

        if (requestParameters['sendType'] == null) {
            throw new runtime.RequiredError(
                'sendType',
                'Required parameter "sendType" was null or undefined when calling sendCreditNoteByPrinting().'
            );
        }
        ...
        if (requestParameters['sendType'] != null) {
            queryParameters['sendType'] = requestParameters['sendType'];
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}/sendByWithRender`;
        urlPath = urlPath.replace(`{${"creditNoteId"}}`, encodeURIComponent(String(requestParameters['creditNoteId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ModelCreditNoteSendByWithRenderFromJSON(jsonValue));
    }
     ...
     * Send credit note by printing
     */
    async sendCreditNoteByPrinting(requestParameters: SendCreditNoteByPrintingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelCreditNoteSendByWithRender> {
        const response = await this.sendCreditNoteByPrintingRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async sendCreditNoteViaEMailRaw(requestParameters: SendCreditNoteViaEMailOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SendCreditNoteViaEMail201Response>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling sendCreditNoteViaEMail().'
            );
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}/sendViaEmail`;
        urlPath = urlPath.replace(`{${"creditNoteId"}}`, encodeURIComponent(String(requestParameters['creditNoteId'])));
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SendCreditNoteViaEMailRequestToJSON(requestParameters['sendCreditNoteViaEMailRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SendCreditNoteViaEMail201ResponseFromJSON(jsonValue));
    }
     ...
     * Send credit note via email
     */
    async sendCreditNoteViaEMail(requestParameters: SendCreditNoteViaEMailOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SendCreditNoteViaEMail201Response> {
        const response = await this.sendCreditNoteViaEMailRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updatecreditNoteRaw(requestParameters: UpdatecreditNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelCreditNoteResponse>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelCreditNoteUpdateToJSON(requestParameters['modelCreditNoteUpdate']),
        }, initOverrides);
     ...
     * Update an existing creditNote
     */
    async updatecreditNote(requestParameters: UpdatecreditNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelCreditNoteResponse> {
        const response = await this.updatecreditNoteRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetCreditNotesStatusEnum = {
    _100: '100',
    _200: '200',
    _300: '300',
    _500: '500',
...
export type GetCreditNotesStatusEnum = typeof GetCreditNotesStatusEnum[keyof typeof GetCreditNotesStatusEnum];
