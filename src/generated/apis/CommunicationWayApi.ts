...
import {
    ...
    GetCommunicationWayKeys200ResponseFromJSON,
    GetCommunicationWayKeys200ResponseToJSON,
    GetCommunicationWays200ResponseFromJSON,
    GetCommunicationWays200ResponseToJSON,
    ModelCommunicationWayFromJSON,
    ModelCommunicationWayToJSON,
    ModelCommunicationWayResponseFromJSON,
    ModelCommunicationWayResponseToJSON,
    ModelCommunicationWayUpdateFromJSON,
    ModelCommunicationWayUpdateToJSON,
} from '../models/index';

export interface CreateCommunicationWayRequest {
    modelCommunicationWay?: Omit<ModelCommunicationWay, 'id'|'objectName'|'create'|'update'>;
}

export interface DeleteCommunicationWayRequest {
    communicationWayId: number;
}

export interface GetCommunicationWayByIdRequest {
    communicationWayId: number;
}

export interface GetCommunicationWaysRequest {
    contactId?: string;
    contactObjectName?: string;
    type?: GetCommunicationWaysTypeEnum;
    main?: GetCommunicationWaysMainEnum;
}

export interface UpdateCommunicationWayRequest {
    communicationWayId: number;
 ...
 * 
 */
export class CommunicationWayApi extends runtime.BaseAPI {

    /**
     * Creates a new contact communication way.
     * Create a new contact communication way
     */
    async createCommunicationWayRaw(requestParameters: CreateCommunicationWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelCommunicationWayResponse>> {
        ...
        const response = await this.request({
            ...
            body: ModelCommunicationWayToJSON(requestParameters['modelCommunicationWay']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelCommunicationWayResponseFromJSON(jsonValue));
    }
     ...
     * Create a new contact communication way
     */
    async createCommunicationWay(requestParameters: CreateCommunicationWayRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelCommunicationWayResponse> {
        const response = await this.createCommunicationWayRaw(requestParameters, initOverrides);
     ...
     */
    async deleteCommunicationWayRaw(requestParameters: DeleteCommunicationWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['communicationWayId'] == null) {
            throw new runtime.RequiredError(
                'communicationWayId',
                'Required parameter "communicationWayId" was null or undefined when calling deleteCommunicationWay().'
            );
        }
        ...
        let urlPath = `/CommunicationWay/{communicationWayId}`;
        urlPath = urlPath.replace(`{${"communicationWayId"}}`, encodeURIComponent(String(requestParameters['communicationWayId'])));
     ...
     * Deletes a communication way
     */
    async deleteCommunicationWay(requestParameters: DeleteCommunicationWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
        const response = await this.deleteCommunicationWayRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCommunicationWayByIdRaw(requestParameters: GetCommunicationWayByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCommunicationWays200Response>> {
        if (requestParameters['communicationWayId'] == null) {
            throw new runtime.RequiredError(
                'communicationWayId',
                'Required parameter "communicationWayId" was null or undefined when calling getCommunicationWayById().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetCommunicationWays200ResponseFromJSON(jsonValue));
    }
     ...
     * Find communication way by ID
     */
    async getCommunicationWayById(requestParameters: GetCommunicationWayByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCommunicationWays200Response> {
        const response = await this.getCommunicationWayByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCommunicationWayKeysRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCommunicationWayKeys200Response>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/CommunicationWayKey`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetCommunicationWayKeys200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve communication way keys
     */
    async getCommunicationWayKeys(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCommunicationWayKeys200Response> {
        const response = await this.getCommunicationWayKeysRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async getCommunicationWaysRaw(requestParameters: GetCommunicationWaysRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCommunicationWays200Response>> {
        const queryParameters: any = {};
        ...
        if (requestParameters['main'] != null) {
            queryParameters['main'] = requestParameters['main'];
        }
     ...
     * Retrieve communication ways
     */
    async getCommunicationWays(requestParameters: GetCommunicationWaysRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCommunicationWays200Response> {
        const response = await this.getCommunicationWaysRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateCommunicationWayRaw(requestParameters: UpdateCommunicationWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelCommunicationWayResponse>> {
        if (requestParameters['communicationWayId'] == null) {
            throw new runtime.RequiredError(
                'communicationWayId',
                'Required parameter "communicationWayId" was null or undefined when calling updateCommunicationWay().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelCommunicationWayUpdateToJSON(requestParameters['modelCommunicationWayUpdate']),
        }, initOverrides);
     ...
     * Update a existing communication way
     */
    async updateCommunicationWay(requestParameters: UpdateCommunicationWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelCommunicationWayResponse> {
        const response = await this.updateCommunicationWayRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetCommunicationWaysTypeEnum = {
    Phone: 'PHONE',
    Email: 'EMAIL',
    Web: 'WEB',
    Mobile: 'MOBILE'
} as const;
export type GetCommunicationWaysTypeEnum = typeof GetCommunicationWaysTypeEnum[keyof typeof GetCommunicationWaysTypeEnum];
/**
 * @export
 */
export const GetCommunicationWaysMainEnum = {
    _0: '0',
    _1: '1'
} as const;
export type GetCommunicationWaysMainEnum = typeof GetCommunicationWaysMainEnum[keyof typeof GetCommunicationWaysMainEnum];
