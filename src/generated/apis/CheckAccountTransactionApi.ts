...
import {
    ...
    ModelCheckAccountTransactionFromJSON,
    ModelCheckAccountTransactionToJSON,
    ModelCheckAccountTransactionResponseFromJSON,
    ModelCheckAccountTransactionResponseToJSON,
    ModelCheckAccountTransactionUpdateFromJSON,
    ModelCheckAccountTransactionUpdateToJSON,
    ValidationErrorFromJSON,
    ValidationErrorToJSON,
} from '../models/index';

export interface CheckAccountTransactionEnshrineRequest {
    checkAccountTransactionId: number;
}

export interface CreateTransactionRequest {
    modelCheckAccountTransaction?: Omit<ModelCheckAccountTransaction, 'id'|'objectName'|'create'|'update'>;
}

export interface DeleteCheckAccountTransactionRequest {
    checkAccountTransactionId: number;
}

export interface GetCheckAccountTransactionByIdRequest {
    checkAccountTransactionId: number;
}
...
export interface UpdateCheckAccountTransactionRequest {
    checkAccountTransactionId: number;
 ...
 * 
 */
export class CheckAccountTransactionApi extends runtime.BaseAPI {
     ...
     * Enshrine
     */
    async checkAccountTransactionEnshrineRaw(requestParameters: CheckAccountTransactionEnshrineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CheckAccountTransactionEnshrine200Response>> {
        if (requestParameters['checkAccountTransactionId'] == null) {
            throw new runtime.RequiredError(
                'checkAccountTransactionId',
                'Required parameter "checkAccountTransactionId" was null or undefined when calling checkAccountTransactionEnshrine().'
            );
        }
        ...
        let urlPath = `/CheckAccountTransaction/{checkAccountTransactionId}/enshrine`;
        urlPath = urlPath.replace(`{${"checkAccountTransactionId"}}`, encodeURIComponent(String(requestParameters['checkAccountTransactionId'])));
     ...
     * Enshrine
     */
    async checkAccountTransactionEnshrine(requestParameters: CheckAccountTransactionEnshrineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CheckAccountTransactionEnshrine200Response> {
        const response = await this.checkAccountTransactionEnshrineRaw(requestParameters, initOverrides);
     ...
     */
    async createTransactionRaw(requestParameters: CreateTransactionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelCheckAccountTransactionResponse>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/CheckAccountTransaction`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelCheckAccountTransactionToJSON(requestParameters['modelCheckAccountTransaction']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelCheckAccountTransactionResponseFromJSON(jsonValue));
    }
     ...
     * Create a new transaction
     */
    async createTransaction(requestParameters: CreateTransactionRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelCheckAccountTransactionResponse> {
     ...
     */
    async deleteCheckAccountTransactionRaw(requestParameters: DeleteCheckAccountTransactionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['checkAccountTransactionId'] == null) {
            throw new runtime.RequiredError(
                'checkAccountTransactionId',
                'Required parameter "checkAccountTransactionId" was null or undefined when calling deleteCheckAccountTransaction().'
            );
        }
        ...
        let urlPath = `/CheckAccountTransaction/{checkAccountTransactionId}`;
        urlPath = urlPath.replace(`{${"checkAccountTransactionId"}}`, encodeURIComponent(String(requestParameters['checkAccountTransactionId'])));
     ...
     * Deletes a check account transaction
     */
    async deleteCheckAccountTransaction(requestParameters: DeleteCheckAccountTransactionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
        const response = await this.deleteCheckAccountTransactionRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCheckAccountTransactionByIdRaw(requestParameters: GetCheckAccountTransactionByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetTransactions200Response>> {
        if (requestParameters['checkAccountTransactionId'] == null) {
            throw new runtime.RequiredError(
                'checkAccountTransactionId',
                'Required parameter "checkAccountTransactionId" was null or undefined when calling getCheckAccountTransactionById().'
            );
        }
     ...
     * Find check account transaction by ID
     */
    async getCheckAccountTransactionById(requestParameters: GetCheckAccountTransactionByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetTransactions200Response> {
        const response = await this.getCheckAccountTransactionByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async getTransactionsRaw(requestParameters: GetTransactionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetTransactions200Response>> {
        ...
        if (requestParameters['checkAccountId'] != null) {
            queryParameters['checkAccount[id]'] = requestParameters['checkAccountId'];
        }

        if (requestParameters['checkAccountObjectName'] != null) {
            queryParameters['checkAccount[objectName]'] = requestParameters['checkAccountObjectName'];
        }

        if (requestParameters['isBooked'] != null) {
            queryParameters['isBooked'] = requestParameters['isBooked'];
        }

        if (requestParameters['paymtPurpose'] != null) {
            queryParameters['paymtPurpose'] = requestParameters['paymtPurpose'];
        }
        ...
        if (requestParameters['payeePayerName'] != null) {
            queryParameters['payeePayerName'] = requestParameters['payeePayerName'];
        }

        if (requestParameters['onlyCredit'] != null) {
            queryParameters['onlyCredit'] = requestParameters['onlyCredit'];
        }

        if (requestParameters['onlyDebit'] != null) {
            queryParameters['onlyDebit'] = requestParameters['onlyDebit'];
        }
     ...
     */
    async updateCheckAccountTransactionRaw(requestParameters: UpdateCheckAccountTransactionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelCheckAccountTransactionResponse>> {
        if (requestParameters['checkAccountTransactionId'] == null) {
            throw new runtime.RequiredError(
                'checkAccountTransactionId',
                'Required parameter "checkAccountTransactionId" was null or undefined when calling updateCheckAccountTransaction().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelCheckAccountTransactionUpdateToJSON(requestParameters['modelCheckAccountTransactionUpdate']),
        }, initOverrides);
     ...
     * Update an existing check account transaction
     */
    async updateCheckAccountTransaction(requestParameters: UpdateCheckAccountTransactionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelCheckAccountTransactionResponse> {
        const response = await this.updateCheckAccountTransactionRaw(requestParameters, initOverrides);
        return await response.value();
    }
