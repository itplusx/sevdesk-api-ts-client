...
import {
    ...
    FindContactsByCustomFieldValue200ResponseFromJSON,
    FindContactsByCustomFieldValue200ResponseToJSON,
    GetContactTabsItemCountById200ResponseFromJSON,
    GetContactTabsItemCountById200ResponseToJSON,
    GetNextCustomerNumber200ResponseFromJSON,
    GetNextCustomerNumber200ResponseToJSON,
    ModelContactFromJSON,
    ModelContactToJSON,
    ModelContactResponseFromJSON,
    ModelContactResponseToJSON,
    ModelContactUpdateFromJSON,
    ModelContactUpdateToJSON,
} from '../models/index';

export interface ContactCustomerNumberAvailabilityCheckRequest {
...
export interface FindContactsByCustomFieldValueRequest {
    value: string;
...
export interface GetContactTabsItemCountByIdRequest {
    contactId: number;
}

export interface GetContactsRequest {
    depth?: GetContactsDepthEnum;
    customerNumber?: string;
}
...
export class ContactApi extends runtime.BaseAPI {
     ...
     */
    async contactCustomerNumberAvailabilityCheckRaw(requestParameters: ContactCustomerNumberAvailabilityCheckRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ContactCustomerNumberAvailabilityCheck200Response>> {
        ...
        let urlPath = `/Contact/Mapper/checkCustomerNumberAvailability`;
     ...
     * Check if a customer number is available
     */
    async contactCustomerNumberAvailabilityCheck(requestParameters: ContactCustomerNumberAvailabilityCheckRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ContactCustomerNumberAvailabilityCheck200Response> {
        const response = await this.contactCustomerNumberAvailabilityCheckRaw(requestParameters, initOverrides);
     ...
     */
    async createContactRaw(requestParameters: CreateContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelContactResponse>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelContactToJSON(requestParameters['modelContact']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelContactResponseFromJSON(jsonValue));
    }
     ...
     * Create a new contact
     */
    async createContact(requestParameters: CreateContactRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelContactResponse> {
     ...
     * Deletes a contact
     */
    async deleteContactRaw(requestParameters: DeleteContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
     ...
     * Deletes a contact
     */
    async deleteContact(requestParameters: DeleteContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
     ...
     */
    async findContactsByCustomFieldValueRaw(requestParameters: FindContactsByCustomFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindContactsByCustomFieldValue200Response>> {
        if (requestParameters['value'] == null) {
            throw new runtime.RequiredError(
                'value',
                'Required parameter "value" was null or undefined when calling findContactsByCustomFieldValue().'
            );
        }

        if (requestParameters['customFieldName'] == null) {
            throw new runtime.RequiredError(
                'customFieldName',
                'Required parameter "customFieldName" was null or undefined when calling findContactsByCustomFieldValue().'
            );
        }
        ...
        if (requestParameters['customFieldSettingId'] != null) {
            queryParameters['customFieldSetting[id]'] = requestParameters['customFieldSettingId'];
        }

        if (requestParameters['customFieldSettingObjectName'] != null) {
            queryParameters['customFieldSetting[objectName]'] = requestParameters['customFieldSettingObjectName'];
        }

        if (requestParameters['customFieldName'] != null) {
            queryParameters['customFieldName'] = requestParameters['customFieldName'];
        }
        ...
        let urlPath = `/Contact/Factory/findContactsByCustomFieldValue`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => FindContactsByCustomFieldValue200ResponseFromJSON(jsonValue));
    }
     ...
     * Find contacts by custom field value
     */
    async findContactsByCustomFieldValue(requestParameters: FindContactsByCustomFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FindContactsByCustomFieldValue200Response> {
        const response = await this.findContactsByCustomFieldValueRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Find contact by ID
     */
    async getContactByIdRaw(requestParameters: GetContactByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindContactsByCustomFieldValue200Response>> {
        if (requestParameters['contactId'] == null) {
            throw new runtime.RequiredError(
                'contactId',
                'Required parameter "contactId" was null or undefined when calling getContactById().'
            );
        }
     ...
     * Find contact by ID
     */
    async getContactById(requestParameters: GetContactByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FindContactsByCustomFieldValue200Response> {
     ...
     */
    async getContactTabsItemCountByIdRaw(requestParameters: GetContactTabsItemCountByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetContactTabsItemCountById200Response>> {
        if (requestParameters['contactId'] == null) {
            throw new runtime.RequiredError(
                'contactId',
                'Required parameter "contactId" was null or undefined when calling getContactTabsItemCountById().'
            );
        }
        ...
        let urlPath = `/Contact/{contactId}/getTabsItemCount`;
        urlPath = urlPath.replace(`{${"contactId"}}`, encodeURIComponent(String(requestParameters['contactId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetContactTabsItemCountById200ResponseFromJSON(jsonValue));
    }
     ...
     * Get number of all items
     */
    async getContactTabsItemCountById(requestParameters: GetContactTabsItemCountByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetContactTabsItemCountById200Response> {
        const response = await this.getContactTabsItemCountByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Retrieve contacts
     */
    async getContactsRaw(requestParameters: GetContactsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FindContactsByCustomFieldValue200Response>> {
        const queryParameters: any = {};
     ...
     * Retrieve contacts
     */
    async getContacts(requestParameters: GetContactsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FindContactsByCustomFieldValue200Response> {
     ...
     */
    async getNextCustomerNumberRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetNextCustomerNumber200Response>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/Contact/Factory/getNextCustomerNumber`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetNextCustomerNumber200ResponseFromJSON(jsonValue));
    }
     ...
     * Get next free customer number
     */
    async getNextCustomerNumber(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetNextCustomerNumber200Response> {
        const response = await this.getNextCustomerNumberRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async updateContactRaw(requestParameters: UpdateContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelContactResponse>> {
        if (requestParameters['contactId'] == null) {
            throw new runtime.RequiredError(
                'contactId',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelContactUpdateToJSON(requestParameters['modelContactUpdate']),
        }, initOverrides);
     ...
     * Update a existing contact
     */
    async updateContact(requestParameters: UpdateContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelContactResponse> {
 ...
 * @export
 */
export const GetContactsDepthEnum = {
    _0: '0',
    _1: '1'
} as const;
export type GetContactsDepthEnum = typeof GetContactsDepthEnum[keyof typeof GetContactsDepthEnum];
