...
import {
    CreateClearingAccountFromJSON,
    CreateClearingAccountToJSON,
    CreateClearingAccount201ResponseFromJSON,
    CreateClearingAccount201ResponseToJSON,
    CreateFileImportAccountFromJSON,
    CreateFileImportAccountToJSON,
    CreateFileImportAccount201ResponseFromJSON,
    CreateFileImportAccount201ResponseToJSON,
    DeleteCheckAccount200ResponseFromJSON,
    DeleteCheckAccount200ResponseToJSON,
    GetBalanceAtDate200ResponseFromJSON,
    GetBalanceAtDate200ResponseToJSON,
    GetCheckAccounts200ResponseFromJSON,
    GetCheckAccounts200ResponseToJSON,
    ModelCheckAccountResponseFromJSON,
    ModelCheckAccountResponseToJSON,
    ModelCheckAccountUpdateFromJSON,
    ModelCheckAccountUpdateToJSON,
} from '../models/index';

export interface CreateClearingAccountRequest {
    createClearingAccount?: CreateClearingAccount;
}

export interface CreateFileImportAccountRequest {
    createFileImportAccount?: CreateFileImportAccount;
}

export interface DeleteCheckAccountRequest {
    checkAccountId: number;
}

export interface GetBalanceAtDateRequest {
    checkAccountId: number;
    date: Date;
}

export interface GetCheckAccountByIdRequest {
    checkAccountId: number;
}

export interface UpdateCheckAccountRequest {
    checkAccountId: number;
 ...
 * 
 */
export class CheckAccountApi extends runtime.BaseAPI {

    /**
     * Creates a new clearing account.
     * Create a new clearing account
     */
    async createClearingAccountRaw(requestParameters: CreateClearingAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateClearingAccount201Response>> {
        ...
        let urlPath = `/CheckAccount/Factory/clearingAccount`;
        ...
        const response = await this.request({
            ...
            body: CreateClearingAccountToJSON(requestParameters['createClearingAccount']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateClearingAccount201ResponseFromJSON(jsonValue));
    }
     ...
     * Create a new clearing account
     */
    async createClearingAccount(requestParameters: CreateClearingAccountRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateClearingAccount201Response> {
        const response = await this.createClearingAccountRaw(requestParameters, initOverrides);
     ...
     */
    async createFileImportAccountRaw(requestParameters: CreateFileImportAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateFileImportAccount201Response>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/CheckAccount/Factory/fileImportAccount`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateFileImportAccountToJSON(requestParameters['createFileImportAccount']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateFileImportAccount201ResponseFromJSON(jsonValue));
    }
     ...
     * Create a new file import account
     */
    async createFileImportAccount(requestParameters: CreateFileImportAccountRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateFileImportAccount201Response> {
        const response = await this.createFileImportAccountRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteCheckAccountRaw(requestParameters: DeleteCheckAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        if (requestParameters['checkAccountId'] == null) {
            throw new runtime.RequiredError(
                'checkAccountId',
                'Required parameter "checkAccountId" was null or undefined when calling deleteCheckAccount().'
            );
        }
        ...
        let urlPath = `/CheckAccount/{checkAccountId}`;
        urlPath = urlPath.replace(`{${"checkAccountId"}}`, encodeURIComponent(String(requestParameters['checkAccountId'])));
     ...
     * Deletes a check account
     */
    async deleteCheckAccount(requestParameters: DeleteCheckAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteCheckAccount200Response> {
        const response = await this.deleteCheckAccountRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getBalanceAtDateRaw(requestParameters: GetBalanceAtDateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetBalanceAtDate200Response>> {
        if (requestParameters['checkAccountId'] == null) {
            throw new runtime.RequiredError(
                'checkAccountId',
                'Required parameter "checkAccountId" was null or undefined when calling getBalanceAtDate().'
            );
        }
        ...
        if (requestParameters['date'] == null) {
            throw new runtime.RequiredError(
                'date',
                'Required parameter "date" was null or undefined when calling getBalanceAtDate().'
            );
        }
        ...
        let urlPath = `/CheckAccount/{checkAccountId}/getBalanceAtDate`;
        urlPath = urlPath.replace(`{${"checkAccountId"}}`, encodeURIComponent(String(requestParameters['checkAccountId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetBalanceAtDate200ResponseFromJSON(jsonValue));
    }
     ...
     * Get the balance at a given date
     */
    async getBalanceAtDate(requestParameters: GetBalanceAtDateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetBalanceAtDate200Response> {
        const response = await this.getBalanceAtDateRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCheckAccountByIdRaw(requestParameters: GetCheckAccountByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCheckAccounts200Response>> {
        if (requestParameters['checkAccountId'] == null) {
            throw new runtime.RequiredError(
                'checkAccountId',
                'Required parameter "checkAccountId" was null or undefined when calling getCheckAccountById().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetCheckAccounts200ResponseFromJSON(jsonValue));
    }
     ...
     * Find check account by ID
     */
    async getCheckAccountById(requestParameters: GetCheckAccountByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCheckAccounts200Response> {
        const response = await this.getCheckAccountByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCheckAccountsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCheckAccounts200Response>> {
        const queryParameters: any = {};
     ...
     * Retrieve check accounts
     */
    async getCheckAccounts(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCheckAccounts200Response> {
        const response = await this.getCheckAccountsRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async updateCheckAccountRaw(requestParameters: UpdateCheckAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelCheckAccountResponse>> {
        if (requestParameters['checkAccountId'] == null) {
            throw new runtime.RequiredError(
                'checkAccountId',
                'Required parameter "checkAccountId" was null or undefined when calling updateCheckAccount().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelCheckAccountUpdateToJSON(requestParameters['modelCheckAccountUpdate']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelCheckAccountResponseFromJSON(jsonValue));
    }
     ...
     * Update an existing check account
     */
    async updateCheckAccount(requestParameters: UpdateCheckAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelCheckAccountResponse> {
        const response = await this.updateCheckAccountRaw(requestParameters, initOverrides);
        return await response.value();
    }
