...
import {
    GetLetterpapersWithThumb200ResponseFromJSON,
    GetLetterpapersWithThumb200ResponseToJSON,
    GetTemplates200ResponseFromJSON,
    GetTemplates200ResponseToJSON,
    ModelChangeLayoutFromJSON,
    ModelChangeLayoutToJSON,
    ModelChangeLayoutResponseFromJSON,
    ModelChangeLayoutResponseToJSON,
} from '../models/index';

export interface GetTemplatesRequest {
    type?: GetTemplatesTypeEnum;
}

export interface UpdateCreditNoteTemplateRequest {
    creditNoteId: number;
...
export class LayoutApi extends runtime.BaseAPI {
     ...
     */
    async getLetterpapersWithThumbRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetLetterpapersWithThumb200Response>> {
        ...
        let urlPath = `/DocServer/getLetterpapersWithThumb`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetLetterpapersWithThumb200ResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve letterpapers
     */
    async getLetterpapersWithThumb(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetLetterpapersWithThumb200Response> {
        const response = await this.getLetterpapersWithThumbRaw(initOverrides);
    ...
    async getTemplatesRaw(requestParameters: GetTemplatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetTemplates200Response>> {
        ...
        let urlPath = `/DocServer/getTemplatesWithThumb`;
     ...
     */
    async updateCreditNoteTemplateRaw(requestParameters: UpdateCreditNoteTemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelChangeLayoutResponse>> {
        if (requestParameters['creditNoteId'] == null) {
            throw new runtime.RequiredError(
                'creditNoteId',
                'Required parameter "creditNoteId" was null or undefined when calling updateCreditNoteTemplate().'
            );
        }
        ...
        let urlPath = `/CreditNote/{creditNoteId}/changeParameter`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelChangeLayoutToJSON(requestParameters['modelChangeLayout']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelChangeLayoutResponseFromJSON(jsonValue));
    }
     ...
     * Update an of credit note template
     */
    async updateCreditNoteTemplate(requestParameters: UpdateCreditNoteTemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelChangeLayoutResponse> {
        const response = await this.updateCreditNoteTemplateRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateInvoiceTemplateRaw(requestParameters: UpdateInvoiceTemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelChangeLayoutResponse>> {
        if (requestParameters['invoiceId'] == null) {
            throw new runtime.RequiredError(
                'invoiceId',
                'Required parameter "invoiceId" was null or undefined when calling updateInvoiceTemplate().'
            );
        }
        ...
        let urlPath = `/Invoice/{invoiceId}/changeParameter`;
     ...
     * Update an invoice template
     */
    async updateInvoiceTemplate(requestParameters: UpdateInvoiceTemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelChangeLayoutResponse> {
        const response = await this.updateInvoiceTemplateRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateOrderTemplateRaw(requestParameters: UpdateOrderTemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelChangeLayoutResponse>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
                'Required parameter "orderId" was null or undefined when calling updateOrderTemplate().'
            );
        }
        ...
        let urlPath = `/Order/{orderId}/changeParameter`;
     ...
     * Update an order template
     */
    async updateOrderTemplate(requestParameters: UpdateOrderTemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelChangeLayoutResponse> {
        const response = await this.updateOrderTemplateRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetTemplatesTypeEnum = {
    Invoice: 'Invoice',
...
export type GetTemplatesTypeEnum = typeof GetTemplatesTypeEnum[keyof typeof GetTemplatesTypeEnum];
