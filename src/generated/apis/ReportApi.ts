...
import {
    ReportContact200ResponseFromJSON,
    ReportContact200ResponseToJSON,
    ReportContactSevQueryParameterFromJSON,
    ReportContactSevQueryParameterToJSON,
    ReportInvoice200ResponseFromJSON,
    ReportInvoice200ResponseToJSON,
    ReportInvoiceSevQueryParameterFromJSON,
    ReportInvoiceSevQueryParameterToJSON,
    ReportOrder200ResponseFromJSON,
    ReportOrder200ResponseToJSON,
    ReportOrderSevQueryParameterFromJSON,
    ReportOrderSevQueryParameterToJSON,
    ReportVoucher200ResponseFromJSON,
    ReportVoucher200ResponseToJSON,
    ReportVoucherSevQueryParameterFromJSON,
    ReportVoucherSevQueryParameterToJSON,
} from '../models/index';
...
export interface ReportInvoiceRequest {
    view: string;
...
export interface ReportVoucherRequest {
...
export class ReportApi extends runtime.BaseAPI {
     ...
     * Export contact list
     */
    async reportContactRaw(requestParameters: ReportContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReportContact200Response>> {
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling reportContact().'
            );
        }
        ...
        let urlPath = `/Report/contactlist`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ReportContact200ResponseFromJSON(jsonValue));
    }
     ...
     * Export contact list
     */
    async reportContact(requestParameters: ReportContactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReportContact200Response> {
        const response = await this.reportContactRaw(requestParameters, initOverrides);
     ...
     * Export invoice list
     */
    async reportInvoiceRaw(requestParameters: ReportInvoiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReportInvoice200Response>> {
        if (requestParameters['view'] == null) {
            throw new runtime.RequiredError(
                'view',
                'Required parameter "view" was null or undefined when calling reportInvoice().'
            );
        }
        ...
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling reportInvoice().'
            );
        }
        ...
        let urlPath = `/Report/invoicelist`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ReportInvoice200ResponseFromJSON(jsonValue));
    }
     ...
     * Export invoice list
     */
    async reportInvoice(requestParameters: ReportInvoiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReportInvoice200Response> {
        const response = await this.reportInvoiceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Export order list
     */
    async reportOrderRaw(requestParameters: ReportOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReportOrder200Response>> {
        if (requestParameters['view'] == null) {
            throw new runtime.RequiredError(
                'view',
                'Required parameter "view" was null or undefined when calling reportOrder().'
            );
        }
        ...
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling reportOrder().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ReportOrder200ResponseFromJSON(jsonValue));
    }
     ...
     * Export order list
     */
    async reportOrder(requestParameters: ReportOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReportOrder200Response> {
        const response = await this.reportOrderRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Export voucher list
     */
    async reportVoucherRaw(requestParameters: ReportVoucherRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReportVoucher200Response>> {
        if (requestParameters['sevQuery'] == null) {
            throw new runtime.RequiredError(
                'sevQuery',
                'Required parameter "sevQuery" was null or undefined when calling reportVoucher().'
            );
        }
        ...
        let urlPath = `/Report/voucherlist`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ReportVoucher200ResponseFromJSON(jsonValue));
    }
     ...
     * Export voucher list
     */
    async reportVoucher(requestParameters: ReportVoucherRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReportVoucher200Response> {
        const response = await this.reportVoucherRaw(requestParameters, initOverrides);
        return await response.value();
    }
